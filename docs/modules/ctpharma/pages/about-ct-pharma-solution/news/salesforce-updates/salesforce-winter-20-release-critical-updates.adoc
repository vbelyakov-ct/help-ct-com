...
[NOTE]
====
After updating the permissions configuration, xref:ctmobile:ios/mobile-application/synchronization/full-synchronization.adoc[launch full synchronization] on devices with installed CT Mobile to apply the changes.
====
