...
* xref:add-and-set-up-divisions[Create and set up divisions].
...
Marketing Detail Tracking.
* Create xref:linking-activity[Activity Link] for automatic linking
activity with a certain marketing cycle.
. xref:creating-a-marketing-cycle[Create Marketing Cycle].
