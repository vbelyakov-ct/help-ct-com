...
[NOTE]
====
After updating the permissions configuration, xref:ctmobile:ios/mobile-application/synchronization/synchronization-launch/index.adoc#h3_1369866827[launch full synchronization] on devices with installed CT Mobile to include the changes.
====
