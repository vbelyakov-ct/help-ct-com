...
* link:create-an-activity-sync[Activity Sync] does not create the
...
accessing link:calendar-settings-ct-cpg-settings-panel[CPG Settings
Panel]​.
* *Required* option added to the
link:calendar-settings-ct-cpg-settings-panel#h3__1888339674[Compact
...
* Add
link:ct-product-field-reference[isIgnoreComponentAvailability] flag
...
New link:new-calendar-management[Calendar] with improved usability
and interface. Now you can
link:calendar-interface-and-activities[manage activities] and
link:calendar-settings-ct-cpg-settings-panel[configure] the
...
the link:trigger-settings[Trigger Settings] record is absent for
...
​The link:dynamic-group-settings[Dynamic Group Settings] custom
...
Download the
link:/resources/Storage/Files/CT-CPG-Summer-%2719-Release-Notes.pdf[CT
