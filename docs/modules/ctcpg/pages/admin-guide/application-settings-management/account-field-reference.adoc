...
[NOTE] ==== It is possible link:admin-guide/targeting-and-marketing-cycles-management/add-a-new-division[to
...
the link:admin-guide/calendar-management/legacy-calendar-management/index[Legacy Calendar Management] for more
details).
