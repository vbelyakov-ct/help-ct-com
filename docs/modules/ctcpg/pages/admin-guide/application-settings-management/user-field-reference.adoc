...
[NOTE] ==== In case of link:admin-guide/targeting-and-marketing-cycles-management/add-a-new-division[creating new
...
select link:admin-guide/calendar-management/legacy-calendar-management/configuring-calendar/configure-settings-for-the-calendar/index[the assigned
division].
...
link:admin-guide/targeting-and-marketing-cycles-management/add-a-new-division#h2__1661054417[be added to the page layout
