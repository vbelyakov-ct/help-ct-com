...
link:admin-guide/next-activity-management/enable-the-next-activity-functionality[be enabled].
...
link:admin-guide/next-activity-management/create-a-new-record-of-next-call-settings[in the Next Call
Settings record]. ====
