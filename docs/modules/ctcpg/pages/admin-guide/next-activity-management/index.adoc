...
The representative can transfer data, for example, xref:admin-guide/objectives-management/objective-creating.adoc#h2_1099816968[goals and notes], from the finished _CT CPG Activity_ record to the next _CT CPG Activity_ record related to the same _Account_ and/or _Contact_ record.
