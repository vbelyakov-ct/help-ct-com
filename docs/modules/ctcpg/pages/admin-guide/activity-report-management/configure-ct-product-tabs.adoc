...
link:activity-report-management#h2__1515393312[the _Activity
...
link:admin-guide/ct-products-and-assortments-management/ref-guide/index#h2__160781133[the
...
. link:admin-guide/activity-report-management/configure-ct-product-tabs#h2_1832965105[Map the _CT
...
. link:admin-guide/activity-report-management/configure-ct-product-tabs#h2__1475822200[Customize fields to
display] on the *CT Product* tab.
. link:admin-guide/ct-products-and-assortments-management/create-a-new-ct-product[Create new _CT Product_
...
link:admin-guide/targeting-and-marketing-cycles-management/index[In case of using
...
link:company-product-tab-settings[Company Product Tab Setting],
link:competitor-product-tab-settings[Competitor Product Tab
Setting], link:pos-material-tab-settings[POS Material Tab Setting].
====
