...
. link:admin-guide/activity-report-management/configure-an-expenses-tab#h2_874578172[Map the
...
. link:admin-guide/activity-report-management/configure-an-expenses-tab#h2__1964705955[Customize fields to
...
link:expenses-tab-settings[here]. ====
