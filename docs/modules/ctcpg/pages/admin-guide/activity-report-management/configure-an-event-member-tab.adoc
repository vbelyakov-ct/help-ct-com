...
. link:admin-guide/activity-report-management/configure-an-event-member-tab#h2_899645149[Map the Event
Member tab and the _Activity Report_ page] for the
corresponding _Activity_ record type via the appropriate custom setting.
. link:admin-guide/activity-report-management/configure-an-event-member-tab[Customize fields to display]
on the *Event Member* tab.
. link:admin-guide/activity-report-management/work-with-the-activity-report-page#h2_867056578[Add members]
...
link:event-member-tab-settings[here]. ====
