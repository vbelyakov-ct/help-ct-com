...
xref:admin-guide/activity-report-management/index.adoc[Activity Reports] display all
...
xref:admin-guide/activity-report-management/work-with-the-activity-report-page.adoc[for further work].
