...
link:admin-guide/ct-products-and-assortments-management/index[_CT Products_ and
_Assortments_] within
link:admin-guide/targeting-and-marketing-cycles-management/index[the _Marketing
...
link:admin-guide/activity-report-management/ref-guide/activity-report-interface[the related tabs displaying] on
link:admin-guide/activity-report-management/index[the configured _Activity Report_
page] for the corresponding _Activity_ record type.
* The _Activity Data_ record types are used for
link:admin-guide/activity-report-management/configure-ct-product-tabs[tracking _CT Products_],
displaying link:admin-guide/activity-report-management/configure-an-event-member-tab[event participants]
and link:admin-guide/activity-report-management/configure-an-expenses-tab[expenses], and
link:admin-guide/activity-report-management/configure-a-special-trackings-tab[tracking tasks and
objectives].
