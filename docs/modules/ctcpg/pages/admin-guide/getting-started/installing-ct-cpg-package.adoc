...
link:admin-guide/getting-started/preparing-the-salesforce-organization[allow users to relate
...
Admin can link:permission-settings[set the permissions] for
