...
_link:activity-sync-management.html[Activity Sync]_ setting with an
_Event_ object.
...
* CTCPG__StartDate__c
* CTCPG__EndDate__c
* link:admin-guide/configuring-activity-sync/activity-sync-management/custom-metadata-type-activity-sync[fields specified] in
