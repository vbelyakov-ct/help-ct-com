...
* Assign the related
_ xref:configuring-targeting-and-marketing-cycles.html[Marketing Cycle]_
record;
...
* Link the corresponding _Target Frequency_ record;
* Fill in _ xref:objective-creating.html[Objectives]_ if specified.
...
_ xref:creating-the-next-activity.html[Next Call]_ functionality is
configured. 
* Grant access to the Joint Visit Report for relevant users if
specified.
