...
xref:admin-guide/cpg-custom-settings/application-settings.adoc.html[Application Settings] record,
...
enabled on the xref:admin-guide/cpg-custom-settings/application-settings.adoc.html[Application
Settings] record, xref:admin-guide/targeting-and-marketing-cycles-management/add-a-new-division[the fields with division
...
|If the CTCPG\__EnableAdvancedTFLogic__c checkbox enabled on
the xref:admin-guide/cpg-custom-settings/application-settings.adoc.html[Application
Settings] record, xref:admin-guide/targeting-and-marketing-cycles-management/add-a-new-division[the fields with division
