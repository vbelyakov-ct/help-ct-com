...
link:admin-guide/targeting-and-marketing-cycles-management/index[manage _Target
Frequency_ records].
...
link:admin-guide/targeting-and-marketing-cycles-management/add-a-new-division[the fields with division values] will be
...
enabled on the _link:application-settings.html[Application
Settings]_ record, link:admin-guide/targeting-and-marketing-cycles-management/add-a-new-division[the fields with division
...
|If the CTCPG__EnableAdvancedTFLogic__c checkbox enabled on
the _link:application-settings.html[Application
Settings]_ record, link:admin-guide/targeting-and-marketing-cycles-management/add-a-new-division[the fields with division
