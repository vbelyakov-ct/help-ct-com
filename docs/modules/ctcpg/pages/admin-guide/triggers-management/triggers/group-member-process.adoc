...
_link:configuring-cpg-groups.html[CPG Group Member]_
link:admin-guide/cpg-groups-management/index[] records that were manually added.
...
link:admin-guide/cpg-groups-management/create-and-update-a-dynamic-cpg-group#h2_1766846133[is being
