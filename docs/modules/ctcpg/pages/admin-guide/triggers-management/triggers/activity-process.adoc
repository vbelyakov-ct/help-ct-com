...
in case of using the _link:activity-sync-management.html[Activity
...
checkbox of the _link:application-settings.html[Application Settings]_
record.
...
_link:configuring-activity-sync.html[Activity Sync]_ setting.
...
based on link:admin-guide/targeting-and-marketing-cycles-management/add-a-new-division[the _User_ division] and the
_link:marketing-cycle-linking-settings.html[Marketing Cycle Linking
Settings]_ record.
