...
in case of using the xref:admin-guide/configuring-activity-sync/index.adoc.html[Activity
Sync] functionality, according to the specified business logic.
...
checkbox of the xref:admin-guide/cpg-custom-settings/application-settings.adoc.html[Application Settings]_
record.
...
xref:admin-guide/configuring-activity-sync/index.adoc[Activity Sync] setting.
...
xref:marketing-cycle-linking-settings.html[Marketing Cycle Linking
Settings] record.
