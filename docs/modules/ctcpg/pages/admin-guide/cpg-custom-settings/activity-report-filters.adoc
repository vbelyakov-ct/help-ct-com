...
link:admin-guide/activity-report-management/create-a-new-filter-for-the-activities-list[manage filters]
for the available activities in the *Activities List* __ section on the
_link:activity-report-interface.html[Activity Report]_ page.
