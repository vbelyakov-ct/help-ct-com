...
link:admin-guide/ct-products-and-assortments-management/ref-guide/index#h2__160781133[tracking
...
link:admin-guide/activity-report-management/configure-an-inventory-tab[create a new record].
