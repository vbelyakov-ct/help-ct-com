...
type is
link:admin-guide/targeting-and-marketing-cycles-management/ref-guide/index#h2__1482834092[available
by default].
* You can
link:admin-guide/targeting-and-marketing-cycles-management/enable-activity-linking-to-the-marketing-cycle[specify other
