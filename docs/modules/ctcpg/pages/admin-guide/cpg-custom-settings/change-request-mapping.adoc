...
link:admin-guide/change-request-management/change-request-field-reference[Change Request] object. This
...
|The record type of the link:admin-guide/change-request-management/change-request-field-reference[Change
Request] object.
