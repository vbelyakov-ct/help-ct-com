...
link:admin-guide/targeting-and-marketing-cycles-management/ref-guide/index[available by
default].
* In case of link:admin-guide/targeting-and-marketing-cycles-management/add-a-new-division[creating new divisions], you
should
link:admin-guide/targeting-and-marketing-cycles-management/division-a-new-record-of-division-target-frequency-settings[create
...
link:admin-guide/targeting-and-marketing-cycles-management/add-the-manage-targets-button[the Target Assignment dialog
box] on the *Account* or *Contact* tab.
* If disabled, the division categories are not in use.

For example, if you have
a link:admin-guide/targeting-and-marketing-cycles-management/ref-guide/index#h3_2015528788[Call
Rate] record for the specific division category,
link:admin-guide/targeting-and-marketing-cycles-management/creating-a-new-record-of-target-frequency[planned calls] from
this record will not be copied into the Target Frequency record for the
target Account or Contact link:admin-guide/targeting-and-marketing-cycles-management/create-targeting-lists[via the
targeting process].
