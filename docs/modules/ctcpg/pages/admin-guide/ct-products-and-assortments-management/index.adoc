...
link:admin-guide/getting-started/configuring-application-settings[After configuring the main
...
link:ct-products-and-assortments-management[_CT products_ and
_Assortments_] according to your company goals:

. link:create-a-new-ct-product[Add the required products] to the
...
products—_link:create-an-assortment.html[Assortments]_—based on _CT
...
. link:assign-assortments-to-accounts[Assign
available assortments] to the clients who should have this
product list while it is active. 
. link:assign-inventories-to-accounts[Assign inventories] for the
