...
link:configuring-activity-report[on the _Activity Report_ page]
or, link:create-a-new-record-of-marketing-detail-tracking[in case
of using the marketing cycle], will be
link:create-a-marketing-cycle[automatically pulled] to
...
link:configure-ct-product-tabs[on the _CT Product_ related tab] on
