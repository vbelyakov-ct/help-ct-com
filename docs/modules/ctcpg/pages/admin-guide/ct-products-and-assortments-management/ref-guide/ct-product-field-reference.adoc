...
link:admin-guide/configuring-ct-products-and-assortments/ref-guide/index#h2__160781133[The _CT
...
link:admin-guide/configuring-ct-products-and-assortments/ref-guide/product-component-field-reference[the product is a part of a
bundle].
