...
xref:admin-guide/calendar-management/new-calendar-settings-field-reference[Planning Calendar
...
and
xref:admin-guide/calendar-management/calendar-settings-ct-cpg-settings-panel#h3__1182969566[Drag
and Drop] settings
|===
...
[.apiobject]#CTCPG\__Activity__c# object, please use
