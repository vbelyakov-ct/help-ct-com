...
xref:admin-guide/calendar-management/calendar-settings-ct-cpg-settings-panel.adoc#h3__1934044513[Target Objects],
xref:admin-guide/calendar-management/calendar-settings-ct-cpg-settings-panel.adoc#h3_1454440899[Pop-Up] and xref:admin-guide/calendar-management/calendar-settings-ct-cpg-settings-panel.adoc#h3__1182969566[Drag and Drop] settings
|===
