...
link:admin-guide/new-calendar-management/new-calendar-settings-field-reference[Planning Calendar
...
and
link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#h3__1182969566[Drag
and Drop] settings
|===
