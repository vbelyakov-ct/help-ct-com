...
link:admin-guide/new-calendar-management/calendar-interface-and-activities[Calendar]:
...
link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel[Calendar Settings (CT
CPG Settings Panel)].
