...
the link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#h3__1934044513[CT
...
link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#h3_1454440899[CT CPG
Settings Panel]). 
...
the link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#show-hierarchy[CT
...
the link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#h3_951662406[CT
CPG Settings Panel].#
...
the link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#h3__1948960707[CT
CPG Settings Panel].#
* [#h2_989699835]#Activities can have titles and subtitles, you can
configure them in
the link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#h3__1888339674[CT
CPG Settings Panel].#
...
the Calendar,
use link:admin-guide/new-calendar-management/custom-labels-for-translating-the-calendar-interface[custom
labels].
...
link:admin-guide/new-calendar-management/custom-permissions-for-using-calendar[custom permissions] to
...
(link:admin-guide/new-calendar-management/calendar-interface-and-activities#h3_1490113349[moving],
resizing to change activity duration,
link:admin-guide/new-calendar-management/calendar-interface-and-activities#h3__786187553[changing
status] etc.) apply to database immediately. However, the
link:admin-guide/new-calendar-management/calendar-interface-and-activities#h3__786187553[Edit Activity]
...
to the
link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#h3__1888339674[Default
duration] setting.  
* If needed, toggle *Compact form* or *Detailed form* and fill out their
fields:
[NOTE] ==== If the compact form is configured as *Required* in
the link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#compact-form[CT
...
specified link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#general[Interval
between drag and drops].
* *Start Date* and *End Date* are pre-filled according to
the link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#h3__1888339674[Default
duration] setting. 
...
it
is link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#h3_1454440899[enabled
in the settings]). 
...
the link:admin-guide/new-calendar-management/custom-permissions-for-using-calendar[Full Access To Other
