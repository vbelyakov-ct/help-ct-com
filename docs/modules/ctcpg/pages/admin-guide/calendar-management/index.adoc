...
* Get familiar with
the xref:admin-guide/calendar-management/calendar-interface-and-activities[Calendar interface and
activities management].
* Learn about xref:admin-guide/calendar-management/calendar-settings-ct-cpg-settings-panel[Calendar
settings].
* xref:calendar-interface[]Learn
about xref:admin-guide/calendar-management/custom-labels-for-translating-the-calendar-interface[custom
labels for translating the Calendar interface].
* Check the xref:admin-guide/calendar-management/custom-permissions-for-using-calendar[required
permissions and field names rules] for using Calendar.
* Read field description for
the xref:admin-guide/calendar-management/new-calendar-settings-field-reference[Planning Calendar
