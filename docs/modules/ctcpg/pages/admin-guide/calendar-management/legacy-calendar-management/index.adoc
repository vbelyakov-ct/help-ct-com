...
link:admin-guide/new-calendar-management/index[new planning Calendar].

In this section:

* Get familiar link:calendar-interface[with the _Calendar_
interface] for each _Calendar_ tab;
* View the default _link:calendar-management.html#h2_1141916048[Calendar
Tab Settings]_ and _link:calendar-management.html#h2_1857539359[Calendar
Settings]_.
* Read field description for
_link:planning-calendar-settings-field-reference.html[Planning Calendar
Settings]_link:skill-mark-field-reference.html[ ]objects.
* link:configuring-calendar[Configure Calendar] for managing
activities. [#ebm]##

[[h2_1141916048]]
=== Calendar Tab Settings

By default, the following _link:calendar-tab-settings.html[Calendar Tab
...
the link:admin-guide/configuring-targeting-and-marketing-cycles/index[Configuring
...
* link:calendar-interface#h2__1884555900[For the Hierarchy tab],
