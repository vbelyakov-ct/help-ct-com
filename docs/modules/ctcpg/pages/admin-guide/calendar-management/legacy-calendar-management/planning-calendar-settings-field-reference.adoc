...
store link:configure-settings-for-the-calendar[the CT CPG Calendar
...
[.object]#link:add-the-custom-holidays-dictionary[Dictionary]
#object.
...
create on the
corresponding link:manage-activities-on-the-table-view-tab[Table
View], link:manage-activities-on-the-hierarchy-view-tab[Hierarchy
View], and
link:manage-activities-on-the-employees-calendar-tab[Employees]
...
|If enabled, link:add-the-custom-holidays-dictionary[the additional
...
Area(131072) a|
The API names of link:manage-list-views-for-the-calendar[the list
