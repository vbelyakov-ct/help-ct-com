...
store link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel[the CT CPG
...
Defines if the
link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#compact-form[Compact
...
link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#h3_951662406[Month]
...
link:admin-guide/configuring-targeting-and-marketing-cycles/add-a-new-division[The calendar division]. Available values by
default:
...
corresponding
link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#h3_1454440899[Pop-Up] setting
...
link:admin-guide/new-calendar-management/calendar-interface-and-activities#h4_2089059603[drag-and-drop]
of target objects.
...
for
link:admin-guide/new-calendar-management/calendar-settings-ct-cpg-settings-panel#h3__1948960707[mapping
