...
xref:admin-guide/targeting-and-marketing-cycles-management/index.adoc#h2_83089996[here].
====

* Track the number of planned calls for the
target _Account_ and _Contact_ records.
* xref:admin-guide/ct-products-and-assortments-management/index[Track specific
