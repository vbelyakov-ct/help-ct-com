...
* link:admin-guide/configuring-targeting-and-marketing-cycles/specify-categories-for-marketing-detail-tracking#h2_1104532017[Add
the new division categories] for the
link:marketing-detail-tracking-field-reference[Marketing Detail
Tracking] object;
* link:admin-guide/configuring-targeting-and-marketing-cycles/specify-categories-for-marketing-detail-tracking#h2_566398107[Assign division
categories] to
the link:targeting-and-marketing-cycle-management#h2_83089996[record
types of the Marketing Detail Object].
* link:admin-guide/configuring-targeting-and-marketing-cycles/specify-categories-for-marketing-detail-tracking#h2__1618421469[Update
dependent picklist] for the *Type* field to have an ability to select
new division categories when
link:admin-guide/configuring-targeting-and-marketing-cycles/create-a-new-record-of-marketing-detail-tracking[creating new
Marketing Detail Tracking records].

[[h2_1104532017]]
=== Add a Division Category

link:admin-guide/configuring-targeting-and-marketing-cycles/add-a-new-division[After the new division creation], add
...
. Add link:admin-guide/configuring-targeting-and-marketing-cycles/add-a-new-division#h2__81078948[the new division
