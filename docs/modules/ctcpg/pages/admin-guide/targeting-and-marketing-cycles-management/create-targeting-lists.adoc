...
When xref:admin-guide/targeting-and-marketing-cycles-management/add-a-new-division[the new division is specified] and
xref:admin-guide/targeting-and-marketing-cycles-management/create-a-marketing-cycle[assigned for the new marketing
cycle]:

* xref:admin-guide/targeting-and-marketing-cycles-management/create-targeting-lists#h2__542322944[target Account and
Contact records] that a user should visit during
xref:admin-guide/targeting-and-marketing-cycles-management/create-a-marketing-cycle[the marketing cycle period];
* xref:admin-guide/targeting-and-marketing-cycles-management/create-targeting-lists#h2__682035545[use a filter] to find
untargeted records or to find records
xref:admin-guide/targeting-and-marketing-cycles-management/create-targeting-lists#h2_1108913478[that should be removed
from targets].
...
linked to xref:admin-guide/targeting-and-marketing-cycles-management/create-a-new-record-of-marketing-detail-tracking[the
created Marketing Detail Tracking record] with
xref:admin-guide/targeting-and-marketing-cycles-management/specify-categories-for-marketing-detail-tracking[the assigned
division category D].
