...
record within link:admin-guide/configuring-targeting-and-marketing-cycles/create-a-marketing-cycle[the active and given
marketing cycle].

The link:target-frequency-process[TargetFrequencyProcess] trigger
automatically creates active _Target Frequency_ records when
the _Account_ or Contact records link:admin-guide/configuring-targeting-and-marketing-cycles/create-targeting-lists[are
...
from the link:marketing-detail-tracking-field-reference[Marketing
Detail Tracking] record of
the link:targeting-and-marketing-cycle-management#h3_2015528788[Call
Rate] record type if:
