...
added to the _link:user-field-reference.html[User]_
link:user-field-reference[] and
_link:marketing-cycle-field-reference.html[Marketing Cycle]_ records.
====
...
of link:account-field-reference[the _Account_ record], that
...
link:contact-field-reference[the _Contact_ record] in the *Contact
...
link:../Storage/project-ct-cpg/CTCPGDOC/attachments/58822346/588320221.png[available
