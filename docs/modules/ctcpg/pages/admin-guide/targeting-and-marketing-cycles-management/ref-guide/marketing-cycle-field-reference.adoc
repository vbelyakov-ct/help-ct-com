...
the _link:application-settings.html[Application Settings]_ record.
...
* You
can specify link:admin-guide/configuring-targeting-and-marketing-cycles/enable-activity-linking-to-the-marketing-cycle[another
activity linking].
...
record of link:application-settings[Application Settings].
