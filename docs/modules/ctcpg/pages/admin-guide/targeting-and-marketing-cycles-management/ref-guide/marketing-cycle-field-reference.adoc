...
You can specify the behavior of the system for the related status on the record of xref:admin-guide/cpg-custom-settings/application-settings.adoc[Application Settings].
