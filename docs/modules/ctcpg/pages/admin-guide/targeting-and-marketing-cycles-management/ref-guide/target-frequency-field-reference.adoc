...
|The related _link:account-field-reference.html[Account]_ record.
...
related _link:contact-field-reference.html[Contact]_ record.
...
Cycle) |The related _link:marketing-cycle-field-reference.html[Marketing
Cycle]_ record.

|Marketing Detail Tracking
|CTCPG__MarketingDetailTrackingId__c |Lookup(Marketing Detail
Tracking) |The
related _link:marketing-detail-tracking-field-reference.html[Marketing
Detail Tracking]_ record.

|Owner |CTCPG__OwnerId__c |Lookup(User) |The related
_link:user-field-reference.html[User]_ record.
