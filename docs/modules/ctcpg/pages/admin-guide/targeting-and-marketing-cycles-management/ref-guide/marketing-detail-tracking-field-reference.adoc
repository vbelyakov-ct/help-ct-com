...
|xref:admin-guide/targeting-and-marketing-cycles-management/specify-categories-for-marketing-detail-tracking.adoc#h2__1618421469[The assigned object type] on the _Marketing Cycle_ record.
|===
