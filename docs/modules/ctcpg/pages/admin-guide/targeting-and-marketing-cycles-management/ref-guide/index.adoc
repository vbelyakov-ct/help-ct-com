...
link:admin-guide/configuring-targeting-and-marketing-cycles/ref-guide/targeting-and-marketing-cycle-management#h2__1971775911[Division
Target Frequency Settings] and
link:admin-guide/configuring-targeting-and-marketing-cycles/ref-guide/targeting-and-marketing-cycle-management#h2_890863050[Target
Frequency Settings].
* Learn about
the link:admin-guide/configuring-targeting-and-marketing-cycles/ref-guide/targeting-and-marketing-cycle-management#h2__252001192[Marketing
Detail Tracking object] and
the link:admin-guide/configuring-targeting-and-marketing-cycles/ref-guide/targeting-and-marketing-cycle-management#h2__1482834092[preconfigured
Marketing Cycle record].
* Read field description for
the link:marketing-detail-tracking-field-reference[Marketing Detail
Tracking], link:marketing-cycle-field-reference[Marketing
Cycle], and link:target-frequency-field-reference[Target
Frequency]link:skill-mark-field-reference[ ]objects.



link:admin-guide/configuring-targeting-and-marketing-cycles/index[Configure targeting
...
in link:application-settings-management[the default _Global_ record
...
You can create link:admin-guide/configuring-targeting-and-marketing-cycles/add-a-new-division[new divisions] and specify
them in the _Default Target Frequency Settings_ records.

[[h2_890863050]]
=== Target Frequency Settings

The link:target-frequency-settings[Target Frequency Settings]
...
link:admin-guide/configuring-targeting-and-marketing-cycles/create-a-marketing-cycle[Create a new Marketing Cycle
record] with the appropriate parameters
and link:admin-guide/configuring-targeting-and-marketing-cycles/enable-activity-linking-to-the-marketing-cycle[enable the
...
are link:admin-guide/configuring-targeting-and-marketing-cycles/ref-guide/targeting-and-marketing-cycle-management#h2_83089996[a few
...
* link:admin-guide/configuring-targeting-and-marketing-cycles/ref-guide/targeting-and-marketing-cycle-management#h3_2015528788[Call
Rate]
* link:admin-guide/configuring-targeting-and-marketing-cycles/ref-guide/targeting-and-marketing-cycle-management#h3_2122917811[Company
Product Tracking]
* link:admin-guide/configuring-targeting-and-marketing-cycles/ref-guide/targeting-and-marketing-cycle-management#h3_669576096[Competitor
Product Tracking]
* link:admin-guide/configuring-targeting-and-marketing-cycles/ref-guide/targeting-and-marketing-cycle-management#h3__2056569094[POS
Material]
* link:admin-guide/configuring-targeting-and-marketing-cycles/ref-guide/targeting-and-marketing-cycle-management#h3__843668850[Special
Tracking]
...
link:admin-guide/configuring-targeting-and-marketing-cycles/creating-a-new-record-of-target-frequency[which is
...
image:588241951.png[]
Go back to
link:admin-guide/configuring-targeting-and-marketing-cycles/ref-guide/targeting-and-marketing-cycle-management#MDTRecordTypes[the
...
link:configure-ct-product-tabs[Customize the Activity Report page]
...
Go back
to link:admin-guide/configuring-targeting-and-marketing-cycles/ref-guide/targeting-and-marketing-cycle-management#MDTRecordTypes[the
list of the Marketing Detail Tracking record types]. 
...
link:configure-ct-product-tabs[Customize the Activity Report
...
Go
back to link:admin-guide/configuring-targeting-and-marketing-cycles/ref-guide/targeting-and-marketing-cycle-management#MDTRecordTypes[the
list of the Marketing Detail Tracking record types].
...
link:configure-a-special-trackings-tab[Customize the Activity
