...
link:admin-guide/configuring-targeting-and-marketing-cycles/create-a-marketing-cycle[the _Marketing Cycle_ record] if:  
...
to the link:marketing-cycle-linking-settings[Marketing Cycle
Linking Setting];
* the _link:marketing-cycle-field-reference.html[Marketing
...
* link:admin-guide/configuring-targeting-and-marketing-cycles/enable-activity-linking-to-the-marketing-cycle#h2__884544412[Create
a checkbox] on the _Marketing Cycle_ object and
link:admin-guide/configuring-targeting-and-marketing-cycles/enable-activity-linking-to-the-marketing-cycle#h2__1809417075[add
...
the marketing cycle.
* link:admin-guide/configuring-targeting-and-marketing-cycles/enable-activity-linking-to-the-marketing-cycle#h2__1816263087[Create
a record] of _link:marketing-cycle-linking-settings.html[Marketing Cycle
...
the link:admin-guide/configuring-targeting-and-marketing-cycles/enable-activity-linking-to-the-marketing-cycle#h2__1816263087[Activity
Link] field.
* Select *Active*. 
. Click *Save*.

The new activity linking is enabled on
link:admin-guide/configuring-targeting-and-marketing-cycles/create-a-marketing-cycle[the _Marketing Cycle_ record].
