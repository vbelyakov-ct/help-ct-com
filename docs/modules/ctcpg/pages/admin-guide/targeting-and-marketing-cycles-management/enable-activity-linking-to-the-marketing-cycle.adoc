...
xref:admin-guide/targeting-and-marketing-cycles-management/create-a-marketing-cycle[the _Marketing Cycle_ record] if:
...
Linking Setting];
* the xref:marketing-cycle-field-reference.html[Marketing
Cycle] record is active.



Enable automatic linking for other _CT CPG Activity_ record types:

* xref:admin-guide/targeting-and-marketing-cycles-management/enable-activity-linking-to-the-marketing-cycle#h2__884544412[Create
a checkbox] on the _Marketing Cycle_ object and
xref:admin-guide/targeting-and-marketing-cycles-management/enable-activity-linking-to-the-marketing-cycle#h2__1809417075[add
...
the marketing cycle.
* xref:admin-guide/targeting-and-marketing-cycles-management/enable-activity-linking-to-the-marketing-cycle#h2__1816263087[Create
a record] of xref:marketing-cycle-linking-settings.html[Marketing Cycle
Linking Settings] to allow automatic linking.
...
the xref:admin-guide/targeting-and-marketing-cycles-management/enable-activity-linking-to-the-marketing-cycle#h2__1816263087[Activity
Link] field.
* Select *Active*.
. Click *Save*.

The new activity linking is enabled on
xref:admin-guide/targeting-and-marketing-cycles-management/create-a-marketing-cycle[the _Marketing Cycle_ record].
