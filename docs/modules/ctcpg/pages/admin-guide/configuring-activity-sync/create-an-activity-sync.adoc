...
When creating an _Activity_ object record with the _Visit_ record type:
...
When creating a __CT CPG Activity_ _ record with the _Visit_ record type, the _Task_ record with the _Meeting_ type will be created:
