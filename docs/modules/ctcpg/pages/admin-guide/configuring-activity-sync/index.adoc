...
xref:admin-guide/configuring-activity-sync/index.adoc[Activity Sync] is designed to merge
...
. Set up xref:admin-guide/configuring-activity-sync/create-an-activity-sync.adoc[Activity Sync] record. Map
