...
link:activity-sync-management[Activity Sync] is designed to merge
...
link:set-up-global-actions-new-task-and-new-event[global
actions] on the *Accounts* and *Contacts* tabs.
. Set up link:create-an-activity-sync[Activity Sync] record. Map
