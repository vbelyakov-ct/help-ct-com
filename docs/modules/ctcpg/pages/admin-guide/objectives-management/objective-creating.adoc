...
pre-configured xref:admin-guide/activity-report-management/index.adoc.html[Activity
Report] page.
...
using a pre-configured xref:admin-guide/activity-report-management/index.adoc.html[Activity
Report] page.
