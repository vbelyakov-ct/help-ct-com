...
* Get familiar with the link:cpg-group-field-reference[CPG Group]
and link:cpg-group-member-field-reference[CPG Group Members]
objects.
* Take a look at the difference between
link:admin-guide/cpg-groups-management/ref-guide/cpg-groups-management#h3__1554410513[static CPG groups] and
link:admin-guide/cpg-groups-management/ref-guide/cpg-groups-management#h3__1007999912[dynamic CPG groups].
* Learn link:admin-guide/cpg-groups-management/ref-guide/cpg-groups-management#h2_514682594[the SOQL builder
options] to create criteria for a group.



link:admin-guide/cpg-groups-management/index[Configure CT CPG groups] for managing
