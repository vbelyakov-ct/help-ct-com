...
* Take a look at the difference between xref:admin-guide/cpg-groups-management/ref-guide/index.adoc#h3__1554410513[static CPG groups] and xref:admin-guide/cpg-groups-management/ref-guide/index.adoc#h3__1007999912[dynamic CPG groups].
