...
. xref:admin-guide/workshops/workshop1-0-creating-basic-order/configuring-layout-settings-1-0/index.adoc[Create the appropriate
layouts] and xref:admin-guide/workshops/workshop1-0-creating-basic-order/configuring-totals-panel-setting-1-0.adoc[customize
the Totals panel].
