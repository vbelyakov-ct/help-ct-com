...
xref:auth-data-field-reference[Auth Data] records.
...
xref:freebie-condition-field-reference[Freebie Condition] object.
...
xref:calculation-types-field-reference[Calculation Type] object.
...
xref:freebie-condition-field-reference[Freebie Condition] does not
...
xref:condition-field-reference[Calculation Method] is set to
_Basic_.
...
xref:condition-field-reference[Condition] record.
...
Criteria 2.0] now works both in xref:web-service[Web Service] and
in-app discount calculator.
* xref:web-service#h3__795817566[Calculate discounts] feature works
both in xref:web-service[Web Service] and in-app discount
calculator.
...
xref:calculation-types[Condotoion Group] record.
...
* In future releases, use xref:web-service#h2_389205030[the new
...
xref:calculation-types-field-reference[Apply Condition Type] field
...
procedure, xref:calculation-types-field-reference[Calculation
Type], and xref:freebie-condition-field-reference[Freebie
Condition]:
...
xref:calculation-types#h3_1561772746[discount rate source].
