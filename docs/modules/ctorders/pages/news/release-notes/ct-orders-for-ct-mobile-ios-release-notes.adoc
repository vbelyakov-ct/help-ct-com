...
in the xref:offline-order#h4__1635896381[order cart] to get the
...
within the xref:delivery-management#h2__1374863314[Delivery
Summary] pop-up.
* The UX/UI improvement for[.object]#Quotas#:
** Display the current quota status in the
xref:offline-order#h4__1635896381[order cart] interface.
...
** xref:offline-order#h4__589780300[In the catalog and promotion
...
* On the xref:offline-order#h4__1635896381[Order Cart] screen, the
...
* xref:5-2-setting-up-the-delivery-summary[Delivery summary] window
