...
rep.
* xref:admin-guide/managing-ct-orders/catalog-management/catalog-management[The Catalog record] must be active and:
...
xref:order-line-item-field-reference[for Order Line Items] contains
