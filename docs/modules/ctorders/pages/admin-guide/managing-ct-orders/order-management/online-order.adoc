...
* *(4)* xref:admin-guide/workshops/workshop-1-0-creating-basic-order/complete-workshop-1-0-checkpoint/creating-a-delivery-1-0.adoc[The added delivery dates] with the product quantity per delivery. Click image:quantity-arrow-down.png[] or image:quantity-arrow-up.png[] on the delivery column header to sort by product quantity.
