...
link:workshop1-0-creating-basic-order[Workshop 1.0] helps you to
...
rep.
* link:admin-guide/managing-ct-orders/catalog-management/catalog-management[The Catalog record] must be active and:
** link:quick-start/creating-and-adding-catalogs-1-0[assigned to the current
account];
...
* The link:admin-guide/managing-ct-orders/catalog-management/catalog-data-model/catalog-line-item-field-reference[Catalog Line Item]
...
sales rep.
* link:admin-guide/managing-ct-orders/discount-management/promotions[The Promotion record] must be active and:
...
* The link:admin-guide/managing-ct-orders/discount-management/promotion-data-model/promotion-line-item-field-reference[Promotion Line Item]
...
Price Book and a link:admin-guide/managing-ct-orders/product-management/product-data-model/ct-price-book-line-item-field-reference[List
...
link:admin-guide/managing-ct-orders/sales-organization-management/settings-and-sales-organization-data-model/settings-fields-reference/filter-setting-field-reference/index[Filter Setting] is configured.
...
link:order-line-item-field-reference[for Order Line Items] contains
...
link:admin-guide/managing-ct-orders/sales-organization-management/settings-and-sales-organization-data-model/settings-fields-reference/layout-setting-field-reference[Object Settings] record with
the link:configuring-layout-settings-1-0[Layout Setting] record
...
with the link:admin-guide/managing-ct-orders/sales-organization-management/howtos/how-to-configure-totals-panel-setting[Totals Panel
Setting] record type. The maximum number of displayed fields is 4. If
the setting is not configured, link:ct-order-field-reference[the
Total Price and Total Discount fields] are displayed by default.
* *(3)* The CT Order button controls.
link:creating-a-delivery-1-0[]
** Click *Get Freebie* to
link:admin-guide/managing-ct-orders/freebies-management/index#h2_1556344363[distribute freebies].
...
for link:5-1-setting-up-a-delivery-split[splitting an order].
** Click *Save Draft* to save newly created order or changes in the
editing one. link:admin-guide/managing-ct-orders/order-management/index#h2_158967301[By default], the
...
If link:5-2-setting-up-the-delivery-summary[the Delivery Summary
...
* *(4)* link:creating-a-delivery-1-0[The added delivery dates] with
...
link:order-line-item-layout-setting-1-0[Layout Setting] record
type.
...
link:ct-order-field-reference[one] that was specified in the pop-up
