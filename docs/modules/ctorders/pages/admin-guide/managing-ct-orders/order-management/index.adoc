...
xref:configuring-an-address-settings-1-0[Address Setting], and,
optionally, specify
xref:adding-delivery-restrictions-to-an-order-1-0[Limit Setting].
. If you use the custom [.object]#Address# object,
xref:creating-a-relationship-between-custom-address-object-and-delivery-1-0.html[configure
...
. Specify xref:admin-guide/managing-ct-orders/catalog-management/catalog-management[Catalogs] and
...
. xref:admin-guide/managing-ct-orders/catalog-management/howtos/how-to-create-and-assign-catalog[Assign Catalogs],
...
. Additionally, specify xref:5-1-setting-up-a-delivery-split[Split
...
orders and xref:creating-a-delivery-1-0[set up deliveries].
...
Orders]xref:ct-order-data-model[]xref:price-tag.html[
]
