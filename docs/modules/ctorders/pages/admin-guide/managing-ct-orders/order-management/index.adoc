...
. xref:admin-guide/workshops/workshop1-0-creating-basic-order/configuring-an-account-1-0.adoc[Add permission] for creating orders for the corresponding Account record.
...
The setup is complete. The representative can create online or offline orders and xref:admin-guide/workshops/workshop1-0-creating-basic-order/complete-workshop-1-0-checkpoint/creating-a-delivery-1-0.adoc[set up deliveries].
