...
xref:admin-guide/managing-ct-orders/order-management/offline-order#h3_1847490047[3. Edit the Order Cart]
  ...
  xref:admin-guide/managing-ct-orders/order-management/offline-order#h4__589780300[3.1 Promotions and Catalogs]

  xref:admin-guide/managing-ct-orders/order-management/offline-order#h4__1635896381[3.2 Order Cart]
...
xref:admin-guide/managing-ct-orders/order-management/offline-order#h2_1980854273[4. Additional Options]
  ...
  xref:admin-guide/managing-ct-orders/order-management/offline-order#h3__419365112[4.2 Price Tags]

  xref:admin-guide/managing-ct-orders/order-management/offline-order#h3__639588894[4.3 Delivery Summary]
...
if the xref:web-service[Web Service] is disabled.
...
to xref:admin-guide/managing-ct-orders/discount-management/index#h2__1225315997[calculate discounts].
