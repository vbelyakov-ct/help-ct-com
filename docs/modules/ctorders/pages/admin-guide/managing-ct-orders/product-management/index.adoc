...
xref:catalog-management[Catalogs] and
xref:promotions[Promotions], and sales representatives used them
...
product—xref:ct-price-book-line-item-field-reference[CT Price Book
Line Item].
