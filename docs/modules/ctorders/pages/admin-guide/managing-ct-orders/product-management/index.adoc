...
link:catalog-management[Catalogs] and
link:promotions[Promotions], and sales representatives used them
for link:workshop1-0-creating-basic-order[creating orders]. You can
...
* Set up link:ct-price-book-field-reference[CT Price Books] and
*List Prices* for each
product—link:ct-price-book-line-item-field-reference[CT Price Book
Line Item].
...
link:managing-bundles[Managing Bundles]. ====
...
record.
. link:admin-guide/getting-started/setting-up-an-instance/creating-relationships-between-product-and-ct-orders-objects[Create
...
. link:managing-bundles[Create and configure bundles].
...
Item# records.
. link:creating-and-assigning-a-ct-price-book-1-0[Create and assign
a Price Book].
. link:adding-a-price-book-line-item-1-0[Set up product list price]
...
* link:managing-bundles[Managing Bundles]
* link:how-to-add-a-product[How to Add a Product]
* link:how-to-add-a-pricebook[How to Create and Assign a Price
Book]
* link:product-data-model[Product Data
Model]link:managing-bundles.html[
]
