...
Condition Types].
* Freebie management:
xref:admin-guide/managing-ct-orders/freebies-management/index#h3__316467656[Freebie Values] and
...
tab, two xref:auth-data-field-reference[Auth Data] records will be
