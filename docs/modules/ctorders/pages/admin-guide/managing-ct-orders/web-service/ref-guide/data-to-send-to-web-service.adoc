...
to xref:admin-guide/managing-ct-orders/web-service/index#h2__1477820419[User Permissions].
...
* The mapping is sent xref:admin-guide/managing-ct-orders/web-service/index#h3__364386004[via one of the
...
* The master data is sent xref:admin-guide/managing-ct-orders/web-service/index#h3__364386004[via one of
