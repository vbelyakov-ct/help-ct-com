...
|Lookup(Condition) a|
Specify the controlling xref:condition-field-reference[Condition].
...
xref:freebie-condition-field-reference[Freebie Condition].
...
appropriate xref:calculation-types-field-reference[Calculation
Type].
