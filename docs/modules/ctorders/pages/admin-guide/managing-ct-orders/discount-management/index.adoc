...
use xref:web-service[the Web Service] to execute calculations from
...
xref:condition-field-reference[Condition] and
...
* xref:calculation-types[Calculation Types]
* xref:calculate-discounts[Calculate
Discounts]xref:calculation-types.html[
]
* xref:discount-logs[Discount Logs]
* xref:links[Links]
* xref:promotions[Promotions]
...
Manage Discount Settings for a Promotion]xref:promotions.html[
]
