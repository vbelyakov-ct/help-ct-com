...
* The xref:admin-guide/managing-ct-orders/catalog-management/index.adoc#h2_457737850[Catalog Assignment] tab consists of two sections. The left list section displays a list of xref:./catalog-data-model/catalogs-field-reference.adoc[catalogs]. In the right list section, assign catalogs for accounts.
...
. xref:admin-guide/workshops/workshop1-0-creating-basic-order/configuring-layout-settings-1-0/index.adoc[Configure Layout Settings] for [.object]#Catalog Line Item# and [.object]#Catalog Assignment# objects.
