...
xref:quotas[quotas] and xref:admin-guide/managing-ct-orders/product-validation-in-order/limit-rules/index[limit rules].
...
the xref:admin-guide/managing-ct-orders/freebies-management/freebie-data-model/freebie-condition-field-reference/index[Freebie Condition] or
...
xref:admin-guide/managing-ct-orders/product-validation-in-order/product-availability/product-availability#product-availability[tap the info icon
...
Date* fields on xref:admin-guide/managing-ct-orders/discount-management/promotion-data-model/promotion-field-reference[Promotion] are
...
* xref:workshop-6-1-configuring-product-availability[Workshop 6.1:
