...
|Components |Components |Header |Header 3+^a|include::partial$bundle-not-supported.adoc[]
...
// comment: this bundle type is not supported since 25 R1
|Components |Components |Components |Header 3.4+^.^a|include::partial$bundle-not-supported.adoc[]
//Parent Bundle
...
//a|* If a product in the parent bundle is unavailable:
//** Product 1
...
|Header |Header |Components |Components
...
|Components |Header |Components |Components
//a| Parent Bundle
