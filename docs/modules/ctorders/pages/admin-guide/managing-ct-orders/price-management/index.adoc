...
xref:delivery-line-item-field-reference[Delivery Line Item] in the
order.
...
. xref:calculation-types[Calculation Type] is linked to the applied
...
* xref:pricing-procedure-v-2-steps[Pricing Procedure v. 2.0]
