...
specified in the link:calculation-types-field-reference[Calculation
Type] record.
...
[{plus}] link:javascript:void(0)[Standard Procedure: MULT]

.[-] Hide[%collapsible] ==== ====

[{plus}] link:javascript:void(0)[Standard Procedure: MULT (with
rounding)]

.[-] Hide[%collapsible] ==== ====

[{plus}] link:javascript:void(0)[Standard Multi-level Procedure]
