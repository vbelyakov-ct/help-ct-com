...
Since CT Orders 2.0, xref:pricing-procedure-v-2-steps[the pricing
...
xref:admin-guide/managing-ct-orders/price-management/ref-guide/pricing-procedure-v-1/pricing-procedure-v-1#h3__1124271170[Type Values Description]
table. ====
