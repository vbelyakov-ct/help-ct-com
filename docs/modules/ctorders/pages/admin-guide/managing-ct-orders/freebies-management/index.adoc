...
* It is not recommended to use *Freebie Value* __ if the same value for the minimum and maximum amount of product is set for _Freebie Level_, [.object]## as this can lead to a validation error.
====
