...
xref:admin-guide/managing-ct-orders/discount-management/index#h2__1585481109[Discount Calculation
process]. The rules which are used for calculation are manifested in the
xref:freebie-condition-field-reference[Freebie Condition] child
...
defined in the xref:freebie-condition-field-reference[Freebie
Condition].
...
* xref:freebie-management-tab[Freebie Management Tab]
