...
link:catalog-management[Catalog], link:promotions[Promotions],
link:how-to-set-up-delivery-summary[Delivery Summary] and
link:order-management[Order] layouts for Salesforce and the CT
Mobile app.
...
link:ct-order-field-reference[the CT Order object] has no record
types by default. ====
...
link:adding-ct-orders-to-the-ct-mobile-app-4-0[creating a new
order]. ====
...
Applies to link:ct-order-field-reference[CT Order] related objects
(link:order-line-item-field-reference[Order Line Item],
link:delivery-line-item-field-reference[Delivery Line Item],
link:calculated-discount-field-reference[Calculated Discount]) and
requires
...
currency while link:offline-order#h2_2044385779[creating order in
...
Assignment# to have the ability link:catalog-management[to add
...
Assignment# to have the ability link:promotions#h2__492952072[to
add products to the promotion and assign accounts].
*[.object]#Order Line Item# to view
link:online-order[product details in the order cart].
[NOTE] ==== It is highly recommended to set up the order layout
for each *Sales Organization* separately. ====



Additionally, link:adding-ct-orders-to-the-ct-mobile-app-4-0#h2_552129946[customize
