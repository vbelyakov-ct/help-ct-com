...
* xref:creating-limit-rules-with-conditions-6-2#h2__953788261[The
...
==== and a [.object]#Quota Template# on the same search level, the individual quota will be applied. For more information, refer to xref:admin-guide/managing-ct-orders/product-validation-in-order/quotas/index#h3__1386411308[Quota Search].#
