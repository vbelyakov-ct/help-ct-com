...
[.object]#Quotas ==== and [.object]#Quota Templates# will be applied to the orders. The search is done xref:admin-guide/managing-ct-orders/product-validation-in-order/quotas/index#h3_1386411308[in the following sequence].#
