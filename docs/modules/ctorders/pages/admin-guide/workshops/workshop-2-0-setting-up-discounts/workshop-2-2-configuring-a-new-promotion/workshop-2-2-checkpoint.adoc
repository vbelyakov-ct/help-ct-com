...
* *Order Type*: _Order_.
* *Account*: select an xref:admin-guide/workshops/workshop1-0-creating-basic-order/configuring-an-account-1-0[account],
which is allowed to place orders.
* *Price
Book*: xref:admin-guide/workshops/workshop1-0-creating-basic-order/creating-and-assigning-a-ct-price-book-1-0/index[price book]
you created earlier.
