...
First, create a _Freebie Type_ record with the _Prioritized_ record type to apply only the one matched condition that is a priority among all suitable conditions:
