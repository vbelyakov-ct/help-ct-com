...
. If you created order in the Order Module, xref:ctmobile:ios/mobile-application/synchronization/synchronization-launch/index.adoc[launch synchronization] in CT Mobile.
