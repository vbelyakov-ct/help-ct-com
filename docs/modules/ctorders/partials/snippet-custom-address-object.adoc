...
. xref:admin-guide/workshops/workshop1-0-creating-basic-order/configuring-an-address-settings-1-0/creating-a-relationship-between-custom-address-object-and-delivery-1-0.adoc[Create a lookup] from the [.object]#Delivery# object to the custom [.object]#Address# object.
