...
Go back to link:remote-detailing-f-a-q.html#GoBacktoMiniTOC[the F.A.Q.
list].
...
link:remote-detailing-ui-basics.html[here].

[[h3_778333580]]
==== Salesforce Side

In Salesforce, click
link:remote-detailing-launch-salesforce-side.html[the invite link or the
...
link:remote-detailing-launch-the-ct-mobile-app.html[Tap the invite link]
...
If the link:ct-mobile-control-panel-presenter.html#h3_341694305[Call
...
. link:clm-activity.html[The current Activity record] has no assigned
CLM presentations and custom scenarios.
link:remote-detailing-apex-trigger-classes-and-quick-action.html#h3__2024838382[Click
the Applications button] to specify the CLM presentations set.
. link:clm-settings.html[The incorrect record of CLM Settings] for the
current user's profile. The Remote Detailing should be enabled in
link:ct-mobile-control-panel-presenter.html[CT Mobile Control Panel:
Presenter]/link:ct-mobile-control-panel-remote-detailing-new.html[CT
...
link:remote-detailing-1-0-ui-for-participants.html[here].
...
link:remote-detailing-f-a-q.html#h2_250361472[the bandwidth and
...
link:remote-detailing-f-a-q.html#h3_1979411778[mobile browsers] due to
their limitations.
...
. Previously, check
link:remote-detailing-f-a-q.html#SupportedBrowsers[the supported
browsers on devices].
...
The same link:ct-presenter.html[CLM presentations] and custom scenarios
as for the *Application* module in the CT Mobile app can be used for
*Remote Detailing*.

* link:clm-application.html[CLM presentation] should be active and
...
* Check link:requirements-and-media-file-formats.html[requirements and
...
clicks cannot be tracked for link:remote-detailing-statistics.html[the
statistics].
...
participants.
* Specify the
link:ct-mobile-control-panel-presenter.html#h3_949497961[CRM Data
Streaming Enabled]/
link:ct-mobile-control-panel-remote-detailing-new.html#h4_1433734342[CRM
...
link:remote-detailing-apex-trigger-classes-and-quick-action.html[add and
use the Applications button on the Activity record in Lightning
Experience].
** For *Remote Detailing 2.0*, you can link:changing-slides.html[switch
...
link:clm-application.html[Application] record to copy and insert the
...
link:publishing-clm-presentations.html#h3_1098755975[renew slides] for
...
familiar with link:js-bridge-methods-availability.html[the list of the
