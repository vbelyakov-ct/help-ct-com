...
link:ct-mobile-control-panel-calendar.html#h2_70500171[CT Mobile Control
Panel: Calendar]/link:ct-mobile-control-panel-activities-new.html[CT
...
On the CLM presentation record, link:clm-application.html[check the
