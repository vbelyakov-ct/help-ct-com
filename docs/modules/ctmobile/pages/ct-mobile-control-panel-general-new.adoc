...
Settings that may be used for link:mobile-layouts-maps.html[the Maps
...
link:ct-mobile-control-panel-general-new.html#h3__1092547330[Account
Full Address] field. ====
...
real-time via the link:geolocation-center.html[Geolocation Center] in
Salesforce.
