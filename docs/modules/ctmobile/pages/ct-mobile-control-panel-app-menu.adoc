...
For the link:home-screen.html[Home screen], enable the *Customizable
Home screen* option. Add, size, and arrange widgets.

For link:managing-offline-objects.html[offline objects],
link:grouping-records.html[group records] by the criterion.

ifndef::andr,win,kotlin[]

For offline objects, enable link:online-records-fetching.html[online
record fetching].

For the link:applications.html[Applications] module,
link:grouping-records.html[group records] by the criterion.

For the link:links-list.html[Links] module, specify resources and web
pages.

ifndef::kotlin[]

For the link:routes.html[Routes] module, specify the ascending or
...
* link:app-menu.html[Configuring App Menu]
