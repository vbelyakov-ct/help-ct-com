...
link:remote-detailing-launch.html[Remote Detailing Launch].
...
Detailing 2.0] and link:remote-detailing-ui-basics.html[Remote Detailing
UI Basics].
...
other link:js-bridge-methods-availability.html[JS Bridge methods]
...
link:clm-applicationstats.html[the Application Stats object] is created
...
link:clm-applicationstats.html[the Application Stats object] per slide
