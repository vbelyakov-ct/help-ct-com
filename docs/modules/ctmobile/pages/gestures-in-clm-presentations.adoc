...
link:applications.html[Application] module, on
link:mobile-layouts-applications.html[the mobile layout], and
...
link:clm-application.html[CLM presentation] record.
...
Display link:clm-presentation-controls.html[the action menu] with
available options.
