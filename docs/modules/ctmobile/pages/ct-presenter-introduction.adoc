...
If you want to use link:migration-to-remote-detailing-2-0.html[Remote
Detailing 2.0], install the
link:ct-mobile-package-release-notes.html#h2_1028401963[CT Mobile
...
. Go to link:ct-mobile-control-panel-tools.html#h3_2011978[CT Mobile
Control Panel:
...
. Check link:user-permissions.html[user permissions] to CLM objects.
. Get familiar with link:requirements-and-media-file-formats.html[the
...
Look through
link:../Storage/project-ct-mobile-en/PDF/Creating-Interactive-CLM-Presentations-for-iOS-(en).pdf[our
...
Look through
link:../Storage/project-ct-mobile-en/PDF/Creating-Interactive-CLM-Presentations-for-Windows-(en).pdf[our
guide] for creating interactive CLM Presentations to know how to add
content, such as media and specific interactions, on slides and properly
upload ready CLM presentations to Salesforce.

CT Presenter provides the link:application-editor.html[Application
Editor]:
...
* Add link:creating-clm-presentation-from-powerpoint.html[PowerPoint],
link:creating-clm-presentation-from-pdf.html[PDF], or
link:creating-clm-presentation-from-jpeg-jpg.html[JPEG/JPG] files to
convert into a CLM presentation.



CT Presenter provides the link:plain-application-editor.html[Plain
Application Editor]:

* Create and edit CLM presentations
link:creating-plain-clm-presentation.html[using the web interface].
* link:creating-plain-clm-presentation-using-templates.html[Create your
templates], and slides with images, texts, videos, etc.
* link:creating-plain-clm-presentation-from-powerpoint.html[Import
PowerPoint] into an existing template and convert it to a CLM
presentation.



Use link:custom-scenario-editor.html[the custom scenario editor] to
create, edit and delete custom scenarios.

ifdef::ios,win[]

In the CT Mobile app, you can
specify link:clm-customscenario.html[custom scenarios] with the help of
the link:applications.html#h3_1236408094[Mobile Scenario Editor] in the
Application module.
...
* link:publishing-clm-presentations.html#h3_1098755975[Renew slides] of
...
link:publishing-clm-presentations.html#h2_1149854286[on the Applications
tab].
* Publish a CLM presentation by using
link:publishing-clm-presentations.html#h2_104022594[the Application
Editor].
...
to link:mobile-application-setup.html#CLMDisplayMode[specify the CLM
...
* The link:clm-application.html[CLM presentation] should be active and
available offline.
...
* link:applications.html[The Application module] allows reviewing CLM
presentations uploaded from Salesforce.
* You can configure link:mobile-layouts-applications.html[the mobile
...
* Use pre-configured link:gestures-in-clm-presentations.html[gestures].
* Double-tap the left or right side of the screen to view the
link:clm-presentation-controls.html[control buttons].
* Double-tap the bottom of the screen to display the selected scenario
and slide in link:clm-navigation-in-clm-presentations.html[a branch] for
rapid switching between the slides.
* link:js-bridge-api.html[JS Bridge methods] are available from within
the CLM presentation if specified on the slide markup.
* During the CLM presentation, specific user actions are captured and
collected in the link:clm-applicationstats.html[Application Stats]
...
link:remote-detailing-f-a-q.html[Remote Detailing: F.A.Q]. ====
...
link:remote-detailing-launch-the-ct-mobile-app.html[for Remote Detailing
on the Activity record in the CT Mobile app].
* The presenter can launch a CLM presentation
link:remote-detailing-launch-salesforce-side.html[for Remote Detailing
on the Activity record or the Application record in Salesforce].
* The presenter can launch a CLM presentation
link:remote-detailing-launch-microsoft-teams.html[via Microsoft Teams].
...
link:remote-detailing-f-a-q.html[]JS methods and links are available
...
according to link:clm-settings.html[the Session timeout (in seconds)
field].
