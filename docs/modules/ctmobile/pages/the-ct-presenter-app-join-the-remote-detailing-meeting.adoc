...
To join link:remote-detailing-launch.html[the Remote Detailing meeting]
...
link:the-ct-presenter-app-interactions-during-the-remote-detailing-meeting.html[Interactions
