...
. Go to the link:ct-mobile-control-panel-app-menu-new.html[CT Mobile
...
ifdef::andr,ios,win[]
link:synchronization-launch.html#h2_538692555[Launch the full
synchronization] on the mobile device to apply changes. Records are
grouped according to the specified field. ifdef::kotlin[]

link:fast-synchronization.html[Launch fast synchronization] on the
