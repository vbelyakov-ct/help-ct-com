...
|Basic via API with xref:ctmobile:main/getting-started/logging-in/index.adoc[login&#44; password], and
xref:security-token[security token] |Yes
(optionally) |Yes |Yes |Yes |Yes |

|xref:ctmobile:main/getting-started/logging-in/oauth-2-0.adoc[OAuth 2.0] |Yes |Yes
...
|xref:ctmobile:main/mobile-application/synchronization/fast-synchronization.adoc[Fast synchronization] |Yes |Yes |Yes
|Yes |Yes

|xref:ctmobile:main/mobile-application/synchronization/full-synchronization.adoc[Full synchronization] |Yes |Yes |Yes
|Yes |Yes
...
|xref:ctmobile:main/admin-guide/ct-mobile-control-panel/custom-settings/ct-mobile-replication.adoc[CT Mobile Replication] |Yes |No |Yes
|No |No

|xref:ctmobile:main/admin-guide/managing-offline-objects/conflict-manager-control.adoc[Conflict Manager] |Yes |No |No |No
|No

|xref:ctmobile:main/admin-guide/managing-offline-objects/online-records-fetching.adoc[Online records fetching] |Yes |No
|No |No |No

|xref:reference-fields#h2_1514470758[Online one record fetching]
|Yes |No |No |Yes |No

|xref:/articles/project-ct-mobile-en[Status Indicator] |Yes |Yes |Yes
|No |Yes

|xref:ct-mobile-control-panel-tools#h2_203730205[Sync metadata
using administrator credentials] |Yes |Yes |Yes |Yes |Yes

|xref:ctmobile:main/admin-guide/metadata-checker/metadata-archive/index.adoc[Sync metadata using ZIP archive(s)] |Yes
|No |Yes |Yes |No
...
|xref:reference-fields#h2_321327715[Lookup filters] |Yes |Yes |Yes
|Yes |Yes
...
|xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-dashboards[Offline dashboards] |Yes |No |No
|No |No
...
|Page layouts and xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc[mobile layouts] |Yes |Yes
|Yes |Yes |Yes
...
|xref:list-views#h2_1243490689[Detailed list views] |Yes |No |No
|Since v.1.3 |No
|===
...
|xref:ctmobile:main/mobile-application/synchronization/synchronization-launch/sync-logs.adoc[Log errors and system actions] |Yes |No |Yes |Yes
|No |

|xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_1226274811[Debug Level]
|Yes |Yes |Yes |Yes |Yes |

|xref:ctmobile:main/mobile-application/synchronization/synchronization-launch/sync-logs.adoc#h2_272409891[Sending sync logs (automatic)] |Yes
|No |No |Yes |No |
...
|xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_1567195273[Log geolocation
...
|xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-workflows.adoc[Button Triggers (workflow
...
|xref:ctmobile:main/admin-guide/custom-color-settings.adoc[Color settings] |Yes |Yes |Yes |Yes
|Yes

|xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_377059502[Image Quality]
|Yes |Yes |No |No |Yes

|xref:demonstration-mode[Demonstration Mode] |Yes |No |No |No |No

|xref:ctmobile:main/mobile-application/application-settings/index.adoc#h3_828881719[Show field hints] |Yes
|Yes |Yes |No |Yes

|xref:ctmobile:main/mobile-application/application-settings/index.adoc#h3_1857935580[Tutorial mode] |Yes |No
|No |No |No

|xref:ctmobile:main/mobile-application/application-settings/index.adoc#h3_115565593[Send diagnostic data] |Yes
|No |No |No |No
...
|xref:ctmobile:main/mobile-application/ui/actions.adoc#h2_1355154294[The Determine Location button] on
[.object]#Accounts# and the[.object]#Activity# objects
|Yes |Yes |Yes |No |Yes

|xref:ctmobile:main/mobile-application/ui/actions.adoc#h2_62618674[Attach photos] to
...
|xref:ct-mobile-control-panel-calendar#h3_1876502572[Multiple
...
|xref:ctmobile:main/mobile-application/application-settings/index.adoc#h3_1768799377[Background download] |Yes
|No |No |No |No
|===
...
|xref:clm-navigation-in-clm-presentations#h2_21685430[Branches]
|Yes |No |No |Yes |No |
...
|xref:clm-presentation-controls#h2_1807389398[Send slides via
...
|xref:ctmobile:main/ct-presenter/the-remote-detailing-functionality/index.adoc[The Remote Detailing
...
|xref:activating-js-bridge#h2_1136353801[skipTenPercent] |Yes |No
|No |No |No |

|xref:activating-js-bridge#h2_1136353801[playVideo] |Yes |No |No
|No |No |

|xref:activating-js-bridge#h2_1136353801[getJSValues] |Yes |No |No
|No |No |
...
|xref:activating-js-bridge#h2_1136353801[CTAPPNewRecord] |Yes |No
|No |No |No |
...
|xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc[Offline charts based on Reports] |Yes |No |No |No
|No
...
|xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-maps[Maps] |Yes |Yes |Yes |Yes |Yes

|xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-dashboards[Dashboards] |Yes |No |No |No |No

|xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-applications[Applications] |Yes |Yes |No |Yes
|Yes

|xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-chatter-feed[Chatter feed] |Yes |Yes |No |Yes
|Yes

|xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-qr-code[QR code] |Yes |Yes |No |No |Yes
...
|xref:ctmobile:main/mobile-application/application-settings/index.adoc#h3_353973580[Store photos in the device
