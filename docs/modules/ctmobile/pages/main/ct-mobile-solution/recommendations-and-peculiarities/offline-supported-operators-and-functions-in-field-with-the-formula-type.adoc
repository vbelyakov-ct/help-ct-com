...
|$Api |No | |
|$CustomMetadata |Yes | |Records of xref:ctmobile:main/admin-guide/ct-mobile-control-panel/custom-settings/index.adoc[custom metadata types].
|$Label |Yes | |
|$Organization |No |Yes |
|Owner: Queue |Yes | |
|Owner: User |Yes | |
|$Profile |Yes |Yes |
|$recordtype |Yes | |
|$Setup |Yes |Yes |Records of xref:ctmobile:main/admin-guide/ct-mobile-control-panel/custom-settings/index.adoc[custom settings].
