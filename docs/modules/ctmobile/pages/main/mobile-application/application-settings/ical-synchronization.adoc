...
current user xref:log-out[logs out]. xref:ctmobile:main/mobile-application/synchronization/index.adoc[The
...
. xref:ctmobile:main/mobile-application/application-settings/ical-synchronization.adoc[Enable iCal synchronization].
. Select one or both available options:
* xref:ctmobile:main/mobile-application/application-settings/ical-synchronization.adoc[Sync Activities from CT Mobile Calendar
to Device Calendar].

Select a device calendar to synchronize activities from the CT Mobile
calendar.
* xref:ctmobile:main/mobile-application/application-settings/ical-synchronization.adoc[Show Device Calendars Activities in CT
Mobile Calendar].
...
xref:ctmobile:main/mobile-application/ui/compact-layout.adoc[a compact layout];
