...
xref:ct-mobile-control-panel-general#h3_1354766135[CT Mobile
Control Panel:
...
xref:application-permission-settings[permission to create and
...
In the Applications module, xref:applications#h3__1557359819[add
...
xref:mobile-layouts-dashboards[the mobile layout], only offline
...
xref:sync-logs[Sync Logs reports] or
xref:clm-applicationstats[CLM-presentation statistics], the message
...
about the data relevancy and if xref:synchronization[the
...
* Specify menu items and their order in xref:app-menu[the main
menu].
