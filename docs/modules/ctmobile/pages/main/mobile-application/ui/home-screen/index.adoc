...
In the Applications module, xref:applications#h3_1557359819[add
...
presentation mode, use xref:gestures-in-clm-presentations[gestures]
and xref:clm-presentation-controls[buttons].
...
to xref:managing-offline-objects[CT Mobile Control Panel: Managing
Offline
