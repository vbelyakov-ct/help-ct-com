...
xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc[Home screen] and allows you to search records of
objects added to the xref:ctmobile:main/admin-guide/app-menu/index.adoc[main menu].
...
subtitle on the xref:ctmobile:main/mobile-application/ui/compact-layout.adoc[compact layout]. The found
