...
xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[Managing Offline Objects in CT Mobile
Control Panel] or
...
If xref:ctmobile:main/admin-guide/start-finish-functionality.adoc[the Start/Finish functionality]
...
* When xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h2_670774632[a
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-general-new.adoc#h3_612123135[CT Mobile
...
refer to xref:ctmobile:main/mobile-application/attaching-files-in-the-files-section.adoc[Attachments in
the Files Section].
...
Add a post in the xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-chatter-feed[Chatter feed].
...
xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-chatter-feed[Chatter feed].
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-offline-objects.adoc[Offline Objects → Export Allowed]
or xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-offline-objects-new.adoc#h3_290156637[CT
Mobile Control Panel 2.0: Offline Objects → Export to CSV]).
* Default fields should be specified in the** Default Columns** field of
the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-offline-objects.adoc[Offline Object] or in
xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-offline-objects-new.adoc#h4_912917703[CT
Mobile Control Panel 2.0: Offline Objects → Export Columns Selection].
* Custom fields can be selected for export if
the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-offline-objects.adoc[Select Export
Columns] checkbox is set to _true_ or
xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-offline-objects-new.adoc#h4_912917703[Export
...
object, switch to xref:ctmobile:main/mobile-application/ui/list-views.adoc#h2_1248088428[detailed list
view]. ====
