...
xref:managing-offline-objects[Offline objects], such as
...
xref:using-calendar#h3_632854949[Calendar] module).
...
xref:managing-offline-objects#h2_1534686659[if permission is
granted];
...
field of the xref:ctm-settings-menu[CTM Settings → Menu] object.
====
. Tap *Save*.
