...
xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[Offline objects], such as
...
xref:ctmobile:main/mobile-application/mobile-application-modules/calendar/using-calendar.adoc#h3_632854949[Calendar] module).
...
xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc#h2_1534686659[if permission is
granted];
...
* export columns to a CSV file if xref:ctmobile:main/mobile-application/ui/actions.adoc#h2_1173923582[the
setting is enabled].
...
field of the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-menu.adoc[CTM Settings → Menu] object.
====
. Tap *Save*.
