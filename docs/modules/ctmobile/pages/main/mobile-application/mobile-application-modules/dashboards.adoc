...
* Add the dashboard to the xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc[mobile layout].
...
To add the *Dashboards* module to the xref:ctmobile:main/admin-guide/app-menu/index.adoc[app menu]:
