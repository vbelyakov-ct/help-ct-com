...
* If there are xref:ctmobile:main/admin-guide/related-lists/custom-related-lists.adoc[custom related lists], the
...
xref:setting-up-task-definitions-and-action-plan-templates#h2_1302650526[The
