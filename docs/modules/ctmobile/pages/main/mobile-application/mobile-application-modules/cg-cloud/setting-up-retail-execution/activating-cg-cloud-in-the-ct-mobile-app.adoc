...
list.
. xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc#h2_1747811907[Set up user
permissions].
. Click *Save*.
...
xref:ctmobile:main/admin-guide/related-lists/custom-related-lists.adoc[if configured].
