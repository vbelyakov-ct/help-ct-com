...
use xref:ctmobile:main/admin-guide/mini-layouts.adoc[mini-layouts] to create new records;

//tag::ios[]

add xref:ctmobile:main/admin-guide/related-lists/custom-related-lists.adoc[custom related lists] to track
related records;

using xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc#h3_1761919763[the Reports and Dashboards
...
using xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc#h3_1292798904[the Calendar widget], track
...
With the help of the xref:calendar[Calendar] module, a rep can
...
the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_612123135[CT Mobile
Control Panel:
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_1092547330[CT Mobile
Control Panel:
General]/xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-general-new.adoc#h3_1092547330[CT
...
In the xref:ctmobile:main/mobile-application/mobile-application-modules/routes.adoc[Routes] module, mobile users can work with
