...
* xref:custom-related-lists#h2_993780705[Create the custom related
...
* xref:ctmobile:main/admin-guide/mini-layouts.adoc[Customize mini layouts] with desired fields to
create[.object]#Opportunity Products# more conveniently.
* Add the *Currency ISO Code* field on the *Opportunity* page layout
when using
xref:working-with-opportunities#h3_1187857038[multi-currencies].



To create an *Opportunity* record, a user should have permission
xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc#h2_1534686659[to create records].
...
Business purposes
xref:adding-opportunities-to-the-ct-mobile-app#h3_404689442[divide
...
xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc#h2_1534686659[if enabled].
