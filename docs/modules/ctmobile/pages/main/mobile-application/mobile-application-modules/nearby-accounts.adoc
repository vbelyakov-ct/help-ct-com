...
Add the *Nearby Accounts* module to xref:ctmobile:main/admin-guide/app-menu/index.adoc[the app menu].
...
Panel:
General]/xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-general-new.adoc#h3_604215198[CT
...
To add the *Nearby Accounts* module to the xref:ctmobile:main/admin-guide/app-menu/index.adoc[app menu]:
