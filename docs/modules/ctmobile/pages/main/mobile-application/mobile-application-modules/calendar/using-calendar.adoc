...
xref:ctmobile:main/admin-guide/application-theme.adoc[the application theme] will be used to
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-calendar.adoc#h3_1391348303[CT Mobile
