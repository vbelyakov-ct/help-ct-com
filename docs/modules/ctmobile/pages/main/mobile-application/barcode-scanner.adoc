...
[NOTE] ==== On the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc[CT
...
created.
* If xref:ctmobile:main/admin-guide/start-finish-functionality.adoc[the Start/Finish
