...
xref:ctmobile:main/getting-started/logging-in/index.adoc[logging in];
...
the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/index.adoc[CT Mobile Control
Panel]/xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/index.adoc[CT Mobile Control Panel
2.0].
...
For more information, read xref:ctmobile:main/mobile-application/synchronization/full-synchronization.adoc[the Full
...
The sync process may include xref:ctmobile:main/admin-guide/ct-mobile-control-panel/custom-settings/ct-mobile-replication.adoc[CT Mobile
Replication];

The sync process may include the xref:ctmobile:main/mobile-application/synchronization/sync-recovery.adoc[Sync Recovery]
functionality.



For more information, read xref:ctmobile:main/mobile-application/synchronization/fast-synchronization.adoc[the Fast
Synchronization article].
...
* download xref:ctmobile:main/admin-guide/metadata-checker/metadata-archive/index.adoc[metadata] changes in ZIP
...
a change on xref:ctmobile:main/admin-guide/ct-mobile-control-panel/index.adoc[CT Mobile Control
Panel]/xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/index.adoc[CT Mobile Control Panel
2.0].
...
* xref:ctmobile:main/admin-guide/metadata-checker/index.adoc#h2_682427009[Manually create the metadata
archive].
* xref:ctmobile:main/admin-guide/metadata-checker/index.adoc#h2_1244689107[Enable Metadata Checker] to
refresh metadata.
...
For more information, read xref:ctmobile:main/mobile-application/synchronization/sync-recovery.adoc[the Sync Recovery
...
case, xref:ctmobile:main/admin-guide/ct-mobile-control-panel/custom-settings/ct-mobile-replication.adoc[create a CT Mobile Replication
...
xref:ctmobile:main/admin-guide/ct-mobile-replication-use-cases-and-steps.adoc[here].
...
on xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc#h2_396225247[the status indicator] at the
...
information, read xref:sync-log[the Sync Log article].
...
The xref:sync-log[Sync Log] object is intended to store logs for
...
xref:ctmobile:main/mobile-application/application-settings/send-application-data-dump.adoc#SendApplicationDataDump-SpecifyDatatoSend[Sync
...
For more information, read xref:ctmobile:main/mobile-application/synchronization/synchronization-launch/sync-logs.adoc[the Sync Logs article].
...
xref:ctmobile:main/admin-guide/metadata-checker/metadata-archive/index.adoc#h2_1854953360[here]. Also, the metadata
...
We recommend enabling xref:ctmobile:main/admin-guide/metadata-checker/index.adoc[a metadata checker] and
xref:ctmobile:main/admin-guide/metadata-checker/index.adoc#h3_1645525423[setting a schedule] for a
...
may incorrectly work, for example, xref:ctmobile:main/mobile-application/synchronization/validation.adoc[offline
validation rules].

. Check xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_2011978[the cloud
token] (refer to xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_2011978[CT
...
recommend enabling xref:ctmobile:main/admin-guide/metadata-checker/index.adoc[a metadata checker]. Also,
it is possible xref:ctmobile:main/admin-guide/metadata-checker/index.adoc#h3_1645525423[to set a
schedule] for a metadata checker or
xref:ctmobile:main/admin-guide/metadata-checker/index.adoc#h2_1657467916[manually create/update] the
metadata archive.
...
created or updated. We recommend enabling xref:ctmobile:main/admin-guide/metadata-checker/index.adoc[a
metadata checker]. Also, it is possible
xref:ctmobile:main/admin-guide/metadata-checker/index.adoc#h3_1645525423[to set a schedule] for a
metadata checker or xref:ctmobile:main/admin-guide/metadata-checker/index.adoc#h2_1657467916[manually
create/update] the metadata archive.
* Also, check the xref:ctmobile:main/ct-mobile-solution/application-language.adoc[Application Language]
article.
...
xref:ctmobile:main/admin-guide/metadata-checker/metadata-archive/index.adoc[a metadata archive]. We recommend enabling
xref:ctmobile:main/admin-guide/metadata-checker/index.adoc[a metadata checker]. Also, it is possible
xref:ctmobile:main/admin-guide/metadata-checker/index.adoc#h3_1645525423[to set a schedule] for a
metadata checker or xref:ctmobile:main/admin-guide/metadata-checker/index.adoc#h2_1657467916[manually
create/update] the metadata archive.
...
Go to the xref:ctmobile:main/mobile-application/application-settings/send-application-data-dump.adoc[Send Application Data
Dump] article.
...
xref:ctmobile:main/ct-mobile-solution/technical-requirements-for-devices-and-network.adoc#h2_1498128754[the
requirements for the connection].
* amount of data. To avoid the synchronization of the large data,
xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[customize the criteria] to download
desired records of offline objects.

* amount of modified components (objects, fields, layouts) or changes
provided on the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/index.adoc[CT Mobile Control
Panel]/xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/index.adoc[CT Mobile Control Panel
...
xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[SOQL query] in the error message.
...
inserted into xref:ctmobile:main/admin-guide/managing-offline-objects/reference-fields.adoc[the reference field] when the
...
* Enable the xref:ctmobile:main/mobile-application/application-settings/index.adoc#h3_1768799377[Background
...
* Disable the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-offline-objects.adoc[Files Download
Enabled] option for offline objects. The files attached to offline
objects will be downloaded as previews.
* Set up the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-offline-objects.adoc[Files Filter] option
...
Enable logs on the
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_272409891[CT Mobile
Control Panel:
General]/xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-general-new.adoc#h2_1687169837[CT
Mobile Control Panel 2.0: General] tab to collect statistics in the
[.object]#Sync Log# object. The xref:sync-log[Sync Log]
