...
[TIP] ==== Launch xref:ctmobile:main/mobile-application/synchronization/full-synchronization.adoc[the full
...
xref:ct-mobile-control-panel-user-interface-new#h3_1354766135[CT
...
!xref:ctmobile:main/mobile-application/mobile-application-modules/applications/index.adoc[Applications] !Application
...
!xref:ctmobile:main/mobile-application/mobile-application-modules/cg-cloud/index.adoc[CG Cloud]
...
!xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc#h3_1761919763[Dashboards] (online) !Dashboard
![.apiobject]#Dashboard# !Read !

! !Report ![.apiobject]#Report# !Read !

! !Report Type ![.apiobject]#ReportType# !Read ! !xref:ctmobile:main/mobile-application/lead-convert.adoc[Lead] !Lead Status ![.apiobject]#LeadStatus# !Read !If the list of offline objects
contains the _Lead_ object.

!xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[Offline Objects] !The list of
...
(will be deprecated in future), or xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/index.adoc[CTM Settings].

! !Task Status ![.apiobject]#TaskStatus# !Read; Edit !If the
list of offline objects contains the _Task_ object.

!xref:ctmobile:main/mobile-application/mobile-application-modules/opportunities/index.adoc[Opportunity] !Opportunity
