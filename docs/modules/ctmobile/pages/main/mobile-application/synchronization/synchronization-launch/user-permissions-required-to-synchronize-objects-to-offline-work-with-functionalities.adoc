...
!xref:applications[Applications] !Application
...
! !Report Type ![.apiobject]#ReportType# !Read ! !xref:lead-convert[Lead] !Lead Status ![.apiobject]#LeadStatus# !Read !If the list of offline objects
contains the _Lead_ object.

!xref:managing-offline-objects[Offline Objects] !The list of
...
!xref:opportunities[Opportunity] !Opportunity
