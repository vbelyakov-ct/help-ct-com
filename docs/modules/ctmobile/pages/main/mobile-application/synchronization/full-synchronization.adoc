...
to xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_2011978[CT Mobile Control
...
that case, xref:ctmobile:main/mobile-application/synchronization/validation.adoc[validation rules], offline reports, and
...
but xref:ctmobile:main/mobile-application/synchronization/validation.adoc[validation rules] offline reports, and some
