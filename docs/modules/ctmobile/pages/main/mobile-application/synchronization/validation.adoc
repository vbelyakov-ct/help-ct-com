...
synchronization as part of the xref:metadata-archive[metadata
...
xref:custom-related-lists[custom related list]).
...
xref:ct-mobile-control-panel-calendar#h3__1036133099[Lock/Unlock
Record]
(xref:ct-mobile-control-panel-activities-new#h4_1219382202[Lock
...
xref:errors-screen#h2__479754125[the Errors screen].
...
separate section on xref:errors-screen#h2__479754125[the Errors
screen].
