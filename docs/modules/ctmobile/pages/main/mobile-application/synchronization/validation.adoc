...
xref:ctmobile:main/admin-guide/start-finish-functionality.adoc[Start/Finish functionality] and
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-calendar.adoc#h3_1036133099[Lock/Unlock
Record]
