...
|===
|In CTM Settings a|
. Go to xref:ctm-settings[CTM Settings].
. Select an existing xref:ctm-settings-offline-objects[Offline
...
through xref:ctm-settings-offline-objects[date-based
...
record and perform xref:synchronization-launch#h2__966867633[quick
