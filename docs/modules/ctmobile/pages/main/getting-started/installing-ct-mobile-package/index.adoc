...
xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc#h2_1551357854[are available offline]
and xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc#h2_1814060569[use SOQL filters]
