...
service.
** As before, xref:ctmobile:main/getting-started/application-permission-settings.adoc[administrators]
could view and refresh the cloud token value on the
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc[CT Mobile Control Panel: Tools].
...
* xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h2_203730205[The
...
the user's device.
* xref:ctmobile:main/admin-guide/metadata-checker/metadata-archive/index.adoc[The metadata archive] should be built. This
...
* xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_2011978[The cloud token] is
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_2011978[the new value] to the
...
manually add xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_2011978[the new
