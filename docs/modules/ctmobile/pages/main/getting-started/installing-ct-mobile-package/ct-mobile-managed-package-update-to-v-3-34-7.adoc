...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/index.adoc[the CTM Settings object] is used to store several
settings defined in the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/index.adoc[CT Mobile
...
xref:ctmobile:main/getting-started/application-permission-settings.adoc#h3_2115044027[the
