...
To use xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc#h3_1361691321[the mobile logo], a mobile
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/index.adoc[CT Mobile Control Panel] tabs to
...
xref:ctmobile:main/mobile-application/synchronization/sync-recovery.adoc[Sync Recovery] to process errors or
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/custom-settings/ct-mobile-replication.adoc[CT Mobile Replication] to hide these
