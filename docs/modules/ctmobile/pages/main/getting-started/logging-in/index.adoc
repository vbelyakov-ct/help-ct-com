...
Salesforce credentials xref:ctmobile:main/getting-started/installing-ct-mobile-package/index.adoc[to your
Org].
...
You are logged in to CT Mobile. The xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc[Home Screen]
...
xref:ctmobile:main/getting-started/logging-in/oauth-2-0.adoc[the OAuth 2.0 protocol] and standard Salesforce
UI.
...
xref:synchronization-launch#h2_1266946854[The first
...
The CT Mobile app is ready to use, and the xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc[Home
