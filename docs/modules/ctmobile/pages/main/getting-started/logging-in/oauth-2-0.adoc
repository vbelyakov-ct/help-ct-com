...
After xref:ctmobile:main/getting-started/logging-in/index.adoc[logging in], a user establishes a session
...
xref:ctmobile:main/mobile-application/synchronization/index.adoc[synchronization]. A new password is not
required.
