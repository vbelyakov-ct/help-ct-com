...
xref:ctmobile:main/ct-mobile-solution/technical-requirements-for-devices-and-network.adoc#h3_118091408[read
the requirements].
...
xref:ctmobile:main/getting-started/installing-ct-mobile-package/index.adoc[to your Org].
. *Allow* access to requested data.

image:allow_access_en.png[]
. Click *Next* in
xref:ctmobile:main/getting-started/application-prompts-for-requesting-permissions.adoc[the additional
...
. Perform xref:ctmobile:main/mobile-application/synchronization/full-synchronization.adoc[a full synchronization].
...
CT Mobile opens. xref:ctmobile:main/getting-started/logging-in/index.adoc[Logging in] to start.
...
After the installation, xref:ctmobile:main/getting-started/logging-in/index.adoc[log in to the CT Mobile
app].
