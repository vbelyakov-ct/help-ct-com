...
* xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/index.adoc[CT Mobile Control Panel
...
* Fixed displaying xref:ctmobile:main/admin-guide/mini-layouts.adoc[Mini Layouts] editing window.
...
profile credentials.
. Go to xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc[CT Mobile Control Panel
→ Tools].
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_1003786176[refreshing the
metadata archive]. ====
...
Detailing.
* Updated
xref:ctmobile:main/getting-started/application-permission-settings.adoc#h3_2115044027[required
...
* The ability to activate xref:ctmobile:main/mobile-application/mobile-application-modules/cg-cloud/index.adoc[the CG Cloud support] to
...
xref:ctmobile:main/ct-presenter/about-ct-presenter/clm-scheme/clm-applicationstats.adoc[application statistics] stores a
participant's agreement to the terms of use.

* During the *Self Detailing* meeting.
** The ability to use the xref:ctmobile:main/ct-presenter/js-bridge-api/methods-for-remote-detailing-2-0/ctm-securequery.adoc[cm .secureQuery]
method in the CLM presentations to make secure requests to Salesforce
data.
** Support the xref:ctmobile:main/ct-presenter/js-bridge-api/methods-for-interaction-with-crm-data/ctm-create.adoc[ctm.create] and
xref:ctmobile:main/ct-presenter/js-bridge-api/methods-for-interaction-with-crm-data/ctm-update.adoc[ctm.update] methods in the CLM presentations.
...
xref:ctmobile:main/admin-guide/metadata-checker/metadata-archive/index.adoc[will be downloaded] in the CT Mobile app
...
deleted with the
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_1658362952[Refresh CTM
Settings] button.
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-offline-objects.adoc[during creating a SOQL
filter].
...
* Fixed the ability
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_847464003[to download the
metadata archive].
...
* Use the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_840249901[New
...
record, all xref:ctmobile:main/ct-presenter/about-ct-presenter/clm-scheme/clm-application.adoc[active and available for Remote
...
xref:ctmobile:main/admin-guide/metadata-checker/index.adoc[the metadata checker] now only tracks reports
...
xref:ctmobile:main/admin-guide/metadata-checker/metadata-archive/index.adoc[the metadata archive].
...
* xref:ctmobile:main/admin-guide/remote-site-settings.adoc[The new RD endpoint] should be
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_847464003[Download metadata
...
the xref:ctmobile:main/admin-guide/start-finish-functionality.adoc[Start/Finish functionality] is
disabled.
...
the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/custom-settings/trigger-settings.adoc[Trigger Settings].
...
* Improved xref:ctmobile:main/mobile-application/synchronization/sync-recovery.adoc[Sync Recovery] functionality: force
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_2011978[the cloud token] will
...
the attachment will be sent as xref:ctmobile:main/mobile-application/synchronization/sync-recovery.adoc#h3_356910769[a
...
* Specify the ability
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-calendar.adoc#h3_1856075785[to leave the
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_1876917838[Scheduled
metadata check] toggle and the
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_1003786176[Refresh metadata
...
the assigned
xref:ctmobile:main/getting-started/application-permission-settings.adoc#h2_1046081510[_CT Mobile
...
xref:ctmobile:main/admin-guide/mini-layouts.adoc#h2_684572466[creating a mini layout].
...
* The xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_1380764274[Remove
metadata archive from server] button is added to simplify the QA
process.
* The ability to specify
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_1990058335[Bing Maps API
Key] for CT Mobile Windows and
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_375370096[Google Maps API
...
* Users of CT Mobile iOS with xref:ctmobile:main/admin-guide/start-finish-functionality.adoc[the
...
* The xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h4_1003786176[Refresh
...
xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc#ManagingOfflineObjects-SOQLFilters[SOQL
filters].
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-offline-objects.adoc[the CTM Settings records] of the
...
* xref:ctmobile:main/ct-presenter/about-ct-presenter/clm-scheme/clm-customscenario.adoc[Custom scenarios] can be selected within
...
* The *Show* button xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc[to view the
cloud token value].
...
* xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_1658362952[The Refresh CTM
