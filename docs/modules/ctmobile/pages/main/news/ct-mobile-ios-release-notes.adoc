...
xref:calendar#h3_645629234[left menu], if they are set up in the
object xref:ctmobile:main/mobile-application/ui/compact-layout.adoc[compact layout].
** Up to 5 events can be displayed for one day in the
xref:ctmobile:main/mobile-application/mobile-application-modules/calendar/using-calendar.adoc#h3_860090196[month view].
** Customizable *All activities per day* hint added to the
xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc#h3_1292798904[calendar widget] for the Home
Screen.
** User can see
...
* Records counter in a xref:ctmobile:main/mobile-application/ui/list-views.adoc[list view] is now displayed
if there are more than 500 records.
* Files sharing workflow has been upgraded, including
xref:ctmobile:main/mobile-application/attaching-files-in-the-files-section.adoc#h3_1261438429[attached
...
* xref:ctmobile:main/mobile-application/ui/actions.adoc#h2_1173923582[Export .csv] item added to the
...
the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-offline-objects.adoc[Offline objects] record
type.
...
* The xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-offline-objects.adoc[Files Download Enabled]
...
will be reduced.
* The xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-offline-objects.adoc[Files Filter] field
added for Offline objects. You can
xref:ctmobile:main/mobile-application/attaching-files-in-the-files-section.adoc#h3_1720123861[specify the
...
xref:ctmobile:main/mobile-application/attaching-files-in-the-files-section.adoc[Files] section of an
offline object. You can add or delete files in the
xref:ctmobile:main/mobile-application/attaching-files-in-the-files-section.adoc#h3_2018099316[Actions]
menu of an offline object.
* Adding and pinning list views for the
xref:ctmobile:main/mobile-application/mobile-application-modules/calendar/using-calendar.adoc#h3_632854949[Calendar].
...
xref:ctmobile:main/ct-mobile-solution/recommendations-and-peculiarities/offline-supported-operators-and-functions-in-field-with-the-formula-type.adoc[formulas].
...
* The ability to minimize the xref:ctmobile:main/mobile-application/mobile-application-modules/libraries.adoc[Libraries] content and
...
one.
**** Now you can xref:ctmobile:main/mobile-application/application-settings/index.adoc#h3_611076828[set up the
...
xref:ctmobile:main/ct-mobile-solution/technical-requirements-for-devices-and-network.adoc[requirements
for devices] and installing
xref:ct-mobile-package-release-notes[the latest CT Mobile package
version].
...
* xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-calendar.adoc#h3_808313222[The default
...
out xref:ctmobile:main/admin-guide/managing-offline-objects/reference-fields.adoc#h2_1554731138[the reference field].
...
* To go to the record screen, xref:ctmobile:main/mobile-application/mobile-application-modules/calendar/using-calendar.adoc#h3_243561528[use
...
* In the left list of records xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc#h3_1292798904[of the
...
* xref:ctmobile:main/mobile-application/mobile-application-modules/routes.adoc#h3_1243841833[The route points] are now numbered, and
...
later. We recommend installing
xref:ct-mobile-package-release-notes#h2_62734607[the latest CT
...
xref:ctmobile:main/mobile-application/ui/list-views.adoc#h2_380480215[list views].
...
xref:ctmobile:main/admin-guide/start-finish-functionality.adoc#h2_239706372[the unfinished
...
xref:ctmobile:main/mobile-application/mobile-application-modules/libraries.adoc[Libraries].
...
characters] are supported in xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc[mobile layouts],
standard and custom xref:ctmobile:main/mobile-application/ui/list-views.adoc[list views], and
xref:ctmobile:main/mobile-application/mobile-application-modules/chatter/index.adoc#h2_779708391[Chatter] posts and comments.
...
xref:ctmobile:main/mobile-application/mobile-application-modules/calendar/using-calendar.adoc[in the calendar grid].
...
* Use xref:ctmobile:main/ct-presenter/about-ct-presenter/clm-scheme/clm-application.adoc[new attributes of CLM presentation] to
choose whether the CLM presentation should be available
xref:ctmobile:main/mobile-application/mobile-application-modules/applications/index.adoc[offline], used in the
...
* xref:ctmobile:main/admin-guide/app-menu/index.adoc[Assign the icon for the main tab] to help a user
quickly find out the object he is working with when viewing the record
screen.
* xref:ctmobile:main/mobile-application/ui/home-screen/search.adoc[Searching in the left record list] now displays the
...
xref:ctmobile:main/mobile-application/mobile-application-modules/calendar/using-calendar.adoc[the Calendar module], the agenda with records
...
* In the xref:ctmobile:main/mobile-application/mobile-application-modules/routes.adoc[Routes] module, the selected options are
saved.
...
xref:ctmobile:main/mobile-application/mobile-application-modules/applications/gestures-in-clm-presentations.adoc[a two-finger pinch].
...
xref:ctmobile:main/mobile-application/application-settings/index.adoc#h3_353973580[The option to choose]
...
limitations]. We highly recommend xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/index.adoc[referring to
...
* Refreshed xref:ctmobile:main/mobile-application/synchronization/sync-recovery.adoc[Sync Recovery] functionality allows
...
xref:synchronization-launch[the fast and full synchronization] to
...
allows making sure that xref:ctmobile:main/mobile-application/synchronization/index.adoc[the synchronization]
is complete.
...
in xref:ctmobile:main/ct-presenter/clm-navigation-in-clm-presentations.adoc[the href attribute] of
the slide layout.
* Converting a CLM presentation from
xref:creating-clm-presentation-from-pdf[a PDF
file] or xref:creating-clm-presentation-from-powerpoint[PowerPoint
...
xref:ctmobile:main/getting-started/application-prompts-for-requesting-permissions.adoc[pop-ups] with
functionalities that need the requested permission.
* Labels of menu items and modules in the menu, such as *Home Screen*,
*Routes*, or *Libraries*, xref:ctmobile:main/admin-guide/app-menu/renaming-menu-items-and-modules.adoc[can
...
in xref:ctmobile:main/mobile-application/mobile-application-modules/nearby-accounts.adoc[Nearby Accounts] and
xref:ctmobile:main/mobile-application/mobile-application-modules/routes.adoc[Routes] modules, in xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-maps[the
Map widget], and within xref:ctmobile:main/mobile-application/ui/actions.adoc[the Determine Location button]
in the combo-menu.
* Use list views of xref:ctmobile:main/ct-presenter/about-ct-presenter/clm-scheme/clm-application.adoc[the Application object] to
filter records in xref:ctmobile:main/mobile-application/mobile-application-modules/applications/index.adoc[the Applications module].
* To quickly return to xref:calendar[the Calendar] after moving on
...
** New icons, xref:ctmobile:main/admin-guide/application-theme.adoc[vivid app themes], and modern
fonts.
** Upgraded xref:calendar[Calendar], xref:ctmobile:main/mobile-application/mobile-application-modules/routes.adoc[Routes], and
xref:ctmobile:main/mobile-application/mobile-application-modules/nearby-accounts.adoc[Nearby Accounts] modules with user-friendly
logic.
...
views on your iPad.
** xref:ctmobile:main/mobile-application/mobile-application-modules/applications/clm-presentation-controls.adoc[Multitasking during an activity]
...
* The xref:ctmobile:main/getting-started/logging-in/index.adoc[Login screen] is implemented using the
xref:ctmobile:main/getting-started/logging-in/oauth-2-0.adoc[OAuth 2.0] protocol and standard Salesforce UI.
* xref:ctmobile:main/mobile-application/mobile-application-modules/libraries.adoc[The content module] now supports folder hierarchy.
* xref:ctmobile:main/mobile-application/synchronization/sync-recovery.adoc[Sync Recovery]. Recovering the records which
could not be properly sent to Salesforce due to permissions issues.
* Adjust the xref:ctmobile:main/admin-guide/related-lists/columns-width-for-related-lists.adoc[width of columns]
of the related lists and custom related lists.
* The long-hoped-for plus button is now available in the *Calendar*. It
is another way xref:ctmobile:main/mobile-application/mobile-application-modules/calendar/using-calendar.adoc[to create an activity in the
...
* xref:ctmobile:main/mobile-application/mobile-application-modules/calendar/set-up-holidays.adoc[Salesforce Holidays] are now supported and
are highlighted in the app's calendar.
* xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc[Image Quality]. Set the
amount of image compression to control the data volume sent to
Salesforce.
* xref:ctmobile:main/admin-guide/mini-layouts.adoc[Mini Layouts] can be assigned to a specific
user profile.
* Each user profile can have its xref:ctmobile:main/admin-guide/custom-color-settings.adoc[custom
...
xref:ctmobile:main/mobile-application/synchronization/synchronization-launch/sync-logs.adoc[reports to analyze] the synchronization.
* New synchronization algorithm with accelerated identification of the
created and updated records.
* xref:ctmobile:main/mobile-application/mobile-application-modules/libraries.adoc[The Libraries module] download process can be
moved to the background, which significantly improves the
synchronization time.
* xref:ctmobile:main/admin-guide/metadata-checker/metadata-archive/index.adoc[Metadata downloading] optimization.
...
* xref:ctmobile:main/admin-guide/ct-mobile-control-panel/custom-settings/ct-mobile-replication.adoc[Improved replication]. Shared records
...
* xref:ctmobile:main/mobile-application/mobile-application-modules/nearby-accounts.adoc[The Nearby Accounts module]. The records
...
* The xref:ctmobile:main/mobile-application/ui/home-screen/search.adoc[Search] box value lower limit is reduced from
...
clock adjustment.
* The xref:ctmobile:main/admin-guide/person-accounts.adoc[Person Account] record type can be
created from a reference field.
* *Dashboards*. Graphs with summary formulas involved are displayed
correctly on xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc[Home Screen].
...
*Task* and *Event*.
* xref:application-editor[Customizable statistics gathering] on
displaying individual screens and elements in CLM presentations.
* xref:ctmobile:main/mobile-application/synchronization/index.adoc[Selective synchronization] in case of user
...
positioning xref:ctmobile:main/mobile-application/ui/actions.adoc[on activity start].
* xref:ctmobile:main/mobile-application/mobile-application-modules/applications/clm-presentation-controls.adoc[Presentation exit screen
improvements].
* The xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[offline-objects] customization
...
* xref:ctmobile:main/mobile-application/synchronization/synchronization-launch/sync-logs.adoc[Application log records] are more detailed.
* xref:ctmobile:main/admin-guide/person-accounts.adoc[Person Accounts] will now display in *Nearby
Accounts* with appropriate settings.
* The improved logic of xref:ctmobile:main/mobile-application/mobile-application-modules/calendar/using-calendar.adoc[copying activities] in
the calendar.
...
new posts in xref:ctmobile:main/mobile-application/mobile-application-modules/chatter/index.adoc[Chatter].
...
* Updated for iOS 11.
* xref:ctmobile:main/mobile-application/application-settings/ical-synchronization.adoc[Two-way sync with iPad/iPhone internal
...
* Optimized xref:ctmobile:main/mobile-application/synchronization/index.adoc[synchronization] for organizations
with an extended data model and large data volumes.
* Customizable set of xref:ctmobile:main/mobile-application/ui/home-screen/search.adoc[search fields] for each object.
* xref:ctmobile:main/admin-guide/managing-offline-objects/reference-fields.adoc#h2_1554731138[Quick record creation in
...
* The xref:ctmobile:main/mobile-application/ui/actions.adoc[Determine Geolocation] functionality in the
...
* xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc[Customizable Home screen] for iPhone added.
* The xref:ctmobile:main/mobile-application/mobile-application-modules/chatter/index.adoc[Chatter] functionality for iPhone was added.

[[h3_118294372]]
==== CLM-presentations

* JS Bridge methods added:
** xref:ctmobile:main/ct-presenter/js-bridge-api/methods-for-clm-presentation-control/ctm-disableslidescroll.adoc[ctm.isableSlideScroll]: optional
lock for slides scrolling using gestures.
** xref:ctmobile:main/ct-presenter/js-bridge-api/methods-for-clm-presentation-control/ctm-enableslidescroll.adoc[ctm.enableSlideScroll]: slide
scrolling unlock option.
** xref:ctmobile:main/ct-presenter/js-bridge-api/methods-for-interaction-with-crm-data/ctm-storefile.adoc[ctm.storeFile]: saving a file attachment as
an attachment to a record.
** xref:ctmobile:main/ct-presenter/js-bridge-api/methods-for-interaction-with-crm-data/ctm-getfile.adoc[ctm.getFile] - getting the contents of an
...
xref:ctmobile:main/mobile-application/mobile-application-modules/applications/index.adoc#h3_1236408094[custom scenarios] in the
