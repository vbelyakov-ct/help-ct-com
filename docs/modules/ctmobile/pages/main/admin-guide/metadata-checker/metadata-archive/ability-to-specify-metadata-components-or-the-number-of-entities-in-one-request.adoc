...
xref:ctmobile:main/admin-guide/metadata-checker/index.adoc[]

//tag::ios[]

xref:ctmobile:main/admin-guide/metadata-checker/index.adoc[The metadata checker] tracks changes in
...
* Go to the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_1003786176[CT
