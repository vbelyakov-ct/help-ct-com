...
by assigning xref:ctmobile:main/getting-started/application-permission-settings.adoc#ApplicationPermissionSettings-PermissionSets[one
...
xref:ctmobile:main/admin-guide/metadata-checker/metadata-archive/index.adoc#h2_1854953360[metadata components].
...
. Go to the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc[CT Mobile Control
Panel: Tools] tab.
...
the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h4_1003786176[CT Mobile
Control Panel:
