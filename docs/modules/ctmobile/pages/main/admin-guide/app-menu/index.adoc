...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-offline-objects.adoc[offline objects]. You
...
xref:ctmobile:main/mobile-application/mobile-application-modules/index.adoc[the desired additional modules].
image:47745270.png[]
...
The icon is set. Launch xref:ctmobile:main/mobile-application/synchronization/full-synchronization.adoc[full
synchronization].
