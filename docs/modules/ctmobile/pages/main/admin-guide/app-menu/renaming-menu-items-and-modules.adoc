...
xref:ctmobile:main/mobile-application/mobile-application-modules/index.adoc[modules]. If the
...
|xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc[Home]
|[.apiobject]#CTM_MainMenu_Tab_Home#

|xref:ctmobile:main/mobile-application/ui/home-screen/search.adoc[Global Search]
|[.apiobject]#CTM_MainMenu_Tab_GlobalSearch#

|xref:ctmobile:main/mobile-application/application-settings/index.adoc[Settings]
...
|xref:ctmobile:main/mobile-application/mobile-application-modules/chatter/index.adoc[Chatter]
|[.apiobject]#CTM_MainMenu_Tab_Chatter#

|xref:ctmobile:main/mobile-application/mobile-application-modules/links.adoc[Links List]
...
|xref:ctmobile:main/mobile-application/mobile-application-modules/recent-items.adoc[Recent Items]
...
To rename xref:ctmobile:main/mobile-application/mobile-application-modules/applications/index.adoc[Applications],
xref:ctmobile:main/mobile-application/mobile-application-modules/libraries.adoc[Libraries], and xref:ctmobile:main/mobile-application/mobile-application-modules/quizzes.adoc[Quizzes] modules:
