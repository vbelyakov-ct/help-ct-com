...
in the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/index.adoc[CTM Settings] with the _Offline Object_
record type.
...
xref:ct-mobile-control-panel-app-menu-new[App Menu]. #
...
xref:ctmobile:main/admin-guide/related-lists/timeline-view.adoc[timeline view]. If enabled, select a field
...
If the record type has a xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc[mobile layout],
