...
Settings# object with the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-menu.adoc[Menu] record
type.
...
Refer to xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc[Home screen] for more details.

[[h3_1468985423]]
==== Offline Objects

* xref:ctmobile:main/admin-guide/app-menu/grouping-records.adoc[Group records] by the criterion and
ascending or descending order of records.
* Define fields available for filtering in
xref:ctmobile:main/mobile-application/ui/list-views.adoc#h2_380480215[mobile list view].



Refer to xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[Managing Offline
...
Refer to xref:ctmobile:main/mobile-application/mobile-application-modules/links.adoc[Links] for more details.
...
* *Default View*: select xref:ctmobile:main/mobile-application/mobile-application-modules/calendar/using-calendar.adoc#h2_1759778354[the
...
Refer to xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-activities-new.adoc[CT Mobile
...
Define the way how files uploaded to the xref:ctmobile:main/mobile-application/mobile-application-modules/libraries.adoc[Libraries]
...
xref:ctmobile:main/ct-mobile-solution/ct-mobile-os-comparison.adoc[device platform].
