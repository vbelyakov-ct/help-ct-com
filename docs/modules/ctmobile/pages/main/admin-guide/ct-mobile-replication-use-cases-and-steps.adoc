...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/custom-settings/ct-mobile-replication.adoc[CT Mobile Replication] is intended to
...
were downloaded via xref:synchronization-launch#h2_966867633[full
...
the corresponding user during xref:ctmobile:main/mobile-application/synchronization/fast-synchronization.adoc[the fast or
...
. Run xref:ctmobile:main/mobile-application/synchronization/index.adoc[the fast synchronization].
