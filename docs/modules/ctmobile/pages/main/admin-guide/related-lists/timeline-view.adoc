...
timeline view does not apply to xref:ctmobile:main/admin-guide/related-lists/custom-related-lists.adoc[custom
related lists]. #
...
* If needed, xref:ctmobile:main/admin-guide/custom-color-settings.adoc[set the colors] for each
activity type.
* xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[If enabled], it is possible to
