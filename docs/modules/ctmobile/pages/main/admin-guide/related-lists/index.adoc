...
xref:ctmobile:main/admin-guide/managing-offline-objects/reference-fields.adoc[the reference field]. In the CT Mobile app,
two types of related lists are available:

* xref:ctmobile:main/admin-guide/related-lists/custom-related-lists.adoc[Custom Related Lists]
...
* on xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-offline-objects.adoc[CT Mobile Control
Panel: Offline
Objects]/xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-offline-objects-new.adoc[CT Mobile
...
xref:ctmobile:main/admin-guide/related-lists/columns-width-for-related-lists.adoc[Columns' Widths for Standard
...
xref:ctmobile:main/admin-guide/related-lists/timeline-view.adoc[Timeline View]. //tag::win,andr,kotlin[]
[NOTE] ==== Not in use. ====
