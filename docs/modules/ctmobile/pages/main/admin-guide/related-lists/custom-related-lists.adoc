...
go to xref:ctmobile:main/admin-guide/related-lists/columns-width-for-related-lists.adoc#h2_947661563[Columns'
...
xref:ctmobile:main/getting-started/application-permission-settings.adoc[permission to edit] an object,
which records are displayed in the custom related list.
. Specify xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc#h2_1534686659[permission to
