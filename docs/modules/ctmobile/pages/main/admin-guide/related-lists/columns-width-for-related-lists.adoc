...
xref:ctmobile:main/admin-guide/metadata-checker/metadata-archive/index.adoc[Metadata Archive] and
xref:ctmobile:main/admin-guide/metadata-checker/index.adoc[Metadata Checker]. ==== //tag::kotlin[]
...
xref:ctmobile:main/mobile-application/synchronization/index.adoc[full synchronization] to apply the changes.
