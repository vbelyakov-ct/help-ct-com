...
Date field] and
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-calendar.adoc#h3_1391348303[Activity End
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-calendar.adoc#h3_1856075785[CT Mobile
...
[.apiobject]#false#.
. Add xref:ctmobile:main/mobile-application/synchronization/validation.adoc[the validation rule], which will be triggered
