...
. Go to the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_494016929[CT
...
. Go to
the xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-general-new.adoc#h4_351797814[CT
...
The setup is complete. Launch xref:ctmobile:main/mobile-application/synchronization/full-synchronization.adoc[full
...
xref:ctmobile:main/admin-guide/person-accounts.adoc[Person Accounts], affects the record display.
