...
This section is intended to xref:ctmobile:main/admin-guide/application-theme.adoc[personalize the
CT Mobile interface].
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-calendar.adoc#h3_717585460[Activity
...
real-time via the xref:ctmobile:main/admin-guide/geolocation-center/index.adoc[Geolocation Centre] in
Salesforce.
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-calendar.adoc#h3_1397263211[Activity Object
API Name] field.
