...
the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-offline-objects.adoc[Offline
Objects] and xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-standard-related-list.adoc[Standard
...
xref:ctmobile:main/mobile-application/synchronization/other-synchronization-modes.adoc#h2_1958232390[sync a single
...
For more information, refer to xref:ctmobile:main/mobile-application/synchronization/sync-recovery.adoc[Sync Recovery].
...
records that match the criteria. Enable xref:ctmobile:main/admin-guide/related-lists/timeline-view.adoc[the
...
For more information, refer to
xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[Managing Offline Objects]. Also, get
