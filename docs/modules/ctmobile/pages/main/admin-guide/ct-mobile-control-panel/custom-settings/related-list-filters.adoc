...
xref:managing-offline-objects[offline object] data upload.
...
|Checkbox |The xref:conflict-manager-control[Conflict Manager] is
...
xref:online-records-fetching[Load more records] button is available
in the application.
...
related list records in the xref:timeline-view[timeline view] if
