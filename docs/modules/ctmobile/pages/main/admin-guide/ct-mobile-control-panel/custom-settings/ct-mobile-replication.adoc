...
CT Mobile Replication helps to speed up xref:ctmobile:main/mobile-application/synchronization/index.adoc[the
...
Text(32768) |The list of xref:ctmobile:main/admin-guide/metadata-checker/metadata-archive/index.adoc[metadata
