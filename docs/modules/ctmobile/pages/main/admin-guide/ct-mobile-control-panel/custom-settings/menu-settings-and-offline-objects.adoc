...
custom xref:ctm-settings[CTM Settings] object.
[TIP] ==== For easy setup, go to
xref:ct-mobile-control-panel[CT Mobile Control Panel]. CT Mobile
...
be grouped by the title of xref:compact-layout[a compact layout].
