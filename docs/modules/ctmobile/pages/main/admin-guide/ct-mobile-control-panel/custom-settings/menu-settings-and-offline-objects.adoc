...
of the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-menu.adoc[Menu] record type of the
custom xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/index.adoc[CTM Settings] object.
[TIP] ==== For easy setup, go to
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/index.adoc[CT Mobile Control Panel]. CT Mobile
...
be grouped by the title of xref:ctmobile:main/mobile-application/ui/compact-layout.adoc[a compact layout].
