...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc[CT Mobile Control Panel:
General]/xref:ct-mobile-control-panel-general-new[CT Mobile Control
Panel 2.0: General], xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-activities-new.adoc[CT
...
xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-maps[the Maps widget] if the value is not set
...
get the location in the xref:ctmobile:main/mobile-application/mobile-application-modules/routes.adoc[Routes] and
...
field is used when the xref:ctmobile:main/admin-guide/start-finish-functionality.adoc[Start/Finish
...
xref:ctmobile:main/ct-presenter/about-ct-presenter/clm-scheme/clm-applicationstats.adoc[the Application Stats object] to the
[.object]#Activity# object.
...
[NOTE] ==== xref:ctmobile:main/ct-presenter/js-bridge-api/index.adoc[JS Bridge as well as
...
|Text(255) a|
Defines xref:ctmobile:main/mobile-application/synchronization/synchronization-launch/sync-logs.adoc[sync logs] must be stored Available values:
...
|Text(255) |xref:ctmobile:main/admin-guide/google-maps-api-key/index.adoc[Access key to Google Maps
...
|xref:ctmobile:main/admin-guide/google-maps-api-key/index.adoc[Access key to Google Maps services]
...
Maps in xref:ctmobile:main/admin-guide/geolocation-center/index.adoc[the Geolocation center].

|Image Quality |[.apiobject]#clm__ImageQuality__c#
|Number(3,0) |Image compression
functionality (xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_377059502[CT
Mobile Control Panel:
General]/xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-general-new.adoc#h3_377059502[CT
...
|If enabled, xref:ctmobile:main/admin-guide/person-accounts.adoc[Person Accounts] are used in the
CT Mobile app.
...
xref:ctmobile:main/ct-presenter/about-ct-presenter/clm-scheme/clm-application.adoc[Application] object to the
...
|Enable the xref:ctmobile:main/admin-guide/start-finish-functionality.adoc[Start/Finish
functionality].
...
the xref:ctmobile:main/admin-guide/start-finish-functionality.adoc[Start/Finish functionality],
...
xref:ctmobile:main/admin-guide/start-finish-functionality.adoc[Start/Finish functionality] is
enabled.
