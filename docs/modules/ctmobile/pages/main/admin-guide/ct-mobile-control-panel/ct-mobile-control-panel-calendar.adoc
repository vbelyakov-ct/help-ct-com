...
xref:ctmobile:main/mobile-application/mobile-application-modules/calendar/using-calendar.adoc#h2_1759778354[the default calendar view]. The
available options:
...
xref:ctmobile:main/admin-guide/start-finish-functionality.adoc[start and finish an activity] using
...
xref:ctmobile:main/admin-guide/start-finish-functionality.adoc#h2_239706372[Enable this option],
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc[the geolocation data] of the
