...
xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[offline object&#44;] as well as
...
xref:ctmobile:main/admin-guide/related-lists/timeline-view.adoc[Timeline] view. In other cases, left blank.
