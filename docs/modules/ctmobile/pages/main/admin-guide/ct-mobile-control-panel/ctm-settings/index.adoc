...
the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/index.adoc[CT Mobile Control Panel].
[.object]#CTM Settings# has record types that correspond to
specific xref:ctmobile:main/admin-guide/ct-mobile-control-panel/custom-settings/index.adoc[custom settings].
...
** xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-menu.adoc[Menu]
** xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ctm-settings/ctm-settings-offline-objects.adoc[Offline Objects]
