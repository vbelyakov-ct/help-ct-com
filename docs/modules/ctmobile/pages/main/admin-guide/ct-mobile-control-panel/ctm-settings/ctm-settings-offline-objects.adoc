...
Allows the xref:ctmobile:main/admin-guide/managing-offline-objects/conflict-manager-control.adoc[Conflict Manager]
...
_true_, then the xref:ctmobile:main/mobile-application/ui/actions.adoc#h2_1173923582[Export to File] item is
...
the xref:ctmobile:main/mobile-application/ui/actions.adoc#h2_1173923582[Export to File] workflow in
...
an API Name of an xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[offline object].
...
Defines if the xref:ctmobile:main/admin-guide/managing-offline-objects/online-records-fetching.adoc[Load more records]
...
export after tapping the xref:ctmobile:main/mobile-application/ui/actions.adoc#h2_1173923582[Export to
...
Enables xref:ctmobile:main/mobile-application/synchronization/sync-recovery.adoc[Sync Recovery] to deliver records that
