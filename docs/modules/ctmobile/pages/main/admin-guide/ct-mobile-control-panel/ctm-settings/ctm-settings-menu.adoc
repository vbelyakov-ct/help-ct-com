...
a|
Stores an API Name of xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[an offline
...
section while creating a new xref:ctmobile:main/mobile-application/ui/list-views.adoc#h2_380480215[mobile
...
Defines the way how xref:ctmobile:main/mobile-application/mobile-application-modules/libraries.adoc[Library] object must be
...
|Text(255) a|
Stores an API Name of a field for xref:ctmobile:main/admin-guide/app-menu/grouping-records.adoc[grouping
