...
or xref:ct-mobile-workflow#h2__925686890[tapping the appropriate
button].
...
xref:synchronization-launch#h2__966867633[any synchronization
mode].
...
xref:ct-mobile-control-panel-workflows#h2__1577295421[Create a new
...
xref:ct-mobile-control-panel-workflows#h2_438443077[Create a new
