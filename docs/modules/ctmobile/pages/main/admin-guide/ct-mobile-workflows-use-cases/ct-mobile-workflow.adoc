...
xref:ctmobile:main/admin-guide/start-finish-functionality.adoc[the Start/Visit button], the
*Capture Geoposition* and *Update Start/End Date Fields* options will no
longer be applied even if they are enabled on the
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-calendar.adoc[CT Mobile Control Panel:
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-activities-new.adoc[CT Mobile Control Panel
2.0: Activities] tab).
...
|xref:ctmobile:main/admin-guide/start-finish-functionality.adoc[The Start button] of the
[.object]#Activity# object.

|[.apiobject]#CTM.Button.FinishActivity#
|xref:ctmobile:main/admin-guide/start-finish-functionality.adoc[The Finish button] of the
[.object]#Activity# object.
...
xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[record creation] in related lists.

|[.apiobject]#CTM.Button.Geoposition# |The button displays a
xref:ctmobile:main/mobile-application/ui/actions.adoc[combo menu] to define Geolocation.

|[.apiobject]#CTM.Button.ActivityHistory# |The icon displays
xref:ctmobile:main/mobile-application/ui/historical-activities.adoc[historical activities].

|[.apiobject]#CTM.Button.Signature# |The
xref:ctmobile:main/mobile-application/ui/actions.adoc[combo-menu] button displays a pop-up signature window.

|[.apiobject]#CTM.Button.ScanBarсode# |The icon displays
xref:ctmobile:main/mobile-application/barcode-scanner.adoc[the EAN code scanner] on the related list.
...
xref:ctmobile:main/mobile-application/ui/actions.adoc[a new post] in the xref:ctmobile:main/mobile-application/mobile-application-modules/chatter/index.adoc[Chatter feed] is
added.

|[.apiobject]#CTM.Button.ConvertLead# |Pressing the button
xref:ctmobile:main/mobile-application/lead-convert.adoc[converts Leads] into an
[.object]#Account# record.

|[.apiobject]#CTM.Button.SortSwitch# |The switcher is to edit
the visibility of records in xref:ctmobile:main/admin-guide/related-lists/custom-related-lists.adoc[a custom
related list].
