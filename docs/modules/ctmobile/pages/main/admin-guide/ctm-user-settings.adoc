...
store settings for xref:ctmobile:main/mobile-application/ui/list-views.adoc#h2_380480215[custom list views]
...
API Name of xref:ctmobile:main/admin-guide/managing-offline-objects/index.adoc[an offline object] for
