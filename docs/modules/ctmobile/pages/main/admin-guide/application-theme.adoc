...
The logo is represented on the xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc[Home screen] if the
...
size. After that, launch the xref:ctmobile:main/mobile-application/synchronization/fast-synchronization.adoc[fast
synchronization].
...
The logo is represented on the xref:ctmobile:main/mobile-application/ui/home-screen/index.adoc[Home screen]. Click
