...
The logo is represented on the xref:home-screen[Home screen] if the
...
size. After that, launch the xref:fast-synchronization[fast
synchronization].
...
The logo is represented on the xref:home-screen[Home screen]. Click
