...
. Make sure xref:ctmobile:main/admin-guide/remote-site-settings.adoc[the required remote site
settings] are specified and active.
. xref:ctmobile:main/admin-guide/google-maps-api-key/index.adoc[Get a Google Maps API Key(s)] and enable
the following APIs:
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h2_670774632[CT Mobile Control
Panel: General]:
...
xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-general-new.adoc#h2_670774632[CT Mobile
...
* ​Specify *Google Maps Javascript API Key*.
* Click *Save*.
..  Go to the xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-activities-new.adoc[CT Mobile
...
|===
. xref:ctmobile:main/getting-started/application-permission-settings.adoc[Assign permission] to read,
