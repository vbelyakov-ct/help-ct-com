...
the xref:ctmobile:main/mobile-application/application-settings/index.adoc#h2_1872639157[map type in the CT
Mobile app settings], you need Google Maps API Key.

To specify the Google Maps API key:

. Generate xref:ctmobile:main/admin-guide/google-maps-api-key/index.adoc[the Google Maps API key].
. Go to the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_604215198[CT
...
Bing Maps API key].
. Go to xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_1990058335[CT
Mobile Control Panel:
...
. Generate xref:ctmobile:main/admin-guide/google-maps-api-key/index.adoc[the Google Maps API key].
. Go to xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_375370096[CT Mobile
Control Panel:
General]/xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-general-new.adoc#h3_375370096[CT
...
To add the[.object]#Account# to the xref:ctmobile:main/admin-guide/app-menu/index.adoc[app
menu]:
...
Use the xref:ctmobile:main/mobile-application/ui/actions.adoc#h2_1355154294[Determine Location] button to
