...
. Create xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc#h2_959581907[an inactive mobile
record type].
. Create xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc#h2_1436774974[a mobile layout].
. xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc#h2_1961857618[Assign the mobile layout] to a
...
* xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-maps[Maps]
* xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-applications[Carousel of CLM Presentations]
* xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-dashboards[Dashboards]
* xref:ctmobile:main/admin-guide/mobile-layouts/index.adoc-qr-code[QR code]
