...
xref:ctmobile:main/mobile-application/mobile-application-modules/chatter/index.adoc[the Chatter module] or in the *Chatter* tab of the
...
. Enable xref:ctmobile:main/mobile-application/mobile-application-modules/chatter/chatter-push-notifications.adoc[push notifications] if
needed.
