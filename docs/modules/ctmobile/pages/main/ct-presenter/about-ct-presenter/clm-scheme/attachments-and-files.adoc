...
xref:ctmobile:main/mobile-application/ui/actions.adoc#h2_62618674[photos] and signatures of *Activity*
records;

attachments to the xref:ctmobile:main/mobile-application/mobile-application-modules/chatter/index.adoc[Chatter feed] posts;
...
We recommend using
the xref:ctmobile:main/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_377059502[Image
Quality] (in CT Mobile Control
Panel)/xref:ctmobile:main/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-general-new.adoc#h3_377059502[Quality
...
xref:ctmobile:main/mobile-application/synchronization/fast-synchronization.adoc[fast synchronization].
