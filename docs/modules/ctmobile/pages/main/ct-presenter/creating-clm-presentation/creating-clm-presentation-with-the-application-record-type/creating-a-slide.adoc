...
xref:ctmobile:main/ct-presenter/about-ct-presenter/clm-scheme/clm-slide.adoc[here]. ====
...
* Specify xref:ctmobile:main/ct-presenter/clm-navigation-in-clm-presentations.adoc[the order and
branch].
...
xref:ctmobile:main/mobile-application/mobile-application-modules/applications/gestures-in-clm-presentations.adoc[using a double swipe].
