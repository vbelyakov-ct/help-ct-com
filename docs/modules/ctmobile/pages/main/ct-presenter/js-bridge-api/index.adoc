...
xref:ctmobile:main/ct-presenter/js-bridge-api/activating-js-bridge.adoc[activate the JS Bridge library].
...
xref:ctmobile:main/ct-presenter/js-bridge-api/methods-for-interaction-with-crm-data/crm-data-display.adoc[displaying data from the following objects]:
