...
xref:application-editor#h2_213917439[the appropriate CLM
...
xref:ctmobile:main/ct-presenter/about-ct-presenter/clm-scheme/clm-applicationstats.adoc[Guest Stats] field is populated with the
