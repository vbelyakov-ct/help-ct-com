...
app]. Read xref:remote-detailing-f-a-q[Remote Detailing: F.A.Q.] to
...
xref:ct-mobile-control-panel-presenter#h2_985373192[CT Mobile
Control Panel:
...
xref:remote-detailing-statistics[the statistics], the *Track slide
