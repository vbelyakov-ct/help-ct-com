...
link:ctm-settings.html[the CTM Settings object] is used to store several
settings defined in the link:ct-mobile-control-panel.html[CT Mobile
Control Panel]. The settings of the
link:menu-settings-and-offline-objects.html[menu],
...
link:application-permission-settings.html#h3_2115044027[the
