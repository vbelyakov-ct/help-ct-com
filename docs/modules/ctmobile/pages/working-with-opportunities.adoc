...
* link:custom-related-lists.html#h2__993780705[Create the custom related
...
* link:mini-layouts.html[Customize mini layouts] with desired fields to
create[.object]#Opportunity Products# more conveniently.
* Add the *Currency ISO Code* field on the *Opportunity* page layout
when using
link:working-with-opportunities.html#h3__1187857038[multi-currencies].



To create an *Opportunity* record, a user should have permission
link:managing-offline-objects.html#h2_1534686659[to create records].
...
In the case of link:manage-currencies.html[multi-currency support], all
...
Business purposes
link:adding-opportunities-to-the-ct-mobile-app.html#h3__404689442[divide
...
link:managing-offline-objects.html#h2_1534686659[if enabled].
