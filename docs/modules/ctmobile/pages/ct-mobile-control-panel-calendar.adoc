...
link:using-calendar.html#h2__1759778354[the default calendar view]. The
available options:
...
link:start-finish-functionality.html[start and finish an activity] using
the additional logic that may be applied to a started activity.

ifdef::ios[]

[NOTE] ==== If you have a link:ct-mobile-workflow.html[CT Mobile
...
link:start-finish-functionality.html#h2_239706372[Enable this option],
...
link:ct-mobile-control-panel-general.html[the geolocation data] of the
