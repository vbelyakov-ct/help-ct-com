...
* The specified link:application-theme.html[theme] is applied to
prompts.
...
link:logging-in.html[logged in] to CT Mobile for the first time, the
...
a mobile user link:chatter-push-notifications.html[Chatter feed] or
link:event-notifications.html[as an alert of the upcoming visit]. Also,
this permission is required to fill out the link:clm-user.html[Device
...
When a mobile user taps link:nearby-accounts.html[Nearby Accounts],
link:routes.html[Routes], link:actions.html[the Determine location
button], or calls an app for the first time.
* *Allow access to Calendar*

When a mobile user enables link:ical-synchronization.html[iCal
synchronization].
* *Allow access to Photos*

When a mobile user chooses a photo from *Photos* and attaches them to
records or link:chatter.html[Chatter posts].
* *Allow access to Contacts*

For viewing contact information in the link:calendar.html[calendar] in
case of using link:ical-synchronization.html[iCal synchronization].
* *Allow access to the microphone*

When a mobile user records audio messages and attaches them to
link:chatter.html[Chatter posts].
...
them to records or link:chatter.html[Chatter posts].
