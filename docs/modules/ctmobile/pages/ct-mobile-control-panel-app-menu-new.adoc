...
Settings# object with the link:ctm-settings-menu.html[Menu] record
type.
...
link:ct-mobile-control-panel-app-menu-new.html#h3__259736469[Module
menu].
...
Refer to link:home-screen.html[Home screen] for more details.

[[h3_1468985423]]
==== Offline Objects

* link:grouping-records.html[Group records] by the criterion and
ascending or descending order of records.
* Define fields available for filtering in
link:list-views.html#h2__380480215[mobile list view].



Refer to link:managing-offline-objects.html[Managing Offline
...
Refer to link:links-list.html[Links] for more details. 

[[h3_1292798904]]
==== Calendar

Configure the link:calendar.html[Calendar] options:

* *Activity Duration (min)*: specify the default duration in minutes for
scheduled activities. 
* *Default View*: select link:using-calendar.html#h2__1759778354[the
...
Refer to link:ct-mobile-control-panel-activities-new.html[CT Mobile
...
Define the way how files uploaded to the link:libraries.html[Libraries]
...
link:ct-mobile-os-comparison.html[device platform]. 
