...
link:applications.html[Applications] module, on
link:mobile-layouts-applications.html[the mobile layout] of a record,
link:home-screen.html[Home Screen], or during a co-browsing session with
...
the *link:creating-application-record.html[Available for Download]*
...
link:applications.html[Applications] module, on
link:mobile-layouts-applications.html[the mobile layout] of a record,
and link:home-screen.html[Home Screen], it is necessary to take slide
screenshots. The *Renew Slides* functionality creates or replaces the
screenshots, for example, if some information was changed or the
animation was added. Taking a slide screenshot with a delay helps to
...
[NOTE] ==== If
link:ct-presenter-introduction.html#h2_1251281241[the required remote
