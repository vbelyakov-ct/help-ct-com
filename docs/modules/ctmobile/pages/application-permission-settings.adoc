...
To use link:home-screen.html#h3__1361691321[the mobile logo], a mobile
...
link:ct-mobile-control-panel.html[CT Mobile Control Panel] tabs to
...
link:sync-recovery.html[Sync Recovery] to process errors or
link:ct-mobile-replication.html[CT Mobile Replication] to hide these
