...
link:attach-files-to-clm-presentation.html[CLM presentation sources],
for example, images, scripts, and styles.

link:actions.html#h2_62618674[photos] and signatures of *Activity*
records;

attachments to the link:chatter.html[Chatter feed] posts;
...
We recommend using
the link:ct-mobile-control-panel-general.html#h3__377059502[Image
Quality] (in CT Mobile Control
Panel)/link:ct-mobile-control-panel-general-new.html#h3__377059502[Quality
...
link:fast-synchronization.html[fast synchronization].
