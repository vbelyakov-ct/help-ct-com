...
* You can use link:creating-a-widget.html[widgets] to make slides look
and feel different. To use widgets, it is needed to add
link:creating-a-placeholder.html[placeholders] where they would be
located.
...
available link:clm-template.html[here]. ====
* To activate JS Bridge in the HTML code,
link:activating-js-bridge.html[enable the JS Bridge library].
