...
link:applications.html#h3_1236408094[Mobile Scenario Editor] to learn
...
link:clm-customscenario.html[its details].
* Click the
image:edit-icon.png[]
...
link:publishing-clm-presentations.html#h3_1098755975[renew them].
...
link:clm-customscenario.html[favorites].
