...
Follow the steps in the link:remote-detailing-setup.html[Remote
...
link:remote-detailing-apex-trigger-classes-and-quick-action.html#h2_249047963[should
be specified] within the trigger code.
. Go to the link:ct-mobile-control-panel-presenter.html[CT Mobile
Control Panel:
...
checkboxes are selected for desired link:clm-application.html[CLM
presentations].
...
link:ct-mobile-control-panel-tools.html#h3__964087610[CT Mobile Control
