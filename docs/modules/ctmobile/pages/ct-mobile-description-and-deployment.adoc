...
. link:ct-mobile-description-and-deployment.html#h2_1760736937[Install
the CT Mobile package] in your Salesforce organization.
. link:ct-mobile-description-and-deployment.html#h2_720612721[Integrate
the CT Mobile package] with the target system.
. link:ct-mobile-description-and-deployment.html#h2_1575473858[Configure
the CT Mobile solution].
. link:ct-mobile-description-and-deployment.html#h2__501372078[Install
the CT Mobile app] on your mobile device.
. link:ct-mobile-description-and-deployment.html#h2_586849428[Log in to
the CT Mobile app] and
link:ct-mobile-description-and-deployment.html#h2_1500017970[perform the
first synchronization].
. Set up desired integrations, for example, with CT Orders, CT Sign, CG
Cloud, etc.

To find out more about integrations, go
to link:ct-mobile-os-comparison.html#h3_839939660[Other modules
availability] and link:ct-mobile-os-comparison.html#h2__303479492[Integrations].
...
link:installing-ct-mobile-package.html[Follow the guide] to install the
CT Mobile package. After installation,
link:remote-site-settings.html[set up remote site settings]. 
...
* link:ct-mobile-control-panel.html[CT Mobile Control Panel]​ is a tool
to provide a clear and convenient UI for CT Mobile settings. It is based
on Angular and REST API. Since the , you can use
link:ct-mobile-control-panel-new.html[CT Mobile Control Panel 2.0] with
more modern user interface and better performance.
* Application Editor​ is a tool to edit
link:manual-creating-clm-presentation.html[CLM presentations]. For
link:creating-plain-clm-presentation.html[plain CLM presentations],
the link:plain-application-editor.html[Plain Application Editor] is in
...
link:metadata-archive.html#h2_1854953360[Salesforce metadata] is
...
The CT Mobile app requests metadata using the
https://developer.salesforce.com/docs/atlas.en-us.api_meta.meta/api_meta/meta_intro.htm[Metadata
API] and link:metadata-checker.html#h2__1036043893[the metadata archive]
and other APIs.
...
link:custom-settings.html[Custom settings and custom metadata types] are
...
link:custom-settings.html[Custom settings&#44; custom metadata types],
and the link:ctm-settings.html[CTM Settings] object are used to store
...
* Apex classes and link:trigger-settings.html[triggers] are used for
...
* Fill out the
link:ct-mobile-control-panel-general.html#h3__2141706831[Product Object
API Name] and
...
link:ct-mobile-control-panel-general-new.html#h4__351797814[Relate
...
object on the link:clm-applicationstats.html[Application Stats] object.
...
specified on the link:ct-mobile-control-panel-calendar.html[CT Mobile
...
link:clm-application.html[Application] object.

ifdef::ios[][TIP] ==== CT mobile allows identifying
link:system-label.html[the records created or edited in the CT Mobile
app]. ====
...
via link:ct-mobile-control-panel.html[CT Mobile Control
...
Customize the link:home-screen.html[Home Screen].

Add objects and modules to link:app-menu.html[the main menu].
...
link:list-views.html[list views],
link:managing-offline-objects.html#ManagingOfflineObjects-SOQLFilters[SOQL
filters], lookup filters, and
link:actions.html[actions]. link:person-accounts.html[Person
Accounts] are supported. 

ifdef::ios[]

Specify screen forms, such as link:compact-layout.html[compact layouts],
link:mini-layouts.html[mini layouts], link:mobile-layouts.html[mobile
layouts],
link:fields-display-on-the-screen-of-the-mobile-application.html[custom
fields display], link:custom-color-settings.html[custom color settings],
add link:app-menu.html#h2__312093935[the custom icon for the main tab]
of the record screen, and
link:renaming-menu-items-and-modules.html[rename menu items].

Configure CT Mobile workflows (refer to
link:ct-mobile-control-panel-workflows.html[CT Mobile Control Panel:
Workflows] or link:ct-mobile-control-panel-workflows-new.html[CT Mobile
Control Panel 2.0: Workflows]).

Configure sync options, such as link:ct-mobile-replication.html[CT
Mobile Replication], link:conflict-manager-control.html[Conflict
Manager], link:online-records-fetching.html[online record fetching], and
quick record sync (refer
to link:ct-mobile-control-panel-offline-objects.html#h3_202390671[CT
Mobile Control Panel: Offline Objects] or
link:ct-mobile-control-panel-offline-objects-new.html#h4_202390671[CT
...
Specify screen forms, such as link:compact-layout.html[compact layouts],
link:mini-layouts.html[mini layouts], link:mobile-layouts.html[mobile
layouts], and link:custom-color-settings.html[custom color settings].

ifdef::kotlin[]

Configure link:ct-mobile-replication-use-cases-and-steps.html[CT Mobile
Replication].

ifdef::ios,win[]

Implement link:js-bridge-api.html[JS Bridge methods] in CLM
...
link:installing-the-ct-mobile-app.html[the article].
...
Go to link:ct-mobile-os-comparison.html[CT Mobile OS Comparison] to view
the core functionalities and learn about the difference between the CT
Mobile app on iOS, Windows, or Android devices.

ifdef::ios[]

link:home-screen.html[Status Indicator] suggests to a user to perform a
...
link:sync-logs.html[Specify the logging level] for saving sync logs of
the CT Mobile app, which can be useful for the Customertimes Support
team in case of issues with the mobile app.

link:application-settings.html[Application Settings] are intended to
...
link:logging-in.html[Log in to the CT Mobile app] using your Salesforce
credentials to a production environment, sandbox instance, or custom
domain.

ifdef::ios[]

CT Mobile is implemented with link:oauth-2-0.html[OAuth 2.0] and
supports link:logging-in-with-single-sign-on.html[Single Sign-On].

ifdef::kotlin,win[]

CT Mobile is implemented with the link:oauth-2-0.html[OAuth
2.0] protocol.
...
to link:synchronization.html[Synchronization].
