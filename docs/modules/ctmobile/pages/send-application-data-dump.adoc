...
the link:sync-log.html[Sync Log] record. The size of the ZIP archive
...
To use this option,
link:ct-mobile-control-panel-tools.html#h3_2011978[the cloud token]
...
. Go to link:ct-mobile-control-panel-general-new.html[CT Mobile Control
Panel 2.0: General].
...
To use this option,
link:ct-mobile-control-panel-tools-new.html#h2_2011978[the cloud token]
should be valid. In the case the cloud token is not specified, the
password will be[.apiobject]#ctmobile#. 
* *E-mail*
...
. Go to link:application-settings.html[Settings] from
