...
link:application-settings.html#h2__397515857[Change user] button to
...
* link:synchronization-launch.html[Full synchronization] malfunction.
...
The current user logged out, and link:logging-in.html[the login screen]
opens.
