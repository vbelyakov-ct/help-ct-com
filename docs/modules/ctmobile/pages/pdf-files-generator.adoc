...
user link:clm-presentation-controls.html#h2_1347300086[sends a PDF
file] from a CLM presentation or calls
the link:ctm-generatepdf.html[ctm.generatePDF] method.
...
link:attachments-and-files.html[attachment] to the CLM presentation.
