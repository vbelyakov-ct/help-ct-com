...
current user. The set of items in the list link:app-menu.html[can be
...
link:home-screen.html[Home] or link:application-settings.html[Settings])
...
* Records can be marked with link:custom-color-settings.html[custom
colors].
...
link:application-permission-settings.html[permission to create records].
* If there is link:related-list-filters.html[a setting in CT Mobile],
tap *Load more records* to open the online records loading screen.
* Tap
image:58835652.png[]
to open the link:ipad.html#h2__1243490689[detailed list view] with
...
link:application-permission-settings.html[permission to delete records].
...
separated link:mobile-layouts.html[into tabs and sections].
...
* Tap
image:58835655.png[]
to open the link:actions.html[Actions] modal window.
...
* If the link:reference-fields.html#h2__1514470758[Online One Record
