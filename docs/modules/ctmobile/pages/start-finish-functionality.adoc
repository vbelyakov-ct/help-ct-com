...
. Go to link:ct-mobile-control-panel-calendar.html[CT Mobile Control
Panel: Calendar].
. {blank}
...
link:ct-mobile-control-panel-calendar.html#h3_1674628596[Activity Start
Date field] and
link:ct-mobile-control-panel-calendar.html#h3_1391348303[Activity End
Date field] will be updated.
[NOTE] ==== If you assign a link:ct-mobile-workflow.html[CT
...
. Go to link:ct-mobile-control-panel-activities-new.html[CT Mobile
...
If enabled, when a mobile user taps the *Start* button, the current
geolocation will be written in the
link:ct-mobile-control-panel-activities-new.html#h4__1419137192[Geolocation
Field].
ifdef::kotlin[]
...
If enabled, when a mobile user taps the *Start* or *Finish* buttons, the
link:ct-mobile-control-panel-activities-new.html#h4__1766544266[Start
Date field] and
link:ct-mobile-control-panel-activities-new.html#h4_587549689[End Date
...
link:mobile-application-setup.html[Mobile Application Setup] record.

* Select this option on the
link:ct-mobile-control-panel-calendar.html#h3_1856075785[CT Mobile
...
object.
. Create the link:ct-mobile-control-panel-workflows.html[CT Mobile
...
[.apiobject]#false#.
. Add link:validation.html[the validation rule], which will be triggered
...
* Select this option on the
link:ct-mobile-control-panel-activities-new.html#h4__1904984675[CT
...
[.apiobject]#false# value on the[.object]#Activity#
object.
. Create the link:ct-mobile-control-panel-workflows-new.html[CT Mobile
Workflow] on the *Start* button to change the
[.apiobject]#false# value of the checkbox to
[.apiobject]#true#.
. Create the CT Mobile Workflow on the *Finish* button to change the
