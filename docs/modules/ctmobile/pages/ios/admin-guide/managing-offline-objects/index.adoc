...
a custom related list, refer to link:custom-related-lists[Custom
Related Lists].

Before specifying objects,
configure link:remote-site-settings[remote site settings].
...
. Click *Save*.
For more information, refer to link:standard-related-lists[Standard
Related Lists].
image:47745401.png[]
...
. Enable the *Filter logic* and define the criteria logic, e.g.,
[.apiobject]#1 and 2 or 3#.
. In the *Display Settings* tab, enable link:timeline-view[the
