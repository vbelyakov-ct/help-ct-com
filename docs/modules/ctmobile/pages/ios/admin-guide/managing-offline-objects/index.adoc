...
a custom related list, refer to xref:ios/admin-guide/related-lists/custom-related-lists.adoc[Custom
Related Lists].

Before specifying objects,
configure xref:ios/admin-guide/remote-site-settings.adoc[remote site settings].
...
. Click *Save*.
For more information, refer to xref:ios/admin-guide/related-lists/standard-related-lists.adoc[Standard
Related Lists].
image:47745401.png[]
...
. Enable the *Filter logic* and define the criteria logic, e.g.,
[.apiobject]#1 and 2 or 3#.
. In the *Display Settings* tab, enable xref:ios/admin-guide/related-lists/timeline-view.adoc[the
