...
link:ios/ct-mobile-control-panel-offline-objects[offline objects]. You
...
link:ios/mobile-application-modules[the desired additional modules].
image:47745270.png[]
...
The icon is set. Launch link:ios/full-synchronization[full
synchronization].
