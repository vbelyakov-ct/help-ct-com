...
link:mobile-application-modules[modules]. If the
...
To rename link:applications[Applications],
link:libraries[Libraries], and link:quizzes[Quizzes] modules:
