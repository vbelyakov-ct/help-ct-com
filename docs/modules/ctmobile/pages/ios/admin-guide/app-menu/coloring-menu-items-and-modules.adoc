...
In the link:app-menu[app menu] since CT Mobile 2.5:
...
link:ct-mobile-control-panel-general#h2__1037766202[CT Mobile
Control Panel: General → User Interface] or
link:ct-mobile-control-panel-user-interface-new[CT Mobile Control
...
The setup is complete. link:synchronization-launch[Launch
