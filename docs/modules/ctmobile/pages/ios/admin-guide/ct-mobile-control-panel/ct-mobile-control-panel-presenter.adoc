...
saved in the corresponding fields of the link:clm-settings[CLM
Settings] record.
...
to link:js-bridge-methods-availability[JS Bridge Methods
Availability].

[[h3_856955672]]
==== Detailed Statistics Enabled

If enabled, link:remote-detailing-statistics[the statistics] per
...
link:remote-detailing-1-0-ui-for-presenter[can resume] the finished
Remote Detailing session. The statistics will be collected for the
resuming meeting too. Use
link:remote-detailing-f-a-q#h2__106650128[the same link] to enter
...
link:ct-mobile-control-panel-presenter#h3_1019207818[CT Mobile
Control Panel:
Presenter]/link:ct-mobile-control-panel-remote-detailing-new#h3_1019207818[CT
...
to link:remote-detailing-2-0-audio-recording[Remote Detailing 2.0:
Audio Recording].
...
link:ct-mobile-control-panel-presenter#h3_1157844415[Delete After
(days)] field.
...
link:ct-mobile-control-panel-presenter#h3_1230065320[Scheduled
...
The field API name of the link:clm-activity[Activity] object for
...
Specify link:remote-detailing-setup[the active site URL] for
...
Enter the API name of a checkbox of the link:clm-activity[Activity]
object, for example,[.apiobject]#IsRequiredEmail__c#. If
the checkbox is active, the participant should fill out an email on
link:remote-detailing-2-0-ui-for-participants#h2__555694282[the
