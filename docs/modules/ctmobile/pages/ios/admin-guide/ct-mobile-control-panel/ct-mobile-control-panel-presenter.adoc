...
* The presenter should receive the participant's permission to record audio using the Terms of Use on the Welcome Screen (refer to xref:ios/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-presenter.adoc#h3_1019207818[CT Mobile Control Panel: Presenter] / xref:ios/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-remote-detailing-new.adoc#h3_1019207818[CT Mobile Control Panel 2.0: Remote Detailing]).
...
If enabled, the audio of the Remote Detailing meeting will be automatically deleted from the _Activity_ record according to the expiration date in the xref:ios/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-presenter.adoc#h3_1157844415[Delete After (days)] field.

[[h3_1157844415]]
=== Delete After (days)

The number of days to keep an audio recording in Salesforce if the xref:ios/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-presenter.adoc#h3_1230065320[Scheduled Activity Audio Cleanup] attribute is enabled.
...
[%collapsible]
====
image:Refresh_CLM_RD_en.png[]

image:Refresh_CLM_RD_2_en.png[]
====
