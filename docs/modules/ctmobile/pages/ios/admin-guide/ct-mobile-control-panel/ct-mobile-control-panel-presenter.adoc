...
saved in the corresponding fields of the link:ios/clm-settings[CLM
Settings] record.
...
to link:ios/js-bridge-methods-availability[JS Bridge Methods
Availability].

[[h3_856955672]]
==== Detailed Statistics Enabled

If enabled, link:ios/remote-detailing-statistics[the statistics] per
...
link:ios/remote-detailing-1-0-ui-for-presenter[can resume] the finished
Remote Detailing session. The statistics will be collected for the
resuming meeting too. Use
link:ios/remote-detailing-f-a-q#h2__106650128[the same link] to enter
...
link:ios/ct-mobile-control-panel-presenter#h3_1019207818[CT Mobile
Control Panel:
Presenter]/link:ios/ct-mobile-control-panel-remote-detailing-new#h3_1019207818[CT
...
to link:ios/remote-detailing-2-0-audio-recording[Remote Detailing 2.0:
Audio Recording].
...
link:ios/ct-mobile-control-panel-presenter#h3_1157844415[Delete After
(days)] field.
...
link:ios/ct-mobile-control-panel-presenter#h3_1230065320[Scheduled
...
The field API name of the link:ios/clm-activity[Activity] object for
...
Specify link:ios/remote-detailing-setup[the active site URL] for
...
Enter the API name of a checkbox of the link:ios/clm-activity[Activity]
object, for example,[.apiobject]#IsRequiredEmail__c#. If
the checkbox is active, the participant should fill out an email on
link:ios/remote-detailing-2-0-ui-for-participants#h2__555694282[the
