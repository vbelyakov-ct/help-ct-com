...
lists of a record of link:managing-offline-objects[an offline
object].

Settings on this tab will be saved in the corresponding fields of
the link:mobile-custom-details-settings[Mobile Custom Details
Settings] record.
...
* Follow the steps link:custom-related-lists[here] to set up custom
