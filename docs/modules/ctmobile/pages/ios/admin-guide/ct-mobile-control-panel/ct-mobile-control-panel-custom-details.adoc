...
lists of a record of link:ios/managing-offline-objects[an offline
object].

Settings on this tab will be saved in the corresponding fields of
the link:ios/mobile-custom-details-settings[Mobile Custom Details
Settings] record.
...
* Follow the steps link:ios/custom-related-lists[here] to set up custom
