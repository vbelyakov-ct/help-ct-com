...
For the link:home-screen[Home screen], enable the *Customizable
Home screen* option. Add, size, and arrange widgets.

For link:managing-offline-objects[offline objects],
link:grouping-records[group records] by the criterion.

ifndef::andr,win,kotlin[]

For offline objects, enable link:online-records-fetching[online
record fetching].

For the link:applications[Applications] module,
link:grouping-records[group records] by the criterion.

For the link:links-list[Links] module, specify resources and web
pages.

ifndef::kotlin[]

For the link:routes[Routes] module, specify the ascending or
...
* link:app-menu[Configuring App Menu]
