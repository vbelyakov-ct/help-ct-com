...
link:managing-offline-objects[an offline object] according to the
criterion.

According to the selected profile, settings on this tab will be saved in
the corresponding fields of the link:mobile-customization[Mobile
...
* Follow the steps link:custom-color-settings[here] to assign
...
* link:custom-color-settings[Custom Color Settings]
