...
xref:ios/admin-guide/managing-offline-objects/index.adoc[an offline object] according to the
criterion.
...
* Follow the steps xref:ios/admin-guide/custom-color-settings.adoc[here] to assign
