...
link:ios/managing-offline-objects[an offline object] according to the
criterion.

According to the selected profile, settings on this tab will be saved in
the corresponding fields of the link:ios/mobile-customization[Mobile
...
* Follow the steps link:ios/custom-color-settings[here] to assign
...
* link:ios/custom-color-settings[Custom Color Settings]
