...
link:ios/mini-layouts[a mini-layout] to create a new record in the CT
Mobile app.

[TIP] ==== For easy setup, go to
link:ios/ct-mobile-control-panel-mini-layouts[CT Mobile Control Panel:
Mini Layouts]/link:ios/ct-mobile-control-panel-mini-layouts-new[CT
