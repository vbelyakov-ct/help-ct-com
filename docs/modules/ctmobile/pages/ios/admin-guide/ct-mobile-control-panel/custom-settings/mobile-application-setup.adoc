...
link:ct-mobile-control-panel-general[CT Mobile Control Panel:
General]/link:ct-mobile-control-panel-general-new[CT Mobile Control
Panel 2.0: General], link:ct-mobile-control-panel-activities-new[CT
...
link:mobile-layouts-maps[the Maps widget] if the value is not set
...
get the location in the link:routes[Routes] and
link:nearby-accounts[Nearby Accounts] modules.
...
field is used when the link:start-finish-functionality[Start/Finish
...
link:clm-applicationstats[the Application Stats object] to the
[.object]#Activity# object.
...
[NOTE] ==== link:js-bridge-api[JS Bridge as well as
...
|Text(255) a|
The default view in the link:calendar[Calendar] module. Available
values:
...
link:ct-mobile-managed-package-update-to-v-3-54[Depending on the CT
Mobile package and CT Mobile app version], the cloud token may be stored
in the link:api-key[API Key] custom setting.

|Debug Level |[.apiobject]#clm__DebugLevel__c#
|Text(255) a|
Defines link:sync-logs[sync logs] must be stored Available values:
...
|Text(255) |link:google-maps-api-key[Access key to Google Maps
...
|link:google-maps-api-key[Access key to Google Maps services]
...
Maps in link:geolocation-center[the Geolocation center].

|Image Quality |[.apiobject]#clm__ImageQuality__c#
|Number(3,0) |Image compression
functionality (link:ct-mobile-control-panel-general#h3__377059502[CT
Mobile Control Panel:
General]/link:ct-mobile-control-panel-general-new#h3__377059502[CT
...
|If enabled, link:person-accounts[Person Accounts] are used in the
CT Mobile app.
...
link:clm-application[Application] object to the
link:clm-product[Product] object.
...
|The API name of the link:reference-object[Reference] object.
...
|Enable the link:start-finish-functionality[Start/Finish
functionality].
...
the link:start-finish-functionality[Start/Finish functionality],
...
link:start-finish-functionality[Start/Finish functionality] is
enabled.
