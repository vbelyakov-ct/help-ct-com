...
Panel 2.0: General], link:ios/ct-mobile-control-panel-activities-new[CT
...
link:ios/mobile-layouts-maps[the Maps widget] if the value is not set
...
get the location in the link:ios/routes[Routes] and
...
field is used when the link:ios/start-finish-functionality[Start/Finish
...
link:ios/clm-applicationstats[the Application Stats object] to the
[.object]#Activity# object.
...
[NOTE] ==== link:ios/js-bridge-api[JS Bridge as well as
...
|Text(255) a|
The default view in the link:ios/calendar[Calendar] module. Available
values:
...
link:ios/ct-mobile-managed-package-update-to-v-3-54[Depending on the CT
Mobile package and CT Mobile app version], the cloud token may be stored
in the link:ios/api-key[API Key] custom setting.

|Debug Level |[.apiobject]#clm__DebugLevel__c#
|Text(255) a|
Defines link:ios/sync-logs[sync logs] must be stored Available values:
...
|Text(255) |link:ios/google-maps-api-key[Access key to Google Maps
...
|link:ios/google-maps-api-key[Access key to Google Maps services]
...
Maps in link:ios/geolocation-center[the Geolocation center].

|Image Quality |[.apiobject]#clm__ImageQuality__c#
|Number(3,0) |Image compression
functionality (link:ios/ct-mobile-control-panel-general#h3__377059502[CT
Mobile Control Panel:
General]/link:ios/ct-mobile-control-panel-general-new#h3__377059502[CT
...
|If enabled, link:ios/person-accounts[Person Accounts] are used in the
CT Mobile app.
...
link:ios/clm-application[Application] object to the
link:ios/clm-product[Product] object.
...
|The API name of the link:ios/reference-object[Reference] object.
...
|Enable the link:ios/start-finish-functionality[Start/Finish
functionality].
...
the link:ios/start-finish-functionality[Start/Finish functionality],
...
link:ios/start-finish-functionality[Start/Finish functionality] is
enabled.
