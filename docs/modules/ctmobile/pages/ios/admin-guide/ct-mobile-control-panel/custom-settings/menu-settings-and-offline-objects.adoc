...
of the link:ctm-settings-menu[Menu] record type of the
custom link:ctm-settings[CTM Settings] object.
[TIP] ==== For easy setup, go to
link:ct-mobile-control-panel[CT Mobile Control Panel]. CT Mobile
Control Panel makes duplicates of the offline objects list in
link:related-list-filters[Related List Filters] so that to be able
...
be grouped by the title of link:compact-layout[a compact layout].
