...
image::Tools_new_settings_only.png[align="center"]
====
...
To work with the metadata archive, specify the <<Cloud Token>> first. Read more about the metadata archive xref:ios/admin-guide/metadata-checker/metadata-archive/index.adoc[here].
...
To work with the metadata archive, specify the xref:ios/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_2011978[Cloud token] first. Read more about the metadata archive xref:ios/admin-guide/metadata-checker/metadata-archive/index.adoc[here].
