...
link:ios/security-token[Security Token] article for additional
information.



CT Mobile receives link:ios/metadata-archive#h2_1854953360[metadata
...
downloading of metadata during link:ios/synchronization[the
...
link:ios/installing-ct-mobile-package[the CT Mobile package was
...
link:ios/ct-mobile-package-release-notes#h2_466019125[CT Mobile Package
version 3.89]. ====
...
the link:ios/ct-mobile-control-panel-tools#h3_2011978[Cloud
...
link:ios/ct-mobile-package-release-notes#h2_466019125[3.89 of CT Mobile
...
between CTM Settings and link:ios/custom-settings[Custom Settings]. All
records of link:ios/ctm-settings[CTM Settings] will be deleted and
re-created according to the corresponding records of
link:ios/custom-settings[custom settings].
...
link:ios/metadata-checker[Metadata Checker] is intended to track any
...
link:ios/remote-site-settings[remote site settings]. ====
...
Is a password, which encrypts link:ios/send-application-data-dump[a
data dump] before sending it to support via e-mail or to Salesforce,
depending on settings in link:ios/ct-mobile-control-panel-general[CT
...
Is used to create an link:ios/metadata-archive[archive with actual
...
Creating and updating slides in link:ios/application-editor[the
Application Editor], including
link:ios/creating-clm-presentation-from-powerpoint[PowerPoint] and
link:ios/creating-clm-presentation-from-pdf[PDF] files converting.

link:ios/plain-application-editor[The Plain Applications Editor],
...
link:ios/clm-application[active CLM presentations] from this folder to
