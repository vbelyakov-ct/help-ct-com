...
link:ios/using-calendar#h2__1759778354[the default calendar view]. The
available options:
...
link:ios/start-finish-functionality[start and finish an activity] using
the additional logic that may be applied to a started activity.

ifdef::ios[]

[NOTE] ==== If you have a link:ios/ct-mobile-workflow[CT Mobile
...
link:ios/start-finish-functionality#h2_239706372[Enable this option],
...
link:ios/ct-mobile-control-panel-general[the geolocation data] of the
