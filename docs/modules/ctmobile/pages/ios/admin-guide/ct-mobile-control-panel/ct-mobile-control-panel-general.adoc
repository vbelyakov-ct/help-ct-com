...
link:person-accounts[Person Accounts] functionality. If enabled:
...
the link:ct-mobile-control-panel-general#h3_494016929[Reference
...
will ask the user link:application-pin-code[to set a personal
...
times in a row, link:log-out[the database will be reset].
...
This section is intended to link:application-theme[personalize the
CT Mobile interface].
...
link:home-screen#h3__1361691321[the Logo widget] is added on the
...
Geolocation data may be used for link:mobile-layouts-maps[the Maps
widget] on a record, in the link:routes[Routes] and
...
link:ct-mobile-control-panel-general#h3_612123135[Account
Geolocation] or
link:ct-mobile-control-panel-general#h3__1092547330[Account Full
...
Obtain and enter your link:google-maps-api-key[Google Maps API key]
...
Obtain and enter your
https://docs.microsoft.com/en-us/bingmaps/getting-started/bing-maps-dev-center-help/getting-a-bing-maps-key[]link:google-maps-api-key[Google
...
Obtain and enter your link:google-maps-api-key[Google Maps
JavaScript API Key] to track the geolocation of CT Mobile iOS users in
real-time via the link:geolocation-center[Geolocation Centre] in
Salesforce.
...
If enabled, the link:sync-logs[Sync Log] records will be created
...
Choose where to link:send-application-data-dump[send the customer's
...
Name* field of the link:mobile-application-setup[Mobile Application
Setup] should be correctly specified for each
[.object]#Activity# object in the
link:ct-mobile-control-panel-calendar#h3_1397263211[Activity Object
API Name] field.
...
For more information, refer to link:reference-object[Reference
Object].
