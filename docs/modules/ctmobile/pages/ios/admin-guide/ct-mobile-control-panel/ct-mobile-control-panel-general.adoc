...
[%collapsible]
====
image::control_panel_general.png[align="center"]
====
...
* [.object]#Person Accounts# are displayed in the *Contacts* menu item and on the *Contacts* tab of the modules, except for the cases if the [.object]#Reference# object is selected in the <<Reference Object API Name>> field.
...
NOTE: If geolocation data is not specified, the account location will be retrieved from the <<Account Full Address Field, Account Full Address>> field.
...
Obtain and enter your xref:ios/admin-guide/google-maps-api-key/index.adoc[Google Maps API key] on this tab for using Google Maps in the CT Mobile Android apps.
