...
the link:ios/ct-mobile-control-panel-general#h3_494016929[Reference
...
This section is intended to link:ios/application-theme[personalize the
CT Mobile interface].
...
link:ios/home-screen#h3__1361691321[the Logo widget] is added on the
...
Geolocation data may be used for link:ios/mobile-layouts-maps[the Maps
...
link:ios/ct-mobile-control-panel-general#h3_612123135[Account
Geolocation] or
link:ios/ct-mobile-control-panel-general#h3__1092547330[Account Full
...
real-time via the link:ios/geolocation-center[Geolocation Centre] in
Salesforce.
...
If enabled, the link:ios/sync-logs[Sync Log] records will be created
...
Name* field of the link:ios/mobile-application-setup[Mobile Application
Setup] should be correctly specified for each
[.object]#Activity# object in the
link:ios/ct-mobile-control-panel-calendar#h3_1397263211[Activity Object
API Name] field.
...
For more information, refer to link:ios/reference-object[Reference
Object].
