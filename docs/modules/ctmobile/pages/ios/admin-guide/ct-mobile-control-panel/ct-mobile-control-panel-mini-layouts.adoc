...
* Follow the steps xref:ios/admin-guide/mini-layouts.adoc[here] to configure a mini
layout for xref:ios/admin-guide/managing-offline-objects/index.adoc[the desired offline
object].
...
* xref:ios/admin-guide/mini-layouts.adoc[Configuring Mini Layouts]
