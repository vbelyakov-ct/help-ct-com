...
the link:mobile-mini-layout-settings[Mobile Mini Layout
Settings] record.
...
* Follow the steps link:mini-layouts[here] to configure a mini
layout for link:managing-offline-objects[the desired offline
object].
...
* link:mini-layouts[Configuring Mini Layouts]
