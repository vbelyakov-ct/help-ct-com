...
the link:ios/mobile-mini-layout-settings[Mobile Mini Layout
Settings] record.
...
* Follow the steps link:ios/mini-layouts[here] to configure a mini
layout for link:ios/managing-offline-objects[the desired offline
object].
...
* link:ios/mini-layouts[Configuring Mini Layouts]
