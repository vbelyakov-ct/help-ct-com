...
records of the link:ct-mobile-workflow[CT Mobile
Workflow] and link:ct-mobile-workflow-step[CT Mobile Workflow
Step].
...
. Click *Create*.
. Fill out the fields. Refer to link:ct-mobile-workflow[CT Mobile
...
. Fill out the fields. Refer to link:ct-mobile-workflow-step[CT
...
* link:ct-mobile-workflows-use-cases[CT Mobile Workflows: Use
Cases]
* link:ct-mobile-workflows-use-cases[]
link:ct-mobile-workflow[CT Mobile Workflow Field Reference]
* link:ct-mobile-workflow-step[CT Mobile Workflow Step Field
Reference]
