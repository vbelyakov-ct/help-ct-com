...
records of the link:ios/ct-mobile-workflow[CT Mobile
Workflow] and link:ios/ct-mobile-workflow-step[CT Mobile Workflow
Step].
...
. Click *Create*.
. Fill out the fields. Refer to link:ios/ct-mobile-workflow[CT Mobile
...
. Fill out the fields. Refer to link:ios/ct-mobile-workflow-step[CT
...
* link:ios/ct-mobile-workflows-use-cases[CT Mobile Workflows: Use
Cases]
* link:ios/ct-mobile-workflows-use-cases[]
link:ios/ct-mobile-workflow[CT Mobile Workflow Field Reference]
* link:ios/ct-mobile-workflow-step[CT Mobile Workflow Step Field
Reference]
