...
the link:ct-mobile-control-panel[CT Mobile Control Panel].
[.object]#CTM Settings# has record types that correspond to
specific link:custom-settings[custom settings].
...
* Settings for the link:menu-settings-and-offline-objects[menu],
link:related-list-filters[offline objects&#44; and standard related
...
** link:ctm-settings-menu[Menu]
** link:ctm-settings-offline-objects[Offline Objects]
