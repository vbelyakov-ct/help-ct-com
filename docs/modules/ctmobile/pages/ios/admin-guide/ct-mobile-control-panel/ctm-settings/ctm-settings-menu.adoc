...
Menu]/link:ios/ct-mobile-control-panel-app-menu-new[CT Mobile Control
Panel 2.0: App Menu]. ====
...
a|
Stores an API Name of link:ios/managing-offline-objects[an offline
object], link:ios/mobile-application-modules[module's name], or name of
a menu item, e.g., link:ios/home-screen[Home] and
link:ios/application-settings[Settings], that will be available in
...
section while creating a new link:ios/list-views#h2__380480215[mobile
...
Defines the way how link:ios/libraries[Library] object must be
downloaded during synchronization, as full content or as a preview.
Interacts with the
link:ios/application-settings#h3_1768799377[Background content loading]
...
link:ios/synchronization[synchronization] with displaying a loader.
** *Background content loading* is disabled: the full content of the
Library object will be downloaded
after link:ios/synchronization[synchronization].
...
|Text(255) a|
Stores an API Name of a field for link:ios/grouping-records[grouping
records] in link:ios/app-menu[the main menu].
...
of link:ios/menu-settings-and-offline-objects[Menu Settings and Offline
