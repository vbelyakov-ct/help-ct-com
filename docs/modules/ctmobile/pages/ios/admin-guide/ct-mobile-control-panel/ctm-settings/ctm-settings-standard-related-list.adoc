...
link:managing-offline-objects[offline object&#44;] as well as
...
Area(32768) a|
Stores link:filters-in-related-lists[a SOQL query] to filter
...
link:timeline-view[Timeline] view. In other cases, left blank.
...
the link:online-records-fetching[Load more records] button is
...
|Text(255) a|
link:application-permission-settings[Organization ID/Profile ID] to
...
|Checkbox |Enable link:synchronization-launch[Quick Record
