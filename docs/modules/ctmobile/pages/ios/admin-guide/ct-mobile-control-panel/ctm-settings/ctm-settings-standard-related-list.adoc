...
xref:ios/admin-guide/managing-offline-objects/index.adoc[offline object&#44;] as well as
...
xref:ios/admin-guide/related-lists/timeline-view.adoc[Timeline] view. In other cases, left blank.
...
the xref:ios/admin-guide/managing-offline-objects/online-records-fetching.adoc[Load more records] button is
...
|Text(255) a|
xref:ios/getting-started/application-permission-settings.adoc[Organization ID/Profile ID] to
...
|Checkbox |Enable xref:ios/mobile-application/synchronization/synchronization-launch/index.adoc[Quick Record
