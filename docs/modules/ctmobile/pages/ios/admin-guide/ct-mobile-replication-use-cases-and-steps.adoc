...
link:ios/ct-mobile-replication[CT Mobile Replication] is intended to
...
were downloaded via link:ios/synchronization-launch#h2__966867633[full
...
records will lead to link:ios/errors-screen[errors], and the newly
...
the corresponding user during link:ios/fast-synchronization[the fast or
...
. Run link:ios/synchronization[the fast synchronization].
