...
. Go to link:ct-mobile-control-panel-calendar[CT Mobile Control
Panel: Calendar].
. {blank}
...
link:ct-mobile-control-panel-calendar#h3_1674628596[Activity Start
Date field] and
link:ct-mobile-control-panel-calendar#h3_1391348303[Activity End
Date field] will be updated.
[NOTE] ==== If you assign a link:ct-mobile-workflow[CT
...
. Go to link:ct-mobile-control-panel-activities-new[CT Mobile
...
If enabled, when a mobile user taps the *Start* button, the current
geolocation will be written in the
link:ct-mobile-control-panel-activities-new#h4__1419137192[Geolocation
Field].
ifdef::kotlin[]
...
If enabled, when a mobile user taps the *Start* or *Finish* buttons, the
link:ct-mobile-control-panel-activities-new#h4__1766544266[Start
Date field] and
link:ct-mobile-control-panel-activities-new#h4_587549689[End Date
...
link:mobile-application-setup[Mobile Application Setup] record.

* Select this option on the
link:ct-mobile-control-panel-calendar#h3_1856075785[CT Mobile
...
object.
. Create the link:ct-mobile-control-panel-workflows[CT Mobile
...
[.apiobject]#false#.
. Add link:validation[the validation rule], which will be triggered
...
* Select this option on the
link:ct-mobile-control-panel-activities-new#h4__1904984675[CT
...
[.apiobject]#false# value on the[.object]#Activity#
object.
. Create the link:ct-mobile-control-panel-workflows-new[CT Mobile
Workflow] on the *Start* button to change the
[.apiobject]#false# value of the checkbox to
[.apiobject]#true#.
. Create the CT Mobile Workflow on the *Finish* button to change the
