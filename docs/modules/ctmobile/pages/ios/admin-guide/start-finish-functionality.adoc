...
Now, the *Start* and *Finish* buttons are added to the _Activity_ record
screen.
...
xref:ios/admin-guide/ct-mobile-control-panel/custom-settings/mobile-application-setup.adoc[Mobile Application Setup] record.
...
* The mobile user will be able to leave the started _Activity_ record
and then come back to finish the _Activity_ record.

The unfinished _Activity_ records will be synchronized. To restrict the
