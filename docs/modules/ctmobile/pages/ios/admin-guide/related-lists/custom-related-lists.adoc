...
can link:ios/custom-related-lists#h3__1591488796[set a custom
...
. Go to link:ios/ct-mobile-control-panel-custom-details-new[CT Mobile
...
link:ios/ct-mobile-control-panel-custom-details[]
...
go to link:ios/columns-width-for-related-lists#h2__947661563[Columns'
...
. Click *Manage* next to link:ios/mobile-custom-details-settings[Mobile
...
link:ios/application-permission-settings[permission to edit] an object,
which records are displayed in the custom related list.
. Specify link:ios/managing-offline-objects#h2_1534686659[permission to
