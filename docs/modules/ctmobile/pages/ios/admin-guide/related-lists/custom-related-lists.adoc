...
can link:custom-related-lists#h3__1591488796[set a custom
...
. Go to link:ct-mobile-control-panel-custom-details-new[CT Mobile
...
link:ct-mobile-control-panel-custom-details[]
...
go to link:columns-width-for-related-lists#h2__947661563[Columns'
...
. Click *Manage* next to link:mobile-custom-details-settings[Mobile
...
link:application-permission-settings[permission to edit] an object,
which records are displayed in the custom related list.
. Specify link:managing-offline-objects#h2_1534686659[permission to
