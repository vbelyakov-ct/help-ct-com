...
link:ios/managing-offline-objects#ManagingOfflineObjects-SOQLFilters[Set
...
record type of the link:ios/ctm-settings[CTM Settings] object.
...
The sorting order for link:ios/custom-related-lists[a custom related
list] is stored in link:ios/mobile-custom-details-settings[Mobile
