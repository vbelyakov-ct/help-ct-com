...
link:ios/reference-fields[the reference field]. In the CT Mobile app,
two types of related lists are available:

* link:ios/custom-related-lists[Custom Related Lists]
* link:ios/standard-related-lists[Standard Related Lists]
...
list;
* Go to link:ios/ct-mobile-control-panel-custom-details[CT Mobile
Control Panel: Custom
details]/link:ios/ct-mobile-control-panel-custom-details-new[CT Mobile
Control Panel 2.0: Custom Details] to customize a custom related list.

|Create a record |{plus} |{plus} a|
Grant permission:

* on link:ios/ct-mobile-control-panel-offline-objects[CT Mobile Control
Panel: Offline
Objects]/link:ios/ct-mobile-control-panel-offline-objects-new[CT Mobile
Control Panel 2.0: Offline Objects] for a standard related list;
* on link:ios/ct-mobile-control-panel-custom-details[CT Mobile Control
Panel: Custom
details]/link:ios/ct-mobile-control-panel-custom-details-new[CT Mobile
...
Objects]/link:ios/ct-mobile-control-panel-offline-objects-new[CT Mobile
Control Panel 2.0: Offline Objects] for a standard related list;
* in link:ios/ct-mobile-control-panel-custom-details[CT Mobile Control
Panel: Custom
details]/link:ios/ct-mobile-control-panel-custom-details-new[CT Mobile
Control Panel 2.0: Custom Details] for a custom related list.
...
* Go to link:ios/custom-related-lists#h2__773495381[Custom Related
...
list;
* Grant permission on
link:ios/ct-mobile-control-panel-custom-details[CT Mobile Control
Panel: Custom
details]/link:ios/ct-mobile-control-panel-custom-details-new[CT Mobile
...
link:ios/columns-width-for-related-lists[Columns' Widths for Standard
...
link:ios/timeline-view[Timeline View]. ifdef::win,andr,kotlin[]
[NOTE] ==== Not in use. ====
...
link:ios/filters-in-related-lists[Filters in Related Lists].
|===
