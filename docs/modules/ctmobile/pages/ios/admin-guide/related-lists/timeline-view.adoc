...
link:standard-related-lists[standard related lists] as a tree of
...
timeline view does not apply to link:custom-related-lists[custom
related lists]. #
...
* If needed, link:custom-color-settings[set the colors] for each
activity type.
* link:managing-offline-objects[If enabled], it is possible to
...
link:event-notifications[to set a reminder].
