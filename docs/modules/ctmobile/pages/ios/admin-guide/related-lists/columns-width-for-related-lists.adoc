...
link:ios/metadata-archive[Metadata Archive] and
link:ios/metadata-checker[Metadata Checker]. ==== ifdef::kotlin[]
...
link:ios/synchronization[full synchronization] to apply the changes.
