...
link:metadata-archive[Metadata Archive] and
link:metadata-checker[Metadata Checker]. ==== ifdef::kotlin[]
...
link:synchronization[full synchronization] to apply the changes.
