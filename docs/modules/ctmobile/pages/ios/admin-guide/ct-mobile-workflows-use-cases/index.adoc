...
of xref:ios/admin-guide/ct-mobile-workflows-use-cases/ct-mobile-workflow.adoc[CT Mobile
Workflow] and xref:ios/admin-guide/ct-mobile-workflows-use-cases/ct-mobile-workflow-step.adoc[CT Mobile Workflow
Step] objects.
...
will be populated on the _Activity_ record with the *Planned* status.
...
out the *Website* field on the custom _Activity_ record with the value
...
the status of the _Activity_ record has changed to the *Finished* value.
...
user taps the *Start* button on the _Activity_ record.
...
_Activity_ record with the *Planned* status.
...
Progress* status for the _Activity_ record.
...
marketing cycle to the _Activity_ record.
