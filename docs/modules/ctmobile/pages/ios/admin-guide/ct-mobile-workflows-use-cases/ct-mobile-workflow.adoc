...
Workflows]/link:ios/ct-mobile-control-panel-workflows-new[CT Mobile
Control Panel 2.0: Workflows]). Actions of CT Mobile Workflow are stored
in the link:ios/ct-mobile-workflow-step[CT Mobile Workflow Step]
object.
...
link:ios/start-finish-functionality[the Start/Visit button], the
...
link:ios/ct-mobile-workflow#h2__925686890[The button API name] to
...
|link:ios/start-finish-functionality[The Start button] of the
[.object]#Activity# object.

|[.apiobject]#CTM.Button.FinishActivity#
|link:ios/start-finish-functionality[The Finish button] of the
[.object]#Activity# object.
...
link:ios/managing-offline-objects[record creation] in related lists.

|[.apiobject]#CTM.Button.Geoposition# |The button displays a
link:ios/actions[combo menu] to define Geolocation.

|[.apiobject]#CTM.Button.ActivityHistory# |The icon displays
link:ios/historical-activities[historical activities].

|[.apiobject]#CTM.Button.Signature# |The
link:ios/actions[combo-menu] button displays a pop-up signature window.

|[.apiobject]#CTM.Button.ScanBarсode# |The icon displays
link:ios/barcode-scanner[the EAN code scanner] on the related list.
...
link:ios/actions[a new post] in the link:ios/chatter[Chatter feed] is
added.

|[.apiobject]#CTM.Button.ConvertLead# |Pressing the button
link:ios/lead-convert[converts Leads] into an
[.object]#Account# record.

|[.apiobject]#CTM.Button.SortSwitch# |The switcher is to edit
the visibility of records in link:ios/custom-related-lists[a custom
related list].
