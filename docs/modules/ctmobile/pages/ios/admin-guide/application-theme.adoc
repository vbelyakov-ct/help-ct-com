...
to link:ct-mobile-control-panel-user-interface-new[CT Mobile
Control Panel 2.0: User Interface].
...
The logo is represented on the link:home-screen[Home screen] if the
...
size. After that, launch the link:fast-synchronization[fast
synchronization].
...
The logo is represented on the link:home-screen[Home screen]. Click
