...
link:ct-mobile-control-panel-tools#h3_1003786176[CT Mobile Control
Panel:
...
to link:metadata-checker[Metadata Checker].
...
in link:ct-mobile-control-panel-tools#h3_2011978[CT Mobile Control
...
link:fields-display-on-the-screen-of-the-mobile-application[optional
