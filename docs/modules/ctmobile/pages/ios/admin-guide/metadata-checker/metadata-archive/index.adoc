...
to link:ios/metadata-checker[Metadata Checker].
...
in link:ios/ct-mobile-control-panel-tools#h3_2011978[CT Mobile Control
...
link:ios/fields-display-on-the-screen-of-the-mobile-application[optional
