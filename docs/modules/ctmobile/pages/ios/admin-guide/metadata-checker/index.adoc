...
the link:ios/mobile-application-setup[Mobile Application Setup]. If the
user does not have this access, grant it
by assigning link:ios/application-permission-settings#ApplicationPermissionSettings-PermissionSets[one
...
link:ios/metadata-archive#h2_1854953360[metadata components].
* For archiving metadata components.
* For auto-updating a value in the
[.apiobject]#clm__MetadataLastModifiedDate__c# field of
the link:ios/mobile-application-setup[Mobile Application Setup]
records.
...
. Go to the link:ios/ct-mobile-control-panel-tools[CT Mobile Control
Panel: Tools] tab.
...
the link:ios/ct-mobile-control-panel-tools#h4_1003786176[CT Mobile
Control Panel:
