...
by assigning xref:application-permission-settings#ApplicationPermissionSettings-PermissionSets[one
...
xref:metadata-archive#h2_1854953360[metadata components].
...
. Go to the xref:ct-mobile-control-panel-tools[CT Mobile Control
Panel: Tools] tab.
