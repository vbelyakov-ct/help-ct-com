...
link:managing-offline-objects[the offline object].
...
. Go to link:ct-mobile-control-panel-mini-layouts[CT Mobile Control
Panel: Mini Layouts].
. Click *Create layout*.
image:47745554.png[]
...
link:application-permission-settings[permissions for the selected
...
. Go to link:ct-mobile-control-panel-mini-layouts-new[CT Mobile
...
link:application-permission-settings[proper permissions for the
...
link:ct-mobile-control-panel-mini-layouts[]
