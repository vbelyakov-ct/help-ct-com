...
link:ios/managing-offline-objects[an offline object] by the specific
criterion, for example, records in the left menu, activities in the
link:ios/calendar[Calendar] module, and records in the
link:ios/nearby-accounts[Nearby Accounts] module. Each offline object
...
. Go to link:ios/ct-mobile-control-panel-color-settings[CT Mobile
...
. Go to link:ios/ct-mobile-control-panel-colors-new[CT Mobile Control
Panel 2.0: Colors].
. {blank}
...
link:ios/synchronization-launch[Launch synchronization] to apply the
changes. ifdef::kotlin[] The setup is complete.
link:ios/synchronization-launch[Launch mixed synchronization] to apply
the changes.
ifdef::ios[]
image:62561517.png[]
ifdef::win[]
