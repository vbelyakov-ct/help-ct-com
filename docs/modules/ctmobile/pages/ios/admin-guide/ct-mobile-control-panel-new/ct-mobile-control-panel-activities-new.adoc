...
the link:ios/calendar[Calendar] module of the mobile app. The tab has
...
can link:ios/start-finish-functionality[start and finish an
activity] using the additional logic that may be applied to a started
activity.

If you have a link:ios/ct-mobile-workflow[CT Mobile Workflow] using
...
collected in
the link:ios/ct-mobile-control-panel-general-new#h3_612123135[Account
Geolocation
Field] or link:ios/ct-mobile-control-panel-general-new#h3__1092547330[Account
Full Address Field] according to selection and in
the link:ios/ct-mobile-control-panel-activities-new#h4__1419137192[Geolocation
Field] field.
...
If
the link:ios/ct-mobile-control-panel-activities-new#h3__470962300[Capture
...
link:ios/calendar[Calendar] module of the mobile app.
