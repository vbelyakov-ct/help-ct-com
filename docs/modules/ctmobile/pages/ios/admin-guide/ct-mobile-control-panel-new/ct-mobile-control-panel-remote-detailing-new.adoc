...
* To create link:ios/test-clm-presentations[test CLM presentations],
...
. On the link:ios/clm-applicationstats[Application Stats] object,
create lookup fields to every [.object]#Activity#
object configured on the
link:ios/ct-mobile-control-panel-activities-new#h2_2014841429[Activities]
tab.
. In the link:ios/mobile-application-setup[Mobile Application Setup],
