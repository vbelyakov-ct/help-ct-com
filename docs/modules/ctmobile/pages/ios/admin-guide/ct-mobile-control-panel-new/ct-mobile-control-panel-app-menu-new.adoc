...
Settings# object with the link:ctm-settings-menu[Menu] record
type.
...
link:ct-mobile-control-panel-app-menu-new#h3__259736469[Module
menu].
...
Refer to link:home-screen[Home screen] for more details.

[[h3_1468985423]]
==== Offline Objects

* link:grouping-records[Group records] by the criterion and
ascending or descending order of records.
* Define fields available for filtering in
link:list-views#h2__380480215[mobile list view].



Refer to link:managing-offline-objects[Managing Offline
...
Refer to link:links-list[Links] for more details.

[[h3_1292798904]]
==== Calendar

Configure the link:calendar[Calendar] options:

* *Activity Duration (min)*: specify the default duration in minutes for
scheduled activities.
* *Default View*: select link:using-calendar#h2__1759778354[the
...
Refer to link:ct-mobile-control-panel-activities-new[CT Mobile
...
Define the way how files uploaded to the link:libraries[Libraries]
...
link:ct-mobile-os-comparison[device platform].
