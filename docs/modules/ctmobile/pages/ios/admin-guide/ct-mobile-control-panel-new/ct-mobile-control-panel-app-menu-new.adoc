...
link:ios/ct-mobile-control-panel-app-menu-new#h3__259736469[Module
menu].
...
Refer to link:ios/home-screen[Home screen] for more details.

[[h3_1468985423]]
==== Offline Objects

* link:ios/grouping-records[Group records] by the criterion and
ascending or descending order of records.
* Define fields available for filtering in
link:ios/list-views#h2__380480215[mobile list view].



Refer to link:ios/managing-offline-objects[Managing Offline
...
Refer to link:ios/links-list[Links] for more details.

[[h3_1292798904]]
==== Calendar

Configure the link:ios/calendar[Calendar] options:

* *Activity Duration (min)*: specify the default duration in minutes for
scheduled activities.
* *Default View*: select link:ios/using-calendar#h2__1759778354[the
...
Refer to link:ios/ct-mobile-control-panel-activities-new[CT Mobile
...
Define the way how files uploaded to the link:ios/libraries[Libraries]
...
link:ios/ct-mobile-os-comparison[device platform].
