...
in the xref:ctm-settings[CTM Settings] with the _Offline Object_
record type.
...
xref:timeline-view[timeline view]. If enabled, select a field
...
If the record type has a xref:mobile-layouts[mobile layout],
