...
in the link:ctm-settings[CTM Settings] with the _Offline Object_
record type.
...
link:ct-mobile-control-panel-app-menu-new[App Menu]. #
...
link:timeline-view[timeline view]. If enabled, select a field
...
If the record type has a link:mobile-layouts[mobile layout],
