...
link:ios/ct-mobile-control-panel-general-new[CT Mobile Control Panel
2.0: General].
...
the link:ios/ct-mobile-control-panel-tools-new#h2_2011978[Cloud
...
[NOTE] ==== Please remove
the link:ios/ability-to-specify-metadata-components-or-the-number-of-entities-in-one-request[archive
