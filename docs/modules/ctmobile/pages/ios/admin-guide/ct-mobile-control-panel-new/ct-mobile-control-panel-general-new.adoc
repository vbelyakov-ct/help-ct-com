...
Settings that may be used for link:mobile-layouts-maps[the Maps
...
link:ct-mobile-control-panel-general-new#h3__1092547330[Account
Full Address] field. ====
...
real-time via the link:geolocation-center[Geolocation Center] in
Salesforce.
