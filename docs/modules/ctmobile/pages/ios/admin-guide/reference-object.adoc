...
. Go to the link:ios/ct-mobile-control-panel-general#h3_494016929[CT
...
. Go to
the link:ios/ct-mobile-control-panel-general-new#h4__351797814[CT
...
The setup is complete. Launch link:ios/full-synchronization[full
...
link:ios/person-accounts[Person Accounts], affects the record display.
