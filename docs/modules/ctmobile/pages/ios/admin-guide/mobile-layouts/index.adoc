...
. Create link:ios/mobile-layouts#h2__959581907[an inactive mobile
record type].
. Create link:ios/mobile-layouts#h2__1436774974[a mobile layout].
. link:ios/mobile-layouts#h2_1961857618[Assign the mobile layout] to a
...
* link:ios/mobile-layouts-maps[Maps]
* link:ios/mobile-layouts-applications[Carousel of CLM Presentations]
* link:ios/mobile-layouts-dashboards[Dashboards]
* link:ios/mobile-layouts-qr-code[QR code]
