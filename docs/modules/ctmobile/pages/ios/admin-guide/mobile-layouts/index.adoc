...
. Create link:mobile-layouts#h2__959581907[an inactive mobile
record type].
. Create link:mobile-layouts#h2__1436774974[a mobile layout].
. link:mobile-layouts#h2_1961857618[Assign the mobile layout] to a
...
* link:mobile-layouts-maps[Maps]
* link:mobile-layouts-applications[Carousel of CLM Presentations]
* link:mobile-layouts-dashboards[Dashboards]
* link:mobile-layouts-qr-code[QR code]
