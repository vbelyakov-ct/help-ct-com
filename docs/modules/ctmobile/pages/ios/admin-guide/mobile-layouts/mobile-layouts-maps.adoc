...
the link:application-settings#h2__1872639157[map type in the CT
Mobile app settings], you need Google Maps API Key.

To specify the Google Maps API key:

. Generate link:google-maps-api-key[the Google Maps API key].
. Go to the link:ct-mobile-control-panel-general#h3_604215198[CT
...
Bing Maps API key].
. Go to link:ct-mobile-control-panel-general#h3__1990058335[CT
Mobile Control Panel:
...
. Generate link:google-maps-api-key[the Google Maps API key].
. Go to link:ct-mobile-control-panel-general#h3_375370096[CT Mobile
Control Panel:
General]/link:ct-mobile-control-panel-general-new#h3_375370096[CT
...
Panel: General]/link:ct-mobile-control-panel-general-new[CT Mobile
...
To add the[.object]#Account# to the link:app-menu[app
menu]:
...
Use the link:actions#h2__1355154294[Determine Location] button to
