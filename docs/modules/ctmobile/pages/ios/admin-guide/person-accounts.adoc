...
link:ct-mobile-control-panel-general#h3_471160840[CT Mobile Control
Panel:
General]/link:ct-mobile-control-panel-general-new#h3_471160840[CT
...
Panel: App Menu]/link:ct-mobile-control-panel-app-menu-new[CT
...
* Configure and assign link:mini-layouts[a mini-layout] for the
...
link:calendar[Calendar] module, the
link:applications[Applications] module, and the CT Mobile app in
...
For activity management, correct operation of the
link:calendar[Calendar] module and the CT Mobile app in general,
