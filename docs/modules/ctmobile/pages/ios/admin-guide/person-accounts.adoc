...
link:ios/ct-mobile-control-panel-general#h3_471160840[CT Mobile Control
Panel:
General]/link:ios/ct-mobile-control-panel-general-new#h3_471160840[CT
...
Panel: App Menu]/link:ios/ct-mobile-control-panel-app-menu-new[CT
...
* Configure and assign link:ios/mini-layouts[a mini-layout] for the
...
link:ios/calendar[Calendar] module, the
link:ios/applications[Applications] module, and the CT Mobile app in
...
For activity management, correct operation of the
link:ios/calendar[Calendar] module and the CT Mobile app in general,
