...
* *iOS apps*. Accept requests from the iOS applications with xref:ios/admin-guide/google-maps-api-key/mobile-application-bundle-id.adoc[the bundle identifier] that is supplied.
+
