...
For building link:routes[routes] and displaying
link:nearby-accounts[nearby accounts] in the CT Mobile app, specify
...
link:mobile-application-bundle-id[the bundle identifier] that is
supplied.
