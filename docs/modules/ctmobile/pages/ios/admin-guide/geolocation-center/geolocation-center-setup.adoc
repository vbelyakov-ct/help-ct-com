...
. Make sure link:remote-site-settings[the required remote site
settings] are specified and active.
. link:google-maps-api-key[Get a Google Maps API Key(s)] and enable
the following APIs:
...
link:ct-mobile-control-panel-general#h2_670774632[CT Mobile Control
Panel: General]:
...
link:using-geolocation-center#h2_1758655018[account marks] on the
map in Geolocation Center.
** If at least one of these fields
is blank, link:using-geolocation-center#h2_1475553155[activities] will
...
link:using-geolocation-center#h2_1475553155[activity marks] on the
map in Geolocation Center.
...
link:ct-mobile-control-panel-general-new#h2_670774632[CT Mobile
...
* ​Specify *Google Maps Javascript API Key*.
* Click *Save*.
..  Go to the link:ct-mobile-control-panel-activities-new[CT Mobile
...
|===
. link:application-permission-settings[Assign permission] to read,
create, and edit the following fields of the link:sync-log[Sync
Log] object to users.
*[.apiobject]#clm__Date__c#
*[.apiobject]#clm__Description__c#
*[.apiobject]#clm__GeoTiming__c#
*[.apiobject]#clm__GeoTracing__c#.
. link:push-identifier[Obtain the push identifier] and enable push
notifications.
