...
Back to
link:ios/offline-supported-operators-and-functions-in-field-with-the-formula-type#ListOfOperators[the
list of operators and functions].
...
Back to
link:ios/offline-supported-operators-and-functions-in-field-with-the-formula-type[the
list of operators and functions].
...
|$CustomMetadata |Yes | |Records of link:ios/custom-settings[custom
metadata types].
...
|$Setup |Yes |Yes |Records of link:ios/custom-settings[custom
settings].
