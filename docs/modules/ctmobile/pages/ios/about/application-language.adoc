...
link:application-settings[Application Settings Screen], and
link:mobile-application-modules[modules]
* UI elements
* buttons
* system pop-ups, such as
link:application-prompts-for-requesting-permissions[app prompts].
...
. Launch link:full-synchronization[full synchronization].

The CT Mobile app is displayed in the selected language.

* To rename modules and items in the left menu, go to
link:renaming-menu-items-and-modules[Menu Items and Modules
Renaming].
...
link:fast-synchronization[mixed synchronization].
