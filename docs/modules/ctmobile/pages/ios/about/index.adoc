...
* In the link:ct-mobile-news[News] section, we share with you the
latest CT Mobile updates, release notes, and Salesforce updates that
affect our CT Mobile solution.
* link:getting-started[Getting Started] is a peek into the CT
...
app.
* link:quick-reference-guides[Administrator Guide] is a complete CT
...
Mobile package.
* The link:mobile-application[Mobile Application] section describes
the settings and functionalities available in the CT Mobile app.
* The link:ct-presenter[CT Presenter] section is intended to
...
link:ct-mobile-ios-release-notes#h2_211762337[2.9].
...
* link:knowledge-base[]link:quick-reference-guides[Administrator
