...
* In the link:ios/ct-mobile-news[News] section, we share with you the
latest CT Mobile updates, release notes, and Salesforce updates that
affect our CT Mobile solution.
* link:ios/getting-started[Getting Started] is a peek into the CT
...
app.
* link:ios/quick-reference-guides[Administrator Guide] is a complete CT
...
Mobile package.
* The link:ios/mobile-application[Mobile Application] section describes
the settings and functionalities available in the CT Mobile app.
* The link:ios/ct-presenter[CT Presenter] section is intended to
...
link:ios/ct-mobile-ios-release-notes#h2_211762337[2.9].
...
* link:ios/knowledge-base[]link:ios/quick-reference-guides[Administrator
