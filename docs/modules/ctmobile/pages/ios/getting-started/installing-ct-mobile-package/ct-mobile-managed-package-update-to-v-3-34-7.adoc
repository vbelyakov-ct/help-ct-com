...
link:ctm-settings[the CTM Settings object] is used to store several
settings defined in the link:ct-mobile-control-panel[CT Mobile
Control Panel]. The settings of the
link:menu-settings-and-offline-objects[menu],
...
link:application-permission-settings#h3_2115044027[the
