...
link:ios/ctm-settings[the CTM Settings object] is used to store several
settings defined in the link:ios/ct-mobile-control-panel[CT Mobile
Control Panel]. The settings of the
link:ios/menu-settings-and-offline-objects[menu],
...
link:ios/application-permission-settings#h3_2115044027[the
