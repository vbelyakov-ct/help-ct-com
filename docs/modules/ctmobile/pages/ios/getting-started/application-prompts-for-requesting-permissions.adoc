...
xref:ios/mobile-application/application-settings/event-notifications.adoc[as an alert of the upcoming visit]. Also,
this permission is required to fill out the xref:ios/ct-presenter/about-ct-presenter/clm-scheme/clm-user/index.adoc[Device
