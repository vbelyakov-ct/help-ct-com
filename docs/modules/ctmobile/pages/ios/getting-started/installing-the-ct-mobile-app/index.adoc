...
link:ios/technical-requirements-for-devices-and-network#h3__118091408[read
the requirements].
...
link:ios/installing-ct-mobile-package[to your Org].
. *Allow* access to requested data.

image:allow_access_en.png[]
. Click *Next* in
link:ios/application-prompts-for-requesting-permissions[the additional
...
. Perform link:ios/full-synchronization[a full synchronization].
...
CT Mobile opens. link:ios/logging-in[Logging in] to start.
...
After the installation, link:ios/logging-in[log in to the CT Mobile
app].
