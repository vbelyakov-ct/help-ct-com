...
To use xref:home-screen#h3__1361691321[the mobile logo], a mobile
...
xref:ct-mobile-control-panel[CT Mobile Control Panel] tabs to
...
xref:ct-mobile-replication[CT Mobile Replication] to hide these
