...
To use xref:ios/mobile-application/ui/home-screen/index.adoc#h3_1361691321[the mobile logo], a mobile
...
xref:ios/admin-guide/ct-mobile-control-panel/index.adoc[CT Mobile Control Panel] tabs to
...
xref:ios/mobile-application/synchronization/sync-recovery.adoc[Sync Recovery] to process errors or
xref:ios/admin-guide/ct-mobile-control-panel/custom-settings/ct-mobile-replication.adoc[CT Mobile Replication] to hide these
