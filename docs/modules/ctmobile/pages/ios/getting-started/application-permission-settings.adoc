...
To use link:home-screen#h3__1361691321[the mobile logo], a mobile
...
link:ct-mobile-control-panel[CT Mobile Control Panel] tabs to
...
link:sync-recovery[Sync Recovery] to process errors or
link:ct-mobile-replication[CT Mobile Replication] to hide these
