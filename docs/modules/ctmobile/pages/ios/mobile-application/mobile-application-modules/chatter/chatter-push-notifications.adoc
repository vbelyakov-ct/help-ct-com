...
link:mobile-layouts-chatter-feed[Chatter feed] is a widget to
...
. In link:mobile-application-setup[Mobile Application Setup], set
the value for the link:push-identifier[PUSH Identifier] field.

For the CT Mobile app installed from the App Store, the push identifier
is[.apiobject]#ctmobile#.
. link:application-prompts-for-requesting-permissions[Allow
