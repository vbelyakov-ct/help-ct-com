...
link:ios/mobile-layouts-chatter-feed[Chatter feed] is a widget to
...
. In link:ios/mobile-application-setup[Mobile Application Setup], set
the value for the link:ios/push-identifier[PUSH Identifier] field.

For the CT Mobile app installed from the App Store, the push identifier
is[.apiobject]#ctmobile#.
. link:ios/application-prompts-for-requesting-permissions[Allow
