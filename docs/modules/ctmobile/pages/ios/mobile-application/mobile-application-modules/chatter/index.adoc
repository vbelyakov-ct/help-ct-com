...
Chatter to the link:mobile-layouts-chatter-feed[mobile layout].
ifdef::ios[] The *Chatter* module displays users' messages. Users
can create posts and comments, add attachments, and receive
link:chatter-push-notifications[push notifications]. You can add
Chatter to the link:mobile-layouts-chatter-feed[mobile layout].
...
To add the *Chatter* module to the link:app-menu[app menu]:
