...
link:calendar[Add the Calendar module] to the CT Mobile main menu,
configure the calendar in link:ct-mobile-control-panel-calendar[CT
Mobile Control Panel:
Calendar]/link:ct-mobile-control-panel-activities-new[CT Mobile
Control Panel 2.0: Activities], and optionally set up
link:custom-color-settings[custom color settings] to display
...
link:custom-color-settings[CT Mobile Control Panel: Color
Settings]/link:ct-mobile-control-panel-colors-new[CT Mobile Control
Panel 2.0: Colors].
...
link:mini-layouts[a mini-layout]:
...
link:application-theme[the application theme] will be used to
...
* If link:start-finish-functionality[the Start/Finish
...
link:compact-layout[the compact layout]:
...
be edited (including adding a photo from the link:actions[Actions]
...
link:ct-mobile-control-panel-calendar#h3_1391348303[CT Mobile
Control Panel: Calendar] or
link:ct-mobile-control-panel-activities-new#h4_587549689[CT Mobile
...
link:ct-mobile-control-panel-activities-new#h4_1834463667[Fields to
...
the link:ct-mobile-control-panel-offline-objects[CT Mobile Control
Panel: Offline
Objects]/link:ct-mobile-control-panel-offline-objects-new[CT Mobile
