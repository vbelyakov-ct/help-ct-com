...
link:custom-color-settings[custom color settings] to different
activity types.
...
link:using-calendar[Using Calendar] article.
...
If configured (in link:ct-mobile-control-panel-mini-layouts[CT
Mobile Control Panel: Mini
Layouts]/link:ct-mobile-control-panel-mini-layouts-new[CT Mobile
...
field in link:compact-layout[the compact layout], and the subtitle
is the value of the second field in the compact layout.

ifdef::ios[]

If necessary, link:set-up-holidays[set up Salesforce Holidays] to
...
To add the *Calendar* module to the link:app-menu[app menu]:
...
. Select the required profile in the *Profile* picklist. To apply
settings to all the profiles, select *General Settings*.
. link:ct-mobile-control-panel-activities-new#h2_2014841429[Specify
Activity objects].
. Go to link:ct-mobile-control-panel-app-menu-new[CT Mobile Control
Panel 2.0: App Menu] tab.
...
hour range (refer to
link:ct-mobile-control-panel-calendar#h3_256846269[CT Mobile
Control Panel:
Calendar]/link:ct-mobile-control-panel-app-menu-new#h2_1511584348[CT
