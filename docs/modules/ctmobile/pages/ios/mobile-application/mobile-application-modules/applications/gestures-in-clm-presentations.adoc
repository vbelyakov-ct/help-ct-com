...
link:applications[Application] module, on
link:mobile-layouts-applications[the mobile layout], and
...
link:clm-application[CLM presentation] record.
...
Display link:clm-presentation-controls[the action menu] with
available options.
