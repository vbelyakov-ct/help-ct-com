...
link:ios/applications[Application] module, on
link:ios/mobile-layouts-applications[the mobile layout], and
...
link:ios/clm-application[CLM presentation] record.
...
Display link:ios/clm-presentation-controls[the action menu] with
available options.
