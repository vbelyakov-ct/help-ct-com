...
.. link:ios/setting-up-task-definitions-and-action-plan-templates[Setting
...
.. link:ios/activating-cg-cloud-in-the-ct-mobile-app[Activating CG
Cloud in the CT Mobile app]
.. link:ios/managing-visits-to-retail-stores[Managing Visits to Retail
Stores]
