...
. link:https://help.salesforce.com/s/articleView?id=sf.retail_task_admin_create_ataskd.htm&type=5[Define] link:https://help.salesforce.com/s/articleView?id=sf.retail_task_admin_create_ataskd.htm&type=5[Assessment Task Definitions]#, which are certain activities related to the different aspects of retail execution.
