...
link:activating-cg-cloud-in-salesforce[After activating CG Cloud]
...
list.
. link:managing-offline-objects#h2__1747811907[Set up user
permissions].
. Click *Save*.
...
link:custom-related-lists[if configured].
...
refer to link:managing-visits-to-retail-stores[Managing Visits to
Retail Stores].
...
parameters, refer to link:ctm-settings-cg-cloud-record-type[CTM
