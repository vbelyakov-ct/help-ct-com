...
* To work with CG Cloud in the CT Mobile app, configure the standard _Visit_ record screen with the help of xref:ctlayouts:admin-guide/creating-a-layout-settings-record.adoc[the CT Layouts solution].
