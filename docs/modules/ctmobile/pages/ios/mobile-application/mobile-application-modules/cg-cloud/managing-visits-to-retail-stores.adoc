...
use xref:mini-layouts[mini-layouts] to create new records;

ifdef::ios[]

add xref:custom-related-lists[custom related lists] to track
related records;

using xref:home-screen#h3__1761919763[the Reports and Dashboards
...
using xref:home-screen#h3_1292798904[the Calendar widget], track
...
xref:managing-visits-to-retail-stores#h2__1374718576[Follow the
...
the *Detailing* tab
xref:managing-visits-to-retail-stores#h2__1374718576[to work with
CG Cloud tasks].
...
the xref:ct-mobile-control-panel-general#h3_612123135[CT Mobile
Control Panel:
...
xref:ct-mobile-control-panel-general#h3__1092547330[CT Mobile
Control Panel:
General]/xref:ct-mobile-control-panel-general-new#h3__1092547330[CT
