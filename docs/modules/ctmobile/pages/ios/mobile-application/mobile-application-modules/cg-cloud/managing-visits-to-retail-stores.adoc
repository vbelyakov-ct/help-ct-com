...
To work with CG cloud tasks, administrators should prepare the _Visit_ record screen in the CT Mobile app by splitting the _Visit_ record layout into several tabs using CT Layouts. Administrators can use xref:ctlayouts:ref-guide/ct-layouts-templates.adoc[the preconfigured template] or create a new one based on it. For more information about CT Layouts, refer to xref:ctlayouts:/about-ct-layouts.adoc[CT Layouts Solution].
...
* add a button with the xref:ctlayouts:admin-guide/ct-layouts-editor-customize-tabs.adoc#h3_349797985[Create Record] action type to create an _Action Plan_ record and add a button with the xref:ctlayouts:ref-guide/json-specifications-and-examples/context-key-reference.adoc[$Class.generateCGCloudTasks] context to generate all required records to the first tab of the _Visit_ record.
...
To perform an assessment task with the *In-Store Survey* type, for example, to capture feedback from buyers, the xref:ctlayouts:admin-guide/ct-layouts-editor-add-sections-and-fields.adoc#h3_1996080511[Record List] section with the _Survey Subject_ records should be added to the tab of the _Visit_ record.
...
To perform an assessment task with the *Inventory Check* type, for example, to count inventories of a product category, the xref:ctlayouts:admin-guide/ct-layouts-editor-add-sections-and-fields.adoc#h3_1996080511[Record List] section with the _Retail Visit KPI_ records and the specific *Target Value* and *Actual Value* fields should be added to the tab of the _Visit_ record.
...
To perform an assessment task with the _Other_ type, for example, to perform asset checks for refrigerator displays and shelves, the xref:ctlayouts:admin-guide/ct-layouts-editor-add-sections-and-fields.adoc#h3_1996080511[Record List] section with the _Retail Visit KPI_ records and the specific *Target Value* and *Actual Value* fields should be added to the tab of the _Visit_ record.
...
. The xref:ctlayouts:admin-guide/ct-layouts-editor-add-sections-and-fields.adoc#h3_1996080511[Record List] section with the image:ct-vision_layouts.png[25,25] button should be added to the tab of the _Visit_ record.
...
. The xref:ctlayouts:admin-guide/ct-layouts-editor-add-sections-and-fields.adoc#h3_1996080511[Record List] section with the _Order_ records should be added to the tab of the _Visit_ record.
...
To perform an assessment task with the _Promotion Check_ type, for example, to track customer reaction to new promotional offers, the xref:ctlayouts:admin-guide/ct-layouts-editor-add-sections-and-fields.adoc#h3_1996080511[Record List] section with the _Retail Visit KPI_ records and the specific *Target Value* and *Actual Value* fields should be added to the tab of the _Visit_ record.
...
To perform an assessment task with the _Task_ type, the xref:ctlayouts:admin-guide/ct-layouts-editor-add-sections-and-fields.adoc#h3_1996080511[Record List] section with the _Task_ records and their *Status* field should be added to the tab of the _Visit_ record.
