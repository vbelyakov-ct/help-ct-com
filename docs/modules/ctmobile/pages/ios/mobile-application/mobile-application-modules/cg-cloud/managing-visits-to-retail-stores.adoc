...
use link:ios/mini-layouts[mini-layouts] to create new records;

ifdef::ios[]

add link:ios/custom-related-lists[custom related lists] to track
related records;

using link:ios/home-screen#h3__1761919763[the Reports and Dashboards
...
using link:ios/home-screen#h3_1292798904[the Calendar widget], track
...
link:ios/managing-visits-to-retail-stores#h2__1374718576[Follow the
...
the *Detailing* tab
link:ios/managing-visits-to-retail-stores#h2__1374718576[to work with
CG Cloud tasks].
...
With the help of the link:ios/calendar[Calendar] module, a rep can
...
the link:ios/ct-mobile-control-panel-general#h3_612123135[CT Mobile
Control Panel:
General]/link:ios/ct-mobile-control-panel-general-new#h3_612123135[CT
Mobile Control Panel 2.0: General] tab. Alternatively, add the *Account
Full Address Field* (refer to
link:ios/ct-mobile-control-panel-general#h3__1092547330[CT Mobile
Control Panel:
General]/link:ios/ct-mobile-control-panel-general-new#h3__1092547330[CT
...
link:ios/ct-mobile-control-panel-color-settings[CT Mobile Control
Panel: Color Settings]/link:ios/ct-mobile-control-panel-colors-new[CT
...
In the link:ios/routes[Routes] module, mobile users can work with
