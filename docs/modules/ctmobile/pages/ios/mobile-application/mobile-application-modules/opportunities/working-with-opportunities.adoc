...
* link:ios/custom-related-lists#h2__993780705[Create the custom related
...
* link:ios/mini-layouts[Customize mini layouts] with desired fields to
create[.object]#Opportunity Products# more conveniently.
* Add the *Currency ISO Code* field on the *Opportunity* page layout
when using
link:ios/working-with-opportunities#h3__1187857038[multi-currencies].



To create an *Opportunity* record, a user should have permission
link:ios/managing-offline-objects#h2_1534686659[to create records].
...
In the case of link:ios/manage-currencies[multi-currency support], all
...
Business purposes
link:ios/adding-opportunities-to-the-ct-mobile-app#h3__404689442[divide
...
link:ios/managing-offline-objects#h2_1534686659[if enabled].
