...
* xref:ios/admin-guide/mini-layouts.adoc[Customize mini layouts] with desired fields to
...
xref:ios/admin-guide/managing-offline-objects/index.adoc#h2_1534686659[to create records].
...
xref:ios/admin-guide/managing-offline-objects/index.adoc#h2_1534686659[if enabled].
