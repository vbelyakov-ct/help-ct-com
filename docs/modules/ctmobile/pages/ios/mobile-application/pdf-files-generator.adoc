...
user link:ios/clm-presentation-controls#h2_1347300086[sends a PDF
file] from a CLM presentation or calls
the link:ios/ctm-generatepdf[ctm.generatePDF] method.
...
link:ios/attachments-and-files[attachment] to the CLM presentation.
