...
|===
|In CTM Settings a|
. Go to link:ctm-settings[CTM Settings].
. Select an existing link:ctm-settings-offline-objects[Offline
...
through link:ctm-settings-offline-objects[date-based
...
record and perform link:synchronization-launch#h2__966867633[quick
