...
* xref:ios/admin-guide/managing-offline-objects/index.adoc[Record screens], e.g., records of
...
xref:ios/mobile-application/application-settings/log-out.adoc[logging out].  ====
