...
link:ios/managing-offline-objects[Managing Offline Objects in CT Mobile
Control Panel] or
...
* When link:ios/ct-mobile-control-panel-general#h2_670774632[a
geolocation type field on the Account object] is specified (refer to
link:ios/ct-mobile-control-panel-general#h3_612123135[CT Mobile Control
Panel: General → Account Geolocation Field] or
link:ios/ct-mobile-control-panel-general-new#h3_612123135[CT Mobile
...
refer to link:ios/attaching-files-in-the-files-section[Attachments in
the Files Section].
...
Add a post in the link:ios/mobile-layouts-chatter-feed[Chatter feed].
...
link:ios/mobile-layouts-chatter-feed[Chatter feed].
...
link:ios/ctm-settings-offline-objects[Offline Objects → Export Allowed]
or link:ios/ct-mobile-control-panel-offline-objects-new#h3_290156637[CT
Mobile Control Panel 2.0: Offline Objects → Export to CSV]).
* Default fields should be specified in the** Default Columns** field of
the link:ios/ctm-settings-offline-objects[Offline Object] or in
link:ios/ct-mobile-control-panel-offline-objects-new#h4__912917703[CT
Mobile Control Panel 2.0: Offline Objects → Export Columns Selection].
* Custom fields can be selected for export if
the link:ios/ctm-settings-offline-objects[Select Export
Columns] checkbox is set to _true_ or
link:ios/ct-mobile-control-panel-offline-objects-new#h4__912917703[Export
...
object, switch to link:ios/list-views#h2_1248088428[detailed list
view]. ====
