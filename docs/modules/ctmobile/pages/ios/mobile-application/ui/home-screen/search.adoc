...
link:home-screen[Home screen] and allows you to search records of
objects added to the link:app-menu[main menu].
...
subtitle on the link:compact-layout[compact layout]. The found
