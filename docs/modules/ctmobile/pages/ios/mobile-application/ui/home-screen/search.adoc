...
link:ios/home-screen[Home screen] and allows you to search records of
objects added to the link:ios/app-menu[main menu].
...
subtitle on the link:ios/compact-layout[compact layout]. The found
