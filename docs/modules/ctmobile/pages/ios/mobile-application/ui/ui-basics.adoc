...
current user. The set of items in the list link:ios/app-menu[can be
...
link:ios/home-screen[Home] or link:ios/application-settings[Settings])
...
* link:ios/search[The search results] are grouped by objects.
* Tap
image:58835664.png[]
...
link:ios/grouping-records[customize the grouping] of the records.
* Records can be marked with link:ios/custom-color-settings[custom
colors].
...
link:ios/application-permission-settings[permission to create records].
* If there is link:ios/related-list-filters[a setting in CT Mobile],
tap *Load more records* to open the online records loading screen.
* Tap
image:58835652.png[]
to open the link:ios/ipad#h2__1243490689[detailed list view] with
...
link:ios/application-permission-settings[permission to delete records].
...
separated link:ios/mobile-layouts[into tabs and sections].
...
* Tap
image:58835655.png[]
to open the link:ios/actions[Actions] modal window.
...
* If the link:ios/reference-fields#h2__1514470758[Online One Record
