...
current user. The set of items in the list link:app-menu[can be
...
link:home-screen[Home] or link:application-settings[Settings])
...
* link:search[The search results] are grouped by objects.
* Tap
image:58835664.png[]
...
link:grouping-records[customize the grouping] of the records.
* Records can be marked with link:custom-color-settings[custom
colors].
...
link:application-permission-settings[permission to create records].
* If there is link:related-list-filters[a setting in CT Mobile],
tap *Load more records* to open the online records loading screen.
* Tap
image:58835652.png[]
to open the link:ipad#h2__1243490689[detailed list view] with
...
link:application-permission-settings[permission to delete records].
...
separated link:mobile-layouts[into tabs and sections].
...
* Tap
image:58835655.png[]
to open the link:actions[Actions] modal window.
...
* If the link:reference-fields#h2__1514470758[Online One Record
