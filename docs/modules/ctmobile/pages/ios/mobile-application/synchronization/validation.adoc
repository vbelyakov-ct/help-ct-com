...
synchronization as part of the link:ios/metadata-archive[metadata
...
link:ios/custom-related-lists[custom related list]).
...
link:ios/start-finish-functionality[Start/Finish functionality] and
link:ios/ct-mobile-control-panel-calendar#h3__1036133099[Lock/Unlock
Record]
(link:ios/ct-mobile-control-panel-activities-new#h4_1219382202[Lock
...
link:ios/errors-screen#h2__479754125[the Errors screen].
...
* If link:ios/errors-screen[an error occurs] during validation, the
...
separate section on link:ios/errors-screen#h2__479754125[the Errors
screen].
