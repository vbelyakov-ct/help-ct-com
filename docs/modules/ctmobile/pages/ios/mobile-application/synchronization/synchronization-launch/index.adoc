...
xref:ios/ct-presenter/js-bridge-api/methods-for-interaction-with-crm-data/ctm-sync.adoc[sync()] method of JS Bridge is requested.
...
components],
xref:ios/ct-presenter/about-ct-presenter/clm-scheme/clm-user/user-permissions.adoc-required-to-synchronize-objects-to-offline-work-with-functionalities[required
