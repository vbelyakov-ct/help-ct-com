...
the xref:ct-mobile-control-panel[CT Mobile Control
...
For more information, read xref:full-synchronization[the Full
...
The sync process may include xref:ct-mobile-replication[CT Mobile
Replication];
...
For more information, read xref:fast-synchronization[the Fast
Synchronization article].
...
* download xref:metadata-archive[metadata] changes in ZIP
...
a change on xref:ct-mobile-control-panel[CT Mobile Control
Panel]/xref:ct-mobile-control-panel-new[CT Mobile Control Panel
2.0].
...
* xref:metadata-checker#h2__682427009[Manually create the metadata
archive].
* xref:metadata-checker#h2__1244689107[Enable Metadata Checker] to
refresh metadata.
...
case, xref:ct-mobile-replication[create a CT Mobile Replication
...
on xref:home-screen#h2__396225247[the status indicator] at the
...
For more information, read xref:sync-logs[the Sync Logs article].
...
xref:metadata-archive#h2_1854953360[here]. Also, the metadata
...
We recommend enabling xref:metadata-checker[a metadata checker] and
xref:metadata-checker#h3_1645525423[setting a schedule] for a
...
recommend enabling xref:metadata-checker[a metadata checker]. Also,
it is possible xref:metadata-checker#h3_1645525423[to set a
schedule] for a metadata checker or
xref:metadata-checker#h2__1657467916[manually create/update] the
metadata archive.
...
created or updated. We recommend enabling xref:metadata-checker[a
metadata checker]. Also, it is possible
xref:metadata-checker#h3_1645525423[to set a schedule] for a
metadata checker or xref:metadata-checker#h2__1657467916[manually
...
xref:metadata-archive[a metadata archive]. We recommend enabling
xref:metadata-checker[a metadata checker]. Also, it is possible
xref:metadata-checker#h3_1645525423[to set a schedule] for a
metadata checker or xref:metadata-checker#h2__1657467916[manually
create/update] the metadata archive.
...
xref:technical-requirements-for-devices-and-network#h2_1498128754[the
...
provided on the xref:ct-mobile-control-panel[CT Mobile Control
Panel]/xref:ct-mobile-control-panel-new[CT Mobile Control Panel
...
* Enable the xref:application-settings#h3_1768799377[Background
...
Enable logs on the
xref:ct-mobile-control-panel-general#h3__272409891[CT Mobile
Control Panel:
General]/xref:ct-mobile-control-panel-general-new#h2__1687169837[CT
