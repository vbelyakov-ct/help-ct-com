...
[TIP] ==== Launch link:ios/full-synchronization[the full
...
link:ios/ct-mobile-control-panel-user-interface-new#h3_1354766135[CT
...
!link:ios/applications[Applications] !Application
...
!link:ios/cg-cloud[CG Cloud]
!link:ios/activating-cg-cloud-in-the-ct-mobile-app#h2_242799573[The
...
!link:ios/home-screen#h3__1761919763[Dashboards] (online) !Dashboard
![.apiobject]#Dashboard# !Read !

! !Report ![.apiobject]#Report# !Read !

! !Report Type ![.apiobject]#ReportType# !Read ! !link:ios/lead-convert[Lead] !Lead Status ![.apiobject]#LeadStatus# !Read !If the list of offline objects
contains the _Lead_ object.

!link:ios/managing-offline-objects[Offline Objects] !The list of
offline objects !— !Read; Edit; Delete (depend on the object) !It is
based on data from
link:ios/related-list-filters[clm__RelatedListFillters__c],
link:ios/menu-settings-and-offline-objects[clm__TopLvlObjects__c]
(will be deprecated in future), or link:ios/ctm-settings[CTM Settings].

! !Task Status ![.apiobject]#TaskStatus# !Read; Edit !If the
list of offline objects contains the _Task_ object.

!link:ios/opportunities[Opportunity] !Opportunity
...
offline objects !— !Read; Edit; Delete (depend on the object) !It is
based on data from
link:ios/related-list-filters[clm__RelatedListFillters__c] and
link:ios/menu-settings-and-offline-objects[clm__TopLvlObjects__c].
