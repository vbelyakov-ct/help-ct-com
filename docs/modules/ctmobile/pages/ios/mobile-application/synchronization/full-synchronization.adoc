...
corner of the link:home-screen[Home Screen] and select *Full
...
. link:metadata-archive[Metadata components] are downloaded.
...
to link:ct-mobile-control-panel-tools#h3_2011978[CT Mobile Control
...
but link:validation[validation rules] offline reports, and some
