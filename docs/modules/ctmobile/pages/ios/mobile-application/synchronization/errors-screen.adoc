...
Errors occur due to violation of link:ios/validation[the validation
rules] and
...
link:ios/attachments-and-files[an attachment] to the
link:ios/sync-log[Sync Log] record.

[TIP] ==== To use this option, the cloud token should be
valid (refer to link:ios/ct-mobile-control-panel-tools#h3_2011978[CT
...
* link:ios/sync-recovery[Sync Recovery]: to send records as usual or as
the JSON file for post-processing by the administrator.
* link:ios/ct-mobile-replication[CT Mobile Replication]: to download
