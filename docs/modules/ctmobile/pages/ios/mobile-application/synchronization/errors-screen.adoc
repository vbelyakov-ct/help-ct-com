...
Errors occur due to violation of link:validation[the validation
rules] and
...
link:attachments-and-files[an attachment] to the
link:sync-log[Sync Log] record.

[TIP] ==== To use this option, the cloud token should be
valid (refer to link:ct-mobile-control-panel-tools#h3_2011978[CT
...
* link:sync-recovery[Sync Recovery]: to send records as usual or as
the JSON file for post-processing by the administrator.
* link:ct-mobile-replication[CT Mobile Replication]: to download
