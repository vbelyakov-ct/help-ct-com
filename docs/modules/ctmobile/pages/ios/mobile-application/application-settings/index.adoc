...
device gallery. The new photos in xref:actions[the CT Mobile
...
* Order module application is added to the xref:app-menu[App menu].
* The
...
General]/xref:ct-mobile-control-panel-general-new#h3_643998525[CT
...
CT Mobile allows xref:logging-in[multiple user access]. Changing
...
xref:logging-in[To change the current user], select the *User*
