...
link:application-settings#h2__397515857[Change user] button to
...
* link:synchronization-launch[Full synchronization] malfunction.
...
The current user logged out, and link:logging-in[the login screen]
opens.
