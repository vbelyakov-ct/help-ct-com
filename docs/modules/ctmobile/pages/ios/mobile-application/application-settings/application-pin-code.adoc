...
passcode anytime you link:log-out[log out] of the mobile
application.
...
. Go to link:ct-mobile-control-panel-general#h3_643998525[CT Mobile
Control Panel: General].
. Set a flag next to *Passcode Enabled*.
. Click *Save*.
. Launch link:synchronization-launch[the full synchronization] on
the mobile device to apply the settings.

|In CT Mobile Control Panel 2.0 a|
. Go to link:ct-mobile-control-panel-general-new#h3_643998525[CT
...
set a passcode after link:logging-in[logging in] and allowing
