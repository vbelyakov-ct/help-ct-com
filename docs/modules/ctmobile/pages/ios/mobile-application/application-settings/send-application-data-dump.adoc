...
the link:sync-log[Sync Log] record. The size of the ZIP archive
...
To use this option,
link:ct-mobile-control-panel-tools#h3_2011978[the cloud token]
...
To use this option,
link:ct-mobile-control-panel-tools-new#h2_2011978[the cloud token]
should be valid. In the case the cloud token is not specified, the
password will be[.apiobject]#ctmobile#.
* *E-mail*
...
. Go to link:application-settings[Settings] from
