...
the xref:ios/mobile-application/synchronization/synchronization-launch/sync-log.adoc[Sync Log] record. The size of the ZIP archive
...
To use this option,
xref:ios/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_2011978[the cloud token]
...
To use this option,
xref:ios/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-tools-new.adoc#h2_2011978[the cloud token]
should be valid. In the case the cloud token is not specified, the
password will be[.apiobject]#ctmobile#.
* *E-mail*
...
. Go to xref:ios/mobile-application/application-settings/index.adoc[Settings] from
