...
* xref:ios/mobile-application/ui/home-screen/index.adoc[Home Screen], xref:ios/mobile-application/application-settings/index.adoc[Application Settings Screen], and xref:ios/mobile-application/mobile-application-modules/index.adoc[modules]
* UI elements
* buttons
* system pop-ups, such as xref:ios/getting-started/application-prompts-for-requesting-permissions.adoc[app prompts].
...
. On the Salesforce side, select the language on the _User_ record: click *View Profile* in the upper right corner *→ Settings → My Personal Information → Language & Time Zone →* specify the *Language* field.
. Tap the *Full Synchronization* button to launch xref:ios/mobile-application/synchronization/fast-synchronization.adoc[mixed synchronization].
