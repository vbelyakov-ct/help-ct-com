...
to generate invite links on the _Activity_ record for *Remote Detailing*
...
on the appropriate _Activity_ record. The custom scenario available for
...
the appropriate _Activity_ record:
