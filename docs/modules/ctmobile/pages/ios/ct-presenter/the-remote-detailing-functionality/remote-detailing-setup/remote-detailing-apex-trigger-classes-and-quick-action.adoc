...
link:ct-mobile-control-panel-calendar#h2_70500171[CT Mobile Control
Panel: Calendar]/link:ct-mobile-control-panel-activities-new[CT
...
On the CLM presentation record, link:clm-application[check the
