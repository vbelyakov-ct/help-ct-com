...
With the invitation link, participants of the xref:ios/ct-presenter/the-remote-detailing-functionality/index.adoc[Remote Detailing] meeting could enter the meeting via the CT Presenter app installed on their devices and, according to the permissions, perform actions, such as stream video and audio, like/dislike slides, or answer the questions on a slide.
