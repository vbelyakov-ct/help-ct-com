...
xref:ios/ct-presenter/the-remote-detailing-functionality/remote-detailing-ui-basics/remote-detailing-1-0-ui-for-participants.adoc[in the browser
window].
...
* According to xref:ios/admin-guide/ct-mobile-control-panel/custom-settings/clm-settings.adoc[Remote Detailing settings], video
...
xref:ios/ct-presenter/the-remote-detailing-functionality/remote-detailing-ui-basics/remote-detailing-1-0-ui-for-presenter.adoc[The presenter could
