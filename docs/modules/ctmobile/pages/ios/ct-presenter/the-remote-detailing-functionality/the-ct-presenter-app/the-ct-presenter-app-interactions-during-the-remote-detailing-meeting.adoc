...
link:ios/remote-detailing-1-0-ui-for-participants[in the browser
window].
...
icon in
link:ios/the-ct-presenter-app-interactions-during-the-remote-detailing-meeting#h2__111154998[the
sidebar].
...
* According to link:ios/clm-settings[Remote Detailing settings], video
...
link:ios/remote-detailing-1-0-ui-for-presenter[The presenter could
