...
To join link:remote-detailing-launch[the Remote Detailing meeting]
...
link:the-ct-presenter-app-interactions-during-the-remote-detailing-meeting[Interactions
