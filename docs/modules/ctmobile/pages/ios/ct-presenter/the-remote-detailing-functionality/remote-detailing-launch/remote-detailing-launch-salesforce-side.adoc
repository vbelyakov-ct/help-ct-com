...
link:ios/clm-application[Application] or
link:ios/clm-activity[Activity] record.
...
the link:ios/remote-detailing-apex-trigger-classes-and-quick-action#h2_249047963[Apex
...
on the link:ios/ct-mobile-control-panel-presenter#h3__1311451422[CT
Mobile Control Panel:
Presenter]/link:ios/ct-mobile-control-panel-remote-detailing-new#h4__1311451422[CT
...
. Click the
link:ios/remote-detailing-apex-trigger-classes-and-quick-action#h3__2024838382[Applications]
button.
...
field.#
. After a while,
link:ios/remote-detailing-launch-salesforce-side#h3_2144641458[the
specific field] will be populated with the invite link, for the *Remote
Detailing* or *Self Detailing* meeting, according to
link:ios/remote-detailing-setup[Remote Detailing Setup].
