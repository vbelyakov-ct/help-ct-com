...
A presenter can start a remote CLM presentation for participants by tapping the invitation link that is stored in the specified field on the xref:ios/ct-presenter/about-ct-presenter/clm-scheme/clm-activity.adoc[Activity] record screen in the CT Mobile app.

* The invitation link for *Remote Detailing* can be created for PC, tablets, and mobile phones.
...
* To join as a participant, tap the invitation link. In the CLM presentation window, tap the *Log out* button. On the *Welcome* screen, enter your username and an e-mail (optionally) and tap *Join* to enter the meeting.
