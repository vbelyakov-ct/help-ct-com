...
xref:ios/ct-presenter/about-ct-presenter/clm-scheme/clm-activity.adoc[Activity] record screen in the CT Mobile app.
...
the [.object]#Contact# of the _Activity_ record after generating
