...
specified. Go to the xref:ct-mobile-control-panel-calendar[CT
...
xref:remote-detailing-apex-trigger-classes-and-quick-action#h3__2024838382[Click
...
* xref:clm-application[CLM presentation] should be active and
...
xref:clm-application[Application] record to copy and insert the
