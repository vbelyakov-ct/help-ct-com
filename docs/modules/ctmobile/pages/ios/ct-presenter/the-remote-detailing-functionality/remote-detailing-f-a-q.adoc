...
Go back to link:ios/remote-detailing-f-a-q#GoBacktoMiniTOC[the F.A.Q.
list].
...
link:ios/remote-detailing-ui-basics[here].

[[h3_778333580]]
==== Salesforce Side

In Salesforce, click
link:ios/remote-detailing-launch-salesforce-side[the invite link or the
...
link:ios/remote-detailing-launch-the-ct-mobile-app[Tap the invite link]
...
If the link:ios/ct-mobile-control-panel-presenter#h3_341694305[Call
...
| a|
* The invite link: https://www.ctclm.com**/mobile**/ 456-7890-123.

|The invite link: https://rd.ctclm.com/*s*/137-9788-974.
|===
...
. Check
link:ios/remote-detailing-apex-trigger-classes-and-quick-action[Apex
Classes and Trigger are created]. It is necessary to specify the correct
API name of the[.object]#Activity# object.
. On link:ios/mobile-application-setup[the Mobile Application Setup
record] assigned for the current user's profile, the
[.object]#Activity# object or the *Start Date* field is not
specified. Go to the link:ios/ct-mobile-control-panel-calendar[CT
Mobile Control Panel:
Calendar]/link:ios/ct-mobile-control-panel-activities-new[CT Mobile
Control Panel 2.0: Activities] tab and set up *Activity* settings for
the current user's profile.
. link:ios/clm-activity[The current Activity record] has no assigned
CLM presentations and custom scenarios.
link:ios/remote-detailing-apex-trigger-classes-and-quick-action#h3__2024838382[Click
the Applications button] to specify the CLM presentations set.
. link:ios/clm-settings[The incorrect record of CLM Settings] for the
current user's profile. The Remote Detailing should be enabled in
link:ios/ct-mobile-control-panel-presenter[CT Mobile Control Panel:
Presenter]/link:ios/ct-mobile-control-panel-remote-detailing-new[CT
...
link:ios/remote-detailing-1-0-ui-for-participants[here].
...
link:ios/remote-detailing-f-a-q#h2_250361472[the bandwidth and
...
link:ios/remote-detailing-f-a-q#h3_1979411778[mobile browsers] due to
their limitations.
...
. Previously, check
link:ios/remote-detailing-f-a-q#SupportedBrowsers[the supported
browsers on devices].
...
The same link:ios/ct-presenter[CLM presentations] and custom scenarios
as for the *Application* module in the CT Mobile app can be used for
*Remote Detailing*.

* link:ios/clm-application[CLM presentation] should be active and
...
* Check link:ios/requirements-and-media-file-formats[requirements and
...
clicks cannot be tracked for link:ios/remote-detailing-statistics[the
statistics].
...
participants.
* Specify the
link:ios/ct-mobile-control-panel-presenter#h3_949497961[CRM Data
Streaming Enabled]/
link:ios/ct-mobile-control-panel-remote-detailing-new#h4_1433734342[CRM
...
link:ios/remote-detailing-apex-trigger-classes-and-quick-action[add and
use the Applications button on the Activity record in Lightning
Experience].
** For *Remote Detailing 2.0*, you can link:ios/changing-slides[switch
...
link:ios/clm-application[Application] record to copy and insert the
...
link:ios/publishing-clm-presentations#h3_1098755975[renew slides] for
...
familiar with link:ios/js-bridge-methods-availability[the list of the
