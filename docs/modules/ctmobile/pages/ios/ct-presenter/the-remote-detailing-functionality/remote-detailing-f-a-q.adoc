...
Go back to link:remote-detailing-f-a-q#GoBacktoMiniTOC[the F.A.Q.
list].
...
link:remote-detailing-ui-basics[here].

[[h3_778333580]]
==== Salesforce Side

In Salesforce, click
link:remote-detailing-launch-salesforce-side[the invite link or the
...
link:remote-detailing-launch-the-ct-mobile-app[Tap the invite link]
...
If the link:ct-mobile-control-panel-presenter#h3_341694305[Call
...
. Check
link:remote-detailing-apex-trigger-classes-and-quick-action[Apex
Classes and Trigger are created]. It is necessary to specify the correct
API name of the[.object]#Activity# object.
. On link:mobile-application-setup[the Mobile Application Setup
record] assigned for the current user's profile, the
[.object]#Activity# object or the *Start Date* field is not
specified. Go to the link:ct-mobile-control-panel-calendar[CT
Mobile Control Panel:
Calendar]/link:ct-mobile-control-panel-activities-new[CT Mobile
Control Panel 2.0: Activities] tab and set up *Activity* settings for
the current user's profile.
. link:clm-activity[The current Activity record] has no assigned
CLM presentations and custom scenarios.
link:remote-detailing-apex-trigger-classes-and-quick-action#h3__2024838382[Click
the Applications button] to specify the CLM presentations set.
. link:clm-settings[The incorrect record of CLM Settings] for the
current user's profile. The Remote Detailing should be enabled in
link:ct-mobile-control-panel-presenter[CT Mobile Control Panel:
Presenter]/link:ct-mobile-control-panel-remote-detailing-new[CT
...
link:remote-detailing-1-0-ui-for-participants[here].
...
link:remote-detailing-f-a-q#h2_250361472[the bandwidth and
...
link:remote-detailing-f-a-q#h3_1979411778[mobile browsers] due to
their limitations.
...
. Previously, check
link:remote-detailing-f-a-q#SupportedBrowsers[the supported
browsers on devices].
...
The same link:ct-presenter[CLM presentations] and custom scenarios
as for the *Application* module in the CT Mobile app can be used for
*Remote Detailing*.

* link:clm-application[CLM presentation] should be active and
...
* Check link:requirements-and-media-file-formats[requirements and
...
clicks cannot be tracked for link:remote-detailing-statistics[the
statistics].
...
participants.
* Specify the
link:ct-mobile-control-panel-presenter#h3_949497961[CRM Data
Streaming Enabled]/
link:ct-mobile-control-panel-remote-detailing-new#h4_1433734342[CRM
...
link:remote-detailing-apex-trigger-classes-and-quick-action[add and
use the Applications button on the Activity record in Lightning
Experience].
** For *Remote Detailing 2.0*, you can link:changing-slides[switch
...
link:clm-application[Application] record to copy and insert the
...
link:publishing-clm-presentations#h3_1098755975[renew slides] for
...
familiar with link:js-bridge-methods-availability[the list of the
