...
link:remote-detailing-launch-the-ct-mobile-app[the CT Mobile
app]. Read link:remote-detailing-f-a-q[Remote Detailing: F.A.Q.] to
...
link:remote-detailing-1-0-ui-for-participants[can join] and
participate.
...
link:ct-mobile-control-panel-presenter#h2_985373192[CT Mobile
Control Panel:
...
link:remote-detailing-statistics[the statistics], the *Track slide
