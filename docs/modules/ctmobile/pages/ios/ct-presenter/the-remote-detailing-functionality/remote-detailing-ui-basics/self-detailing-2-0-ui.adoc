...
link:ios/remote-detailing-f-a-q#h2__106650128[the invitation link].

Use https://help.salesforce.com/articleView?id=000331470&mode=1&type=1[the
integration user] to link:ios/remote-detailing-statistics[collect
...
link:ios/js-bridge-methods-availability[JS Bridge methods], take
surveys, and more.
