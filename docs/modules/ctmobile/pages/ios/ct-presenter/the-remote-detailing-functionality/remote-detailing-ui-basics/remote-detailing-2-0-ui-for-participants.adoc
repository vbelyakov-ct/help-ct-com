...
. Click link:ios/remote-detailing-f-a-q#h2__106650128[the invite link]
to join the CLM presentation.
. Enter your username and e-mail and click *Join*.
* If specified, a participant should agree with
link:ios/ct-mobile-control-panel-presenter#h3_1019207818[the Terms of
Use].
* An email address
link:ios/ct-mobile-control-panel-presenter#h3__868233337[may be
required].
...
allowed in
the link:ios/ct-mobile-control-panel-presenter#h3_172954036[CT Mobile
Control Panel:
...
the link:ios/ct-mobile-control-panel-presenter#h3_341694305[CT Mobile
Control Panel:
...
link:ios/ct-mobile-control-panel-presenter#h3__1123335710[CT Mobile
Control Panel:
Presenter]/link:ios/ct-mobile-control-panel-remote-detailing-new#h4__1123335710[CT
