...
link:remote-detailing-launch[Remote Detailing Launch].
...
Detailing 2.0] and link:remote-detailing-ui-basics[Remote Detailing
UI Basics].
...
other link:js-bridge-methods-availability[JS Bridge methods]
...
link:clm-applicationstats[the Application Stats object] is created
...
link:clm-applicationstats[the Application Stats object] per slide
