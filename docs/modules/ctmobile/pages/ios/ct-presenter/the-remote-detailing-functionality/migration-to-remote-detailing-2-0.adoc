...
Follow the steps in the link:remote-detailing-setup[Remote
...
link:remote-detailing-apex-trigger-classes-and-quick-action#h2_249047963[should
be specified] within the trigger code.
. Go to the link:ct-mobile-control-panel-presenter[CT Mobile
Control Panel:
...
checkboxes are selected for desired link:clm-application[CLM
presentations].
...
link:ct-mobile-control-panel-tools#h3__964087610[CT Mobile Control
