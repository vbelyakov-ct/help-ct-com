...
Follow the steps in the link:ios/remote-detailing-setup[Remote
...
link:ios/remote-detailing-apex-trigger-classes-and-quick-action#h2_249047963[should
be specified] within the trigger code.
. Go to the link:ios/ct-mobile-control-panel-presenter[CT Mobile
Control Panel:
...
checkboxes are selected for desired link:ios/clm-application[CLM
presentations].
...
link:ios/ct-mobile-control-panel-tools#h3__964087610[CT Mobile Control
