...
The link:applications[Application] module, Carousel of CLM
presentations link:mobile-layouts-applications[on the mobile
layout] and link:home-screen[Home Screen].

link:gestures-in-clm-presentations[Gestures]

link:clm-presentation-controls[Button controls]

link:opening-attached-files[Opening Attached files]

link:changing-slides[Changing Slides]

ifndef::andr[]

link:methods-for-clm-presentation-navigation[JS Bridge methods]
...
link:methods-for-clm-presentation-navigation[the JS Bridge methods
for navigation]. ====
