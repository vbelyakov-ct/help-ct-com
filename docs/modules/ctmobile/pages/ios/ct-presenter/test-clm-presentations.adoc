...
[TIP] ==== Refer to link:ios/js-bridge-methods-availability[JS
...
. Go to the link:ios/ct-mobile-control-panel-remote-detailing-new[CT
...
** link:ios/ctm-create[ctm.create]
** link:ios/ctm-update[ctm.update]
** link:ios/ctm-delete[ctm.delete]
** link:ios/ctm-query[ctm.query]
** link:ios/ctm-opendatatablebyparentrecord[ctm.openDataTableByParentRecord]
** link:ios/ctm-opendatatablebyquery[ctm.openDataTableByQuery]
** link:ios/ctm-openqrscanner[ctm.openQRScanner]
** link:ios/ctm-openquiz[ctm.openQuiz]
** link:ios/ctm-getfile[ctm.getFile]
** link:ios/ctm-storefile[ctm.storeFile]
* *Demo Presentation*

Use this CLM-presentation as an example of how to interact with the
elements, such as video or link:ios/creating-a-widget[widgets], and how
to link:ios/ctm-generatepdf[create a PDF] based on a slide.
