...
link:gestures-in-clm-presentations[gestures], and
...
link:clm-application[the desired CLM presentation record] and add
...
link:clm-customscenario[the desired Scenario record], and add the
...
to link:clm-navigation-in-clm-presentations[Navigation in CLM
Presentations].
