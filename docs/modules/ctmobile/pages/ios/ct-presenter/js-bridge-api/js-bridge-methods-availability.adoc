...
you should launch link:fast-synchronization[fast synchronization]
...
|Methods for interaction with CRM data |link:crm-data-display[CRM
data display] |Yes |Yes |Yes |Yes |

| |link:opening-attached-files[Opening attached files] |Yes |Yes
|Yes |No |

| |Query records: link:ctm-query[ctm.query] |Yes |Yes |Yes |Yes
|These methods are forbidden during the *Self Detailing* and *Self
Detailing 2.0* meetings.

| |Create records: link:ctm-create[ctm.create] |Yes |Yes |Yes |Yes
|

| |Update records: link:ctm-update[ctm.update] |Yes |Yes |Yes |Yes
|

| |Delete records: link:ctm-delete[ctm.delete] |Yes |Yes |Yes |Yes
|

| |Start fast sync: link:ctm-sync[ctm.sync] |Yes |Yes |No |No |

| |Obtain the path to the file: link:ctm-getfile[ctm.getFile] |Yes
|No |Yes |No |

| |Save attachments: link:ctm-storefile[ctm.storeFile] |Yes |No
|Yes |No |
...
link:ctm-photo[ctm.photo] |Yes |Yes |No |No |
...
| |PDF generation: link:ctm-generatepdf[ctm.generatePDF] |Yes |No
|No |No |
...
link:ctm-autoexitpresenter[ctm.autoExitPresenter] |Yes |No |Yes |No
|

|Methods for CLM presentation control |Like:
link:ctm-like[ctm.like] |Yes |Yes |Yes |No |

| |Dislike: link:ctm-dislike[ctm.dislike] |Yes |Yes |Yes |No |
...
link:ctm-customstats[ctm.customStats] |Yes |No |No |No |

| |link:ctm-setoptions[ctm.setOptions] |No |No |Yes |No |

|Methods for CLM presentation navigation
|link:ctappgotoslide[CTAPPgoToSlide] |Yes |No |Yes |Yes |

| |link:ctappgotofirst[CTAPPgoToFirst] |Yes |No |Yes |Yes |

| |link:ctappgotoprevious[CTAPPgoToPrevious] |Yes |No |Yes |Yes |

| |link:ctappgotonext[CTAPPgoToNext] |Yes |No |Yes |Yes |
...
link:ctm-getappenv[ctm.getAppEnv] |No |No |No |Yes |These methods
are used during the Remote Detailing 2.0 or Self Detailing 2.0 meeting.

| |Define the Id of the Activity record:
link:ctm-getvisitid[ctm.getVisitId] |No |No |No |Yes |
