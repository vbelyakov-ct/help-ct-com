...
link:ios/methods-for-interaction-with-crm-data[Methods for Interaction
with CRM data]

link:ios/methods-for-accessing-external-functionality[Methods for
Accessing External Functionality]

link:ios/methods-for-clm-presentation-control[Methods for CLM
Presentation Control]

ifdef::ios,win[]

link:ios/methods-for-clm-presentation-navigation[Methods for
CLM-presentation Navigation]

link:ios/methods-for-remote-detailing-2-0[Methods for Remote Detailing
2.0]
