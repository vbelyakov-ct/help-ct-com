...
link:methods-for-interaction-with-crm-data[Methods for Interaction
with CRM data]

link:methods-for-accessing-external-functionality[Methods for
Accessing External Functionality]

link:methods-for-clm-presentation-control[Methods for CLM
Presentation Control]

ifdef::ios,win[]

link:methods-for-clm-presentation-navigation[Methods for
CLM-presentation Navigation]

link:methods-for-remote-detailing-2-0[Methods for Remote Detailing
2.0]
