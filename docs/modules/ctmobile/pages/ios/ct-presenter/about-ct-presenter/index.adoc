...
* In the case of using on-the-slide markup, xref:ios/ct-presenter/the-remote-detailing-functionality/remote-detailing-f-a-q.adoc[]JS methods and links are available from within the CLM presentation.
