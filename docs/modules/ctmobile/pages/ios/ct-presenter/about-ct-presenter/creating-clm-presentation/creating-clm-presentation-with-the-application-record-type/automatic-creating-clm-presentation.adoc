...
or *link:ios/creating-clm-presentation[create new CLM presentation]*.
. Click
...
* Click the **link:ios/creating-a-slide[Slide] **name to edit a slide.
* Click the **link:ios/creating-a-template[Template] **name to edit a
template.
* Specify whether the slide is active and can be used in CLM
presentation or not.
* Specify the *Required* attribute and a category, if needed.
* Specify slides
in link:ios/clm-navigation-in-clm-presentations[branches].
. Click link:ios/publishing-clm-presentations[the Publish application
button].
...
link:ios/synchronization-launch[Perform fast or mixed synchronization]
...
* link:ios/creating-interactive-clm-presentation[Creating Interactive
CLM Presentation]
