...
link:ios/clm-slide[here]. ====
* Enter the *Slide* name.
* Specify the slide content using one of the options below:
** Select link:ios/clm-template[the template] with placeholders and
widgets.
** In the *Markup* field, specify a markup for a slide.
* Specify link:ios/clm-navigation-in-clm-presentations[the order and
branch].
...
It is also possible to add link:ios/attachments-and-files[attachment
