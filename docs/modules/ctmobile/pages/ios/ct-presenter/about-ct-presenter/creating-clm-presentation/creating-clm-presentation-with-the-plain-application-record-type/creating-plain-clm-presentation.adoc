...
* Click
link:ios/creating-plain-clm-presentation-using-templates[Templates] for
selecting a template for a CLM presentation.
* Click link:ios/creating-plain-clm-presentation-from-powerpoint[Import
PPT] for creating a CLM presentation from uploaded PowerPoint.
* Click *Save* to save changes.
* Click *Convert* to edit the plain CLM presentation as
link:ios/creating-clm-presentation[the usual one]. This action is
irreversible.
