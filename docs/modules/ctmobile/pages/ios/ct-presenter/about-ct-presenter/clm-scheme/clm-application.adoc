...
may be used link:ios/changing-slides[in the navigation] for switching
...
the link:ios/clm-applicationstats[Application Stats] object.
...
link:ios/creating-clm-presentation-from-powerpoint[PowerPoint],
link:ios/creating-clm-presentation-from-pdf[PDF], or
link:ios/creating-clm-presentation-from-jpeg-jpg[ZIP archives with the
JPEG/JPG files] on the link:ios/application-editor[Application Editor]
tab.
* *Plain Application*

In the built-in link:ios/plain-application-editor[Plain Application
Editor], CLM presentations can be created based on
link:ios/clm-template[templates],
link:ios/clm-placeholder[placeholders], link:ios/clm-widget[widgets],
...
link:ios/clm-customscenario[custom scenarios].

|Slide Zoom Enabled |[.apiobject]#clm__IsZoomEnabled__c#
|Checkbox |If enabled, zoom in and out slides if
link:ios/mobile-application-setup#h2_993073976[the display mode is
*wk*].
...
* link:ios/the-remote-detailing-functionality[For Remote Detailing]
