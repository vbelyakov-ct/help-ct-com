...
link:ios/clm-activity[activity] records.
...
object specified on link:ios/ct-mobile-control-panel-calendar[CT Mobile
Control Panel:
...
link:ios/the-remote-detailing-functionality[Remote Detailing] meeting
...
The link:ios/clm-customscenario[custom scenario] record in which a
slide was shown.

|Description |[.apiobject]#clm__Description__c# |Long
Text Area(32768) |To store
link:ios/clm-presentation-controls#h3_300583250[a comment] left by a
...
link:ios/ctm-customstats[ctm.CustomStats()]
