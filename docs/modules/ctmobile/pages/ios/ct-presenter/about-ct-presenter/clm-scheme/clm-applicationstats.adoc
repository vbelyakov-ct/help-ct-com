...
link:clm-activity[activity] records.
...
link:gestures-in-clm-presentations[gestures].  ====
...
object specified on link:ct-mobile-control-panel-calendar[CT Mobile
Control Panel:
...
link:the-remote-detailing-functionality[Remote Detailing] meeting
...
The link:clm-customscenario[custom scenario] record in which a
slide was shown.

|Description |[.apiobject]#clm__Description__c# |Long
Text Area(32768) |To store
link:clm-presentation-controls#h3_300583250[a comment] left by a
...
link:ctm-customstats[ctm.CustomStats()]
