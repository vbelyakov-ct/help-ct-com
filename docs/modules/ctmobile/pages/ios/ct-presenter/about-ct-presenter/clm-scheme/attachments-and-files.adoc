...
link:attach-files-to-clm-presentation[CLM presentation sources],
for example, images, scripts, and styles.

link:actions#h2_62618674[photos] and signatures of *Activity*
records;

attachments to the link:chatter[Chatter feed] posts;
...
We recommend using
the link:ct-mobile-control-panel-general#h3__377059502[Image
Quality] (in CT Mobile Control
Panel)/link:ct-mobile-control-panel-general-new#h3__377059502[Quality
...
link:fast-synchronization[fast synchronization].
