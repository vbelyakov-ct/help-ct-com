...
link:ios/attach-files-to-clm-presentation[CLM presentation sources],
for example, images, scripts, and styles.

link:ios/actions#h2_62618674[photos] and signatures of *Activity*
records;

attachments to the link:ios/chatter[Chatter feed] posts;
...
We recommend using
the link:ios/ct-mobile-control-panel-general#h3__377059502[Image
Quality] (in CT Mobile Control
Panel)/link:ios/ct-mobile-control-panel-general-new#h3__377059502[Quality
...
link:ios/fast-synchronization[fast synchronization].
