...
link:clm-application[Applications] available to the user.
...
link:home-screen[the Carousel of CLM presentations on the Home
Screen] or link:mobile-layouts-applications[in the widget on the
...
link:changing-slides[in the navigation].
