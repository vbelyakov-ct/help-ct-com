...
link:ios/clm-application[Applications] available to the user.
...
link:ios/home-screen[the Carousel of CLM presentations on the Home
Screen] or link:ios/mobile-layouts-applications[in the widget on the
...
link:ios/changing-slides[in the navigation].
