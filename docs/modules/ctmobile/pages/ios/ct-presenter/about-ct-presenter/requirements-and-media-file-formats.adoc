...
long link:synchronization[during the synchronization].
...
that may be link:creating-clm-presentation-from-pdf[converted into
HTML5 code].
...
link:gestures-in-clm-presentations[Default gestures] to switch and
...
For presentations in link:the-remote-detailing-functionality[Remote
...
Go back to
link:requirements-and-media-file-formats#ListofRequirements[the
