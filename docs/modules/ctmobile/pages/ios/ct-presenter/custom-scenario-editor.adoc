...
link:applications#h3_1236408094[Mobile Scenario Editor] to learn
...
link:clm-customscenario[its details].
* Click the
image:edit-icon.png[]
...
link:publishing-clm-presentations#h3_1098755975[renew them].
...
link:clm-customscenario[favorites].
