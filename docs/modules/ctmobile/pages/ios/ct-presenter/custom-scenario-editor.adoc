...
link:ios/applications#h3_1236408094[Mobile Scenario Editor] to learn
...
link:ios/clm-customscenario[its details].
* Click the
image:edit-icon.png[]
...
link:ios/publishing-clm-presentations#h3_1098755975[renew them].
...
link:ios/clm-customscenario[favorites].
