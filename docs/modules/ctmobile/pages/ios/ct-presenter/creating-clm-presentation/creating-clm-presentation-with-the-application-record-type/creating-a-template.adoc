...
* You can use link:creating-a-widget[widgets] to make slides look
and feel different. To use widgets, it is needed to add
link:creating-a-placeholder[placeholders] where they would be
located.
...
available link:clm-template[here]. ====
* To activate JS Bridge in the HTML code,
link:activating-js-bridge[enable the JS Bridge library].
