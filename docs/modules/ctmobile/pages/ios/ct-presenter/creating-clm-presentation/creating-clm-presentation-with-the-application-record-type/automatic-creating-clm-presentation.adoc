...
. Click xref:ios/ct-presenter/publishing-clm-presentations.adoc[the Publish application
button].
...
xref:ios/mobile-application/synchronization/synchronization-launch/index.adoc[Perform fast or mixed synchronization]
