...
** _Plain Application_ to link:plain-application-editor[create
...
the link:self-detailing-2-0-ui[Self Detailing
...
download as PDF while using the link:self-detailing-2-0-ui[Self
