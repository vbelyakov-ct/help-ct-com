...
link:applications[Applications] module, on
link:mobile-layouts-applications[the mobile layout] of a record,
link:home-screen[Home Screen], or during a co-browsing session with
...
the *link:creating-application-record[Available for Download]*
...
link:applications[Applications] module, on
link:mobile-layouts-applications[the mobile layout] of a record,
and link:home-screen[Home Screen], it is necessary to take slide
screenshots. The *Renew Slides* functionality creates or replaces the
screenshots, for example, if some information was changed or the
animation was added. Taking a slide screenshot with a delay helps to
...
[NOTE] ==== If
link:ct-presenter-introduction#h2_1251281241[the required remote
