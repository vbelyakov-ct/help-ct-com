...
xref:ios/ct-presenter/js-bridge-api/index.adoc[read/write access to CRM data]. In CLM
...
xref:ios/ct-presenter/about-ct-presenter/clm-scheme/clm-applicationstats.adoc[CLM-presentations tracking and usage
