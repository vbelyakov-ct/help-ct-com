...
* Since link:ct-mobile-managed-package-update-to-v-3-54[CT Mobile
...
* link:ct-mobile-control-panel-new[CT Mobile Control Panel
...
link:ability-to-specify-metadata-components-or-the-number-of-entities-in-one-request[archive
component custom metadata type] before upgrading to this version.

[[h3_1844278829]]
==== Fixes

* Fixed displaying link:mini-layouts[Mini Layouts] editing window.
* Fixed displaying fields in the
link:ct-mobile-control-panel-custom-details[Custom Details] editing
window.
...
link:ct-mobile-control-panel-tools#h3_1003786176[refreshing the
metadata archive]. ====
...
objects with link:related-list-filters[related list filters].
...
* Fixed editing link:custom-scenario-editor[custom scenarios].
...
link:ct-mobile-control-panel-presenter#h3_298754890[custom domain
name for your meeting URL].
* The *Available for Download* checkbox is added to the
link:creating-application-record#h2_1960465655[application creation
form]. If selected, the presentation can be
link:self-detailing-2-0-ui[downloaded as PDF] during the Self
Detailing.
* Updated
link:application-permission-settings#h3_2115044027[required
...
* link:remote-detailing-2-0-audio-recording[Saving audio recording]
...
* The ability to activate link:cg-cloud[the CG Cloud support] to
...
link:remote-detailing-launch-salesforce-side#h3__135274013[users
will be notified] if CLM presentations are not found on a server.
* The *Terms Accepted* attribute in the
link:clm-applicationstats[application statistics] stores a
participant's agreement to the terms of use.

* During the *Self Detailing* meeting.
** The ability to use the link:ctm-securequery[cm .secureQuery]
method in the CLM presentations to make secure requests to Salesforce
data.
** Support the link:ctm-create[ctm.create] and
link:ctm-update[ctm.update] methods in the CLM presentations.
* link:remote-detailing-launch-salesforce-side#h3__135274013[For
user convenience]:
...
link:metadata-archive[will be downloaded] in the CT Mobile app
...
deleted with the
link:ct-mobile-control-panel-tools#h3__1658362952[Refresh CTM
Settings] button.
...
link:ct-mobile-control-panel-offline-objects[during creating a SOQL
filter].
* link:ct-mobile-control-panel-presenter#h3_1019207818[New options]
...
* If link:ct-presenter-introduction#h2_1251281241[the required
remote sites] are not activated, an error message will be displayed when
a user tries to
link:publishing-clm-presentations#h3_1098755975[renew slides].
* link:remote-detailing-statistics[The browser name and IP address]
...
the images in link:creating-clm-presentation-from-jpeg-jpg[JPEG or
JPG format].
...
* Fixed the ability
link:ct-mobile-control-panel-tools#h3_847464003[to download the
metadata archive].
...
link:clm-user[User audit fields] for the _CT Mobile Administrator_
...
* Use the link:ct-mobile-control-panel-tools#h3_840249901[New
...
* link:clm-settings[The new parameter] for future audio recording
storage is added.
* link:remote-detailing-launch-salesforce-side#h3__135274013[For
user convenience]:
...
* link:clm-user[The new audit field] is intended to store the
...
link:application-editor[Application Editor].
* If CLM presentations are not set for the[.object]#Activity#
record, all link:clm-application[active and available for Remote
...
link:metadata-checker[the metadata checker] now only tracks reports
...
link:migration-to-remote-detailing-2-0[Migration to Remote
...
link:metadata-archive[the metadata archive].
...
* link:remote-site-settings[The new RD endpoint] should be
activated when installing or updating the CT Mobile package.
* link:remote-detailing-ui-basics[Enhanced UI] for the presenter
and participants.
...
* Security Update:
link:ct-mobile-control-panel-presenter#h3__53846510[specify the
integration user] to connect to the *Self Detailing* meeting and collect
statistics.
* link:remote-detailing-f-a-q#h2__106650128[New direct links] to
...
link:ct-mobile-control-panel-tools#h3_847464003[Download metadata
...
link:application-editor[converting to CLM presentation] has been
enlarged up to 75 MB.
* link:js-bridge-methods-availability[New JS Bridge methods] to
...
the link:start-finish-functionality[Start/Finish functionality] is
disabled.
...
the link:trigger-settings[Trigger Settings].
* Fixed link:download-clm-presentations-as-pdf[saving CLM
...
link:ct-mobile-control-panel-presenter#h3__1311451422[Link Field]
and
link:ct-mobile-control-panel-presenter#h3__201439959[Application
List Field].
...
* Improved link:sync-recovery[Sync Recovery] functionality: force
...
link:mobile-application-setup[Mobile Application Setup] is added.
...
link:ct-mobile-control-panel-tools#h3_2011978[the cloud token] will
be copied to the protected link:api-key[API Key] custom setting.
...
the attachment will be sent as link:sync-recovery#h3_356910769[a
...
* Specify the ability
link:ct-mobile-control-panel-calendar#h3_1856075785[to leave the
...
link:ct-mobile-control-panel-tools#h3__1876917838[Scheduled
...
the assigned
link:application-permission-settings#h2__1046081510[_CT Mobile
...
link:mini-layouts#h2__684572466[creating a mini layout].
* Fixes for link:custom-related-lists#h2__993780705[the creation of
...
* The ability to work with the link:custom-scenario-editor[Custom
Scenario Editor] in Lightning Experience.
* Fixed the process of
link:publishing-clm-presentations#h3_1098755975[renewing slides] if
there is only one slide in the CLM presentation.
* Fixed link:attach-files-to-clm-presentation[attaching files to
...
In this release, the new link:ctm-user-settings[CTM User Settings]
...
* The ability
to link:ct-mobile-control-panel-app-menu#h2_1511584348[specify the
ascending or descending order] for records in the *Routes* module.
* The link:ct-mobile-control-panel-tools#h3_1380764274[Remove
metadata archive from server] button is added to simplify the QA
process.
* The ability to specify
link:ct-mobile-control-panel-general#h3__1990058335[Bing Maps API
Key] for CT Mobile Windows and
link:ct-mobile-control-panel-general#h3_375370096[Google Maps API
...
* Users of CT Mobile iOS with link:start-finish-functionality[the
...
link:api-key[The new private API key custom setting] is used to
...
* The link:ct-mobile-control-panel-tools#h4_1003786176[Refresh
...
link:managing-offline-objects#ManagingOfflineObjects-SOQLFilters[SOQL
filters].
...
link:ctm-settings-offline-objects[the CTM Settings records] of the
...
* link:clm-customscenario[Custom scenarios] can be selected within
...
* The *Show* button link:ct-mobile-control-panel-tools[to view the
cloud token value].
...
* The link:ct-mobile-control-panel-presenter#h3_341694305[Call
...
in red color
link:remote-detailing-1-0-ui-for-presenter#h2_561326567[for better
visibility].
...
* link:ct-mobile-control-panel-presenter[The corresponding tab]
...
* link:ct-mobile-control-panel-tools#h3__1658362952[The Refresh CTM
...
link:download-clm-presentations-as-pdf[the Download as PDF button]
...
* The enhanced link:remote-detailing-setup[setup process] for the
*Remote Detailing* and *Self Detailing* functionality.
* In Lightning Experience, add
link:remote-detailing-launch-salesforce-side#h2_1396626265[the
Remote Detailing button] on the *Application* record to launch the
*Remote Detailing* meeting.
* On the link:remote-detailing-1-0-ui-for-participants[Attendee
