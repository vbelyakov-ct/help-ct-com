...
* Since link:ios/ct-mobile-managed-package-update-to-v-3-54[CT Mobile
...
* link:ios/ct-mobile-control-panel-new[CT Mobile Control Panel
...
link:ios/ability-to-specify-metadata-components-or-the-number-of-entities-in-one-request[archive
component custom metadata type] before upgrading to this version.

[[h3_1844278829]]
==== Fixes

* Fixed displaying link:ios/mini-layouts[Mini Layouts] editing window.
* Fixed displaying fields in the
link:ios/ct-mobile-control-panel-custom-details[Custom Details] editing
window.
...
profile credentials.
. Go to link:ios/ct-mobile-control-panel-tools[CT Mobile Control Panel
→ Tools].
...
link:ios/ct-mobile-control-panel-tools#h3_1003786176[refreshing the
metadata archive]. ====
...
objects with link:ios/related-list-filters[related list filters].
...
* Fixed editing link:ios/custom-scenario-editor[custom scenarios].
...
link:ios/ct-mobile-control-panel-presenter#h3_298754890[custom domain
name for your meeting URL].
* The *Available for Download* checkbox is added to the
link:ios/creating-application-record#h2_1960465655[application creation
form]. If selected, the presentation can be
link:ios/self-detailing-2-0-ui[downloaded as PDF] during the Self
Detailing.
* Updated
link:ios/application-permission-settings#h3_2115044027[required
...
* link:ios/remote-detailing-2-0-audio-recording[Saving audio recording]
...
* The ability to activate link:ios/cg-cloud[the CG Cloud support] to
...
link:ios/remote-detailing-launch-salesforce-side#h3__135274013[users
will be notified] if CLM presentations are not found on a server.
* The *Terms Accepted* attribute in the
link:ios/clm-applicationstats[application statistics] stores a
participant's agreement to the terms of use.

* During the *Self Detailing* meeting.
** The ability to use the link:ios/ctm-securequery[cm .secureQuery]
method in the CLM presentations to make secure requests to Salesforce
data.
** Support the link:ios/ctm-create[ctm.create] and
link:ios/ctm-update[ctm.update] methods in the CLM presentations.
* link:ios/remote-detailing-launch-salesforce-side#h3__135274013[For
user convenience]:
...
link:ios/metadata-archive[will be downloaded] in the CT Mobile app
...
link:ios/ct-mobile-control-panel-offline-objects[during creating a SOQL
filter].
* link:ios/ct-mobile-control-panel-presenter#h3_1019207818[New options]
...
* If link:ios/ct-presenter-introduction#h2_1251281241[the required
remote sites] are not activated, an error message will be displayed when
a user tries to
link:ios/publishing-clm-presentations#h3_1098755975[renew slides].
* link:ios/remote-detailing-statistics[The browser name and IP address]
...
the images in link:ios/creating-clm-presentation-from-jpeg-jpg[JPEG or
JPG format].
...
* Fixed the ability
link:ios/ct-mobile-control-panel-tools#h3_847464003[to download the
metadata archive].
...
link:ios/clm-user[User audit fields] for the _CT Mobile Administrator_
...
* Use the link:ios/ct-mobile-control-panel-tools#h3_840249901[New
...
* The ability to specify whether link:ios/clm-settings[the participant
is required] to add the email to access the *Remote Detailing* meeting.
* link:ios/clm-settings[The new parameter] for future audio recording
storage is added.
* link:ios/remote-detailing-launch-salesforce-side#h3__135274013[For
user convenience]:
...
* link:ios/clm-user[The new audit field] is intended to store the
...
record, all link:ios/clm-application[active and available for Remote
...
link:ios/metadata-checker[the metadata checker] now only tracks reports
...
link:ios/migration-to-remote-detailing-2-0[Migration to Remote
...
link:ios/metadata-archive[the metadata archive].
...
* link:ios/remote-site-settings[The new RD endpoint] should be
activated when installing or updating the CT Mobile package.
* link:ios/remote-detailing-ui-basics[Enhanced UI] for the presenter
and participants.
...
* Security Update:
link:ios/ct-mobile-control-panel-presenter#h3__53846510[specify the
integration user] to connect to the *Self Detailing* meeting and collect
statistics.
* link:ios/remote-detailing-f-a-q#h2__106650128[New direct links] to
...
link:ios/ct-mobile-control-panel-tools#h3_847464003[Download metadata
...
link:ios/application-editor[converting to CLM presentation] has been
enlarged up to 75 MB.
* link:ios/js-bridge-methods-availability[New JS Bridge methods] to
...
the link:ios/start-finish-functionality[Start/Finish functionality] is
disabled.
...
the link:ios/trigger-settings[Trigger Settings].
* Fixed link:ios/download-clm-presentations-as-pdf[saving CLM
...
link:ios/ct-mobile-control-panel-presenter#h3__1311451422[Link Field]
and
link:ios/ct-mobile-control-panel-presenter#h3__201439959[Application
List Field].
...
* Improved link:ios/sync-recovery[Sync Recovery] functionality: force
...
link:ios/mobile-application-setup[Mobile Application Setup] is added.
...
link:ios/ct-mobile-control-panel-tools#h3_2011978[the cloud token] will
be copied to the protected link:ios/api-key[API Key] custom setting.
...
the attachment will be sent as link:ios/sync-recovery#h3_356910769[a
...
* Specify the ability
link:ios/ct-mobile-control-panel-calendar#h3_1856075785[to leave the
...
link:ios/ct-mobile-control-panel-tools#h3__1876917838[Scheduled
...
the assigned
link:ios/application-permission-settings#h2__1046081510[_CT Mobile
...
link:ios/mini-layouts#h2__684572466[creating a mini layout].
* Fixes for link:ios/custom-related-lists#h2__993780705[the creation of
...
* The ability to work with the link:ios/custom-scenario-editor[Custom
Scenario Editor] in Lightning Experience.
* Fixed the process of
link:ios/publishing-clm-presentations#h3_1098755975[renewing slides] if
there is only one slide in the CLM presentation.
* Fixed link:ios/attach-files-to-clm-presentation[attaching files to
...
In this release, the new link:ios/ctm-user-settings[CTM User Settings]
...
* The ability
to link:ios/ct-mobile-control-panel-app-menu#h2_1511584348[specify the
ascending or descending order] for records in the *Routes* module.
* The link:ios/ct-mobile-control-panel-tools#h3_1380764274[Remove
metadata archive from server] button is added to simplify the QA
process.
* The ability to specify
link:ios/ct-mobile-control-panel-general#h3__1990058335[Bing Maps API
Key] for CT Mobile Windows and
link:ios/ct-mobile-control-panel-general#h3_375370096[Google Maps API
...
* Users of CT Mobile iOS with link:ios/start-finish-functionality[the
...
link:ios/api-key[The new private API key custom setting] is used to
...
* The link:ios/ct-mobile-control-panel-tools#h4_1003786176[Refresh
...
link:ios/ctm-settings-offline-objects[the CTM Settings records] of the
...
* link:ios/clm-customscenario[Custom scenarios] can be selected within
...
* The *Show* button link:ios/ct-mobile-control-panel-tools[to view the
cloud token value].
...
* The link:ios/ct-mobile-control-panel-presenter#h3_341694305[Call
...
in red color
link:ios/remote-detailing-1-0-ui-for-presenter#h2_561326567[for better
visibility].
...
* link:ios/ct-mobile-control-panel-presenter[The corresponding tab]
...
* link:ios/ct-mobile-control-panel-tools#h3__1658362952[The Refresh CTM
...
link:ios/download-clm-presentations-as-pdf[the Download as PDF button]
...
* The enhanced link:ios/remote-detailing-setup[setup process] for the
*Remote Detailing* and *Self Detailing* functionality.
* In Lightning Experience, add
link:ios/remote-detailing-launch-salesforce-side#h2_1396626265[the
Remote Detailing button] on the *Application* record to launch the
*Remote Detailing* meeting.
* On the link:ios/remote-detailing-1-0-ui-for-participants[Attendee
