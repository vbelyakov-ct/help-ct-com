...
See the
link:ios/compatible-versions-of-ct-mobile-and-other-packages[compatibility
...
link:ios/calendar#h3_645629234[left menu], if they are set up in the
object link:ios/compact-layout[compact layout].
** Up to 5 events can be displayed for one day in the
link:ios/using-calendar#h3_860090196[month view].
** Customizable *All activities per day* hint added to the
link:ios/home-screen#h3_1292798904[calendar widget] for the Home
Screen.
** User can see
...
* Records counter in a link:ios/list-views[list view] is now displayed
if there are more than 500 records.
* Files sharing workflow has been upgraded, including
link:ios/attaching-files-in-the-files-section#h3__1261438429[attached
files for offline objects], link:ios/sharing-clm-presentations[CLM
...
* link:ios/actions#h2_1173923582[Export .csv] item added to the
...
the link:ios/ctm-settings-offline-objects[Offline objects] record
type.
...
* The link:ios/ctm-settings-offline-objects[Files Download Enabled]
...
will be reduced.
* The link:ios/ctm-settings-offline-objects[Files Filter] field
added for Offline objects. You can
link:ios/attaching-files-in-the-files-section#h3_1720123861[specify the
...
link:ios/attaching-files-in-the-files-section[Files] section of an
offline object. You can add or delete files in the
link:ios/attaching-files-in-the-files-section#h3__2018099316[Actions]
menu of an offline object.
* Adding and pinning list views for the
link:ios/using-calendar#h3__632854949[Calendar].
...
link:ios/offline-supported-operators-and-functions-in-field-with-the-formula-type[formulas].
...
* The ability to minimize the link:ios/libraries[Libraries] content and
link:ios/attachments-and-files[Attachments] of a record. Move the
...
one.
**** Now you can link:ios/application-settings#h3__611076828[set up the
...
**** Opening draft order.
**** Finalizing order.
*** link:ios/limitations-for-the-ct-orders-module[Recommended load
...
link:ios/technical-requirements-for-devices-and-network[requirements
for devices] and installing
link:ios/ct-mobile-package-release-notes[the latest CT Mobile package
version].
...
* link:ios/ct-mobile-control-panel-calendar#h3_808313222[The default
...
Go back to link:ios/ct-mobile-ios-release-notes#ListOfReleases[the list
...
* link:ios/activating-cg-cloud-in-salesforce[Activate CG Cloud in your
Salesforce org] to work with retail stores
link:ios/activating-cg-cloud-in-the-ct-mobile-app[in the CT Mobile
app].
* link:ios/managing-visits-to-retail-stores#h2_1751285824[Find the
nearby stores],
link:ios/managing-visits-to-retail-stores#h2__1880003381[build optimal
routes], and
link:ios/managing-visits-to-retail-stores#h2_535537278[schedule your
...
link:ios/managing-visits-to-retail-stores#h2__1592083570[to generate
...
** link:ios/setting-up-task-definitions-and-action-plan-templates#h2__1302650526[Monitor
key processes] such as
link:ios/managing-visits-to-retail-stores#h3_1867622910[inventory
audits],
link:ios/managing-visits-to-retail-stores#h3__696266799[promotion
checks], and
link:ios/managing-visits-to-retail-stores#h3__85077301[in-store
surveys] with predefined templates.
** link:ios/managing-visits-to-retail-stores#h3__481270469[Using
Einstein Detection and CT Vision], audit shelves, measure share and
shelf, manage stock and optimize product sales.
** link:ios/managing-visits-to-retail-stores#h3_190353401[Using CT
Orders], create your orders and manage deliveries.
* Gather information
link:ios/managing-visits-to-retail-stores#h3__582599340[using custom
metrics] and
link:ios/managing-visits-to-retail-stores#h3__1516408339[perform ad-hoc
tasks].
...
link:ios/clm-user[are saved] after each synchronization to optimize the
...
link:ios/coloring-menu-items-and-modules[that object icon] in the CT
Mobile app.

image:color_menu_item_ios_en.png[]
* Use the detailed list view to see records in full screen when filling
out link:ios/reference-fields#h2__1554731138[the reference field].
...
* To go to the record screen, link:ios/using-calendar#h3__243561528[use
...
* In the left list of records link:ios/home-screen#h3_1292798904[of the
...
* link:ios/routes#h3_1243841833[The route points] are now numbered, and
...
later. We recommend installing
link:ios/ct-mobile-package-release-notes#h2_62734607[the latest CT
...
link:ios/list-views#h2__380480215[list views].
...
link:ios/start-finish-functionality#h2_239706372[the unfinished
...
link:ios/libraries[Libraries].
* When link:ios/log-out[logging out] of the CT Mobile app, a
...
link:ios/api-key[API Key] custom setting.
* https://help.salesforce.com/articleView?id=fields_using_rich_text_area.htm&type=5[Special
characters] are supported in link:ios/mobile-layouts[mobile layouts],
standard and custom link:ios/list-views[list views], and
link:ios/chatter#h2__779708391[Chatter] posts and comments.
...
link:ios/using-calendar[in the calendar grid].
...
* Use link:ios/clm-application[new attributes of CLM presentation] to
choose whether the CLM presentation should be available
link:ios/applications[offline], used in the
link:ios/remote-detailing-launch[Remote Detailing] meeting, or both.
...
* link:ios/app-menu[Assign the icon for the main tab] to help a user
quickly find out the object he is working with when viewing the record
screen.
* link:ios/search[Searching in the left record list] now displays the
...
link:ios/using-calendar[the Calendar module], the agenda with records
...
* In the link:ios/routes[Routes] module, the selected options are
saved.
...
Remember to link:ios/publishing-clm-presentations[re-publish these CLM
presentations] and perform the fast sync. ====

* The ability to zoom in or out a CLM presentation using
link:ios/gestures-in-clm-presentations[a two-finger pinch].
...
link:ios/remote-detailing-launch-the-ct-mobile-app[with one tap].
** Multitasking: switch between the meeting window and record details
link:ios/remote-detailing-1-0-ui-for-presenter[with one tap]. Resume
...
link:ios/application-settings#h3__353973580[The option to choose]
...
limitations]. We highly recommend link:ios/ctm-settings[referring to
...
* Refreshed link:ios/sync-recovery[Sync Recovery] functionality allows
...
link:ios/synchronization-launch[the fast and full synchronization] to
...
allows making sure that link:ios/synchronization[the synchronization]
is complete.
...
* For easy work with link:ios/attachments-and-files[CLM presentation
...
in link:ios/clm-navigation-in-clm-presentations[the href attribute] of
the slide layout.
* Converting a CLM presentation from
link:ios/creating-clm-presentation-from-pdf[a PDF
file] or link:ios/creating-clm-presentation-from-powerpoint[PowerPoint
...
link:ios/application-prompts-for-requesting-permissions[pop-ups] with
functionalities that need the requested permission.
* Labels of menu items and modules in the menu, such as *Home Screen*,
*Routes*, or *Libraries*, link:ios/renaming-menu-items-and-modules[can
be translated] using custom labels.
* On the link:ios/ipad[detailed list view] screen, remove a record as
well as create a record if permissions are granted.
* The support of the standard *Shipping Address* and *Billing Address*
fields as link:ios/mobile-application-setup[Account Geolocation Field]
in link:ios/nearby-accounts[Nearby Accounts] and
link:ios/routes[Routes] modules, in link:ios/mobile-layouts-maps[the
Map widget], and within link:ios/actions[the Determine Location button]
in the combo-menu.
* Use list views of link:ios/clm-application[the Application object] to
filter records in link:ios/applications[the Applications module].
* To quickly return to link:ios/calendar[the Calendar] after moving on
...
** New icons, link:ios/application-theme[vivid app themes], and modern
fonts.
** Upgraded link:ios/calendar[Calendar], link:ios/routes[Routes], and
link:ios/nearby-accounts[Nearby Accounts] modules with user-friendly
logic.
** link:ios/ipad[The collapsible main menu] provides a much wider
working area on your iPad.
** link:ios/ipad[Detailed List Views]. Look through the detailed list
views on your iPad.
** link:ios/clm-presentation-controls[Multitasking during an activity]
...
** New UI for link:ios/iphone[iPhone devices].
* The link:ios/logging-in[Login screen] is implemented using the
link:ios/oauth-2-0[OAuth 2.0] protocol and standard Salesforce UI.
* link:ios/libraries[The content module] now supports folder hierarchy.
* link:ios/sync-recovery[Sync Recovery]. Recovering the records which
could not be properly sent to Salesforce due to permissions issues.
* Adjust the link:ios/columns-width-for-related-lists[width of columns]
of the related lists and custom related lists.
* The long-hoped-for plus button is now available in the *Calendar*. It
is another way link:ios/using-calendar[to create an activity in the
...
* link:ios/set-up-holidays[Salesforce Holidays] are now supported and
are highlighted in the app's calendar.
* link:ios/ct-mobile-control-panel-general[Image Quality]. Set the
amount of image compression to control the data volume sent to
Salesforce.
* link:ios/mini-layouts[Mini Layouts] can be assigned to a specific
user profile.
* Each user profile can have its link:ios/custom-color-settings[custom
...
All functionality is available link:ios/ipad[by clicking the name of
...
records of the link:ios/sync-log[Sync Log] object with an attachment
containing detailing information (log file). Use
link:ios/sync-logs[reports to analyze] the synchronization.
* New synchronization algorithm with accelerated identification of the
created and updated records.
* link:ios/libraries[The Libraries module] download process can be
moved to the background, which significantly improves the
synchronization time.
* link:ios/metadata-archive[Metadata downloading] optimization.
...
* link:ios/ct-mobile-replication[Improved replication]. Shared records
...
* link:ios/nearby-accounts[The Nearby Accounts module]. The records
...
* The link:ios/search[Search] box value lower limit is reduced from
...
clock adjustment.
* The link:ios/person-accounts[Person Account] record type can be
created from a reference field.
* *Dashboards*. Graphs with summary formulas involved are displayed
correctly on link:ios/home-screen[Home Screen].
...
list) in the related lists link:ios/iphone[on iPhone devices].
...
*Task* and *Event*.
* link:ios/application-editor[Customizable statistics gathering] on
displaying individual screens and elements in CLM presentations.
* link:ios/synchronization[Selective synchronization] in case of user
access rules to object records is changed.
* Now you can sort link:ios/related-lists[the custom and standard
related lists] by lookup fields.
* The *Determine Location* button is not displayed when using
positioning link:ios/actions[on activity start].
* link:ios/clm-presentation-controls[Presentation exit screen
improvements].
* The link:ios/managing-offline-objects[offline-objects] customization
...
* link:ios/sync-logs[Application log records] are more detailed.
* link:ios/person-accounts[Person Accounts] will now display in *Nearby
Accounts* with appropriate settings.
* The improved logic of link:ios/using-calendar[copying activities] in
the calendar.
...
new posts in link:ios/chatter[Chatter].
...
* Updated for iOS 11.
* link:ios/ical-synchronization[Two-way sync with iPad/iPhone internal
...
* Optimized link:ios/synchronization[synchronization] for organizations
with an extended data model and large data volumes.
* Customizable set of link:ios/search[search fields] for each object.
* link:ios/reference-fields#h2__1554731138[Quick record creation in
...
* The link:ios/actions[Determine Geolocation] functionality in the
*Accounts* combo menu now depends on the user’s access rights to the
geolocation field.
* link:ios/debug-console[Application log] search functionality added.
* The *Time* type fields are now supported.
* Multiple currencies functionality added.
* link:ios/home-screen[Customizable Home screen] for iPhone added.
* The link:ios/chatter[Chatter] functionality for iPhone was added.

[[h3_118294372]]
==== CLM-presentations

* JS Bridge methods added:
** link:ios/ctm-disableslidescroll[ctm.isableSlideScroll]: optional
lock for slides scrolling using gestures.
** link:ios/ctm-enableslidescroll[ctm.enableSlideScroll]: slide
scrolling unlock option.
** link:ios/ctm-storefile[ctm.storeFile]: saving a file attachment as
an attachment to a record.
** link:ios/ctm-getfile[ctm.getFile] - getting the contents of an
...
(link:ios/mobile-application-setup[Mobile Application Setup]).
...
link:ios/applications#h3_1236408094[custom scenarios] in the
