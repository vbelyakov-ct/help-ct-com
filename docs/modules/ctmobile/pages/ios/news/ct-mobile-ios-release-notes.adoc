...
* xref:ctlayouts:admin-guide/creating-a-layout-settings-record.adoc[Customize screens with CT Layouts] to use a variety of data types to gather information on sales, effectiveness, and availability of products:
...
* When the presenter taps on the invitation link, CT Mobile prompts her to start the meeting in the CT Mobile app or default browser.
...
* Labels of menu items and modules in the menu, such as *Home Screen*, *Routes*, or *Libraries*, xref:ios/mobile-application/ui/renaming-ui-elements.adoc[can be translated] using custom labels.
