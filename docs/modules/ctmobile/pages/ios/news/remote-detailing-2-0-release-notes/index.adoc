...
the xref:ios/ct-presenter/index.adoc[CT Presenter] solution. The CT Presenter
...
xref:ios/ct-presenter/the-remote-detailing-functionality/remote-detailing-launch/remote-detailing-launch-microsoft-teams.adoc[using the CT Presenter
app].
...
xref:ios/ct-presenter/the-remote-detailing-functionality/remote-detailing-ui-basics/remote-detailing-2-0-ui-for-presenter.adoc#h4_1768762957[The
