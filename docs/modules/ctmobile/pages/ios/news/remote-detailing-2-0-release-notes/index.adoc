...
available link:ios/remote-detailing-versions-comparison[here].
* Remote Detailing 2.0 and Self Detailing 2.0 are parts of
the link:ios/ct-presenter[CT Presenter] solution. The CT Presenter
features depend on the version of the CT Mobile package are
available link:ios/ct-mobile-package-release-notes[here].
...
link:ios/remote-detailing-launch-microsoft-teams[using the CT Presenter
app].
...
* Support for the secure link:ios/ctm-securequery[ctm.secureQuery]
...
* link:ios/remote-detailing-2-0-ui-for-participants#h3__111154998[The
...
* Participants can
link:ios/remote-detailing-2-0-ui-for-participants#h4__1837856184[turn
on the video or share the screen] in a browser.
link:ios/remote-detailing-2-0-ui-for-presenter#h4_1768762957[The
...
* Display all link:ios/clm-application[active and available for Remote
...
link:ios/ct-mobile-control-panel-presenter#h3__1123335710[the specified
time interval].
...
link:ios/ct-mobile-control-panel-presenter#h3__53846510[the integration
...
* link:ios/clm-settings[If enabled], the chat history will be saved and
