...
link:gestures-in-clm-presentations.html[Gestures in CLM presentations].
...
link:mobile-layouts-applications.html[a mobile layout of a record] will
be closed. When a user taps to close a CLM presentation launched from
the link:clm-application.html[Application] menu or
link:home-screen.html[Home] screen, the pop-up window appears with
options:
...
Tap
image:58835871.png[]
to select link:custom-scenario-editor.html[a scenario] from a list of
...
link:libraries.html[downloaded documents].



Tap an attachment to open it in fullscreen mode. Tap *Send* and follow
the 3–5 steps of the
link:clm-presentation-controls.html#h2__1807389398[Send Slides] section
...
*Share Allowed* checkbox link:clm-slide.html[on a Slide record] to have
...
link:email-templates.html[Email Templates]. ====
. Tap *Send*.
...
Tap
image:58835868.png[]
to send link:pdf-files-generator.html[a PDF based on the HTML template].

* link:creating-a-template.html[Templates] are attached to the CLM
presentation.
...
link:clm-presentation-controls.html#h2_395765007[exit the CLM
presentation].
