...
link:managing-offline-objects.html[Offline objects], such as
...
link:using-calendar.html#h3__632854949[Calendar] module).
...
link:managing-offline-objects.html#h2_1534686659[if permission is
granted];
...
* export columns to a CSV file if link:actions.html#h2_1173923582[the
setting is enabled].
...
link:ctm-user-settings.html[CTM User Settings] record after the sync
process.
...
field of the link:ctm-settings-menu.html[CTM Settings → Menu] object.
====
. Tap *Save*.
