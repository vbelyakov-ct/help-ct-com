...
in the link:ctm-settings.html[CTM Settings] with the _Offline Object_
record type.
...
link:ct-mobile-control-panel-app-menu-new.html[App Menu]. #
...
link:timeline-view.html[timeline view]. If enabled, select a field
...
If the record type has a link:mobile-layouts.html[mobile layout],
