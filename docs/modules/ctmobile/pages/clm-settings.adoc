...
preferences to display link:clm-application.html[CLM presentations] via
the Remote Detailing functionality.[TIP] ==== For easy setup,
go to link:ct-mobile-control-panel-presenter.html[CT Mobile Control
Panel:
...
enabled, link:js-bridge-methods-availability.html[certain JS Bridge
...
|Checkbox |If enabled, link:remote-detailing-statistics.html[the
statistics] per slide will be gathered for each participant at the
meeting.

|Email Required Field
|[.apiobject]#clm__EmailRequiredField__c# |Text(255)
|The field API name of the *link:clm-activity.html[Activity]* object,
...
link:self-detailing-1-0-sites-settings.html[the URL of a site] is used
...
link:ct-mobile-control-panel-presenter.html#h3_298754890[Custom
Subdomain
Enabled]/link:ct-mobile-control-panel-remote-detailing-new.html#h3_1243606343[Custom
