...
. Click *Save*.
. Go to the link:ct-mobile-control-panel-presenter.html#h3_912321036[CT
Control Panel: Presenter] tab and enable the *Audio Record Enabled*
checkbox (or *Audio Recording* toggle in the
link:ct-mobile-control-panel-remote-detailing-new.html#h4__1165812577[CT
...
link:remote-detailing-2-0-ui-for-presenter.html#h4_218961852[the Record
