...
https://help.customertimes.com/smart/project-ct-mobile-en/list-views/a/h2_380480215[custom
...
API Name of xref:android/quick-reference-guides/managing-offline-objects.adoc[an offline object] for
