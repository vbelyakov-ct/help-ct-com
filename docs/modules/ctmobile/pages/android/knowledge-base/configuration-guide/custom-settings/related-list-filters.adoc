...
xref:android/quick-reference-guides/managing-offline-objects.adoc[offline object] data upload.
...
|Enable xref:android/synchronization-launch[Quick Record Synchronization]
...
xref:android/filters-in-related-lists[The SOQL query to filter]:
...
(DESC) xref:android/filters-in-related-lists[sorting order of records in
the list].
