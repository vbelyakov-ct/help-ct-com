...
link:android/mini-layouts[a mini-layout] to create a new record in the CT
Mobile app.

[TIP] ==== For easy setup, go to
link:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-mini-layouts[CT Mobile Control Panel:
Mini Layouts]. ====
