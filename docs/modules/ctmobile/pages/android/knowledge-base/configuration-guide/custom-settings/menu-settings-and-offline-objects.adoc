...
xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/index.adoc[CT Mobile Control Panel]. CT Mobile
Control Panel makes duplicates of the offline objects list in
xref:android/knowledge-base/configuration-guide/custom-settings/related-list-filters[Related List Filters] so that to be able
...
be grouped by the title of xref:android/compact-layout[a compact layout].
