...
|[.apiobject]#ApplicationProcess# |[.apiobject]#before delete# |The trigger sends the IDs of the deleting CLM presentations to
...
a|
The trigger checks the attachment is related to the slide or CLM presentation, sends the slide or CLM presentation attachment to the Customertimes server, and updates the parent record of the attachment if applied.

NOTE: The *Attachment* record label must contain the [.apiobject]#.ppt# or [.apiobject]#.html# value.
