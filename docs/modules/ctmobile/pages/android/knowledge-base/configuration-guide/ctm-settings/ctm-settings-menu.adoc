...
xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-app-menu.adoc[CT Mobile Control Panel: App
Menu]. ====
...
a|
Stores an API Name of xref:android/quick-reference-guides/managing-offline-objects.adoc[an offline
object], xref:android/mobile-application-modules[module's name], or name of
a menu item, e.g., xref:android/quick-reference-guides/home-screen.adoc[Home] and
xref:android/application-settings[Settings], that will be available in
...
records] in xref:android/app-menu[the main menu].
