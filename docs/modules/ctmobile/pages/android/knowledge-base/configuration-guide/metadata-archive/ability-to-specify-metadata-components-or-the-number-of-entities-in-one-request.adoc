...
https://help.customertimes.com/smart/project-ct-mobile-en/metadata-checker[]
...
* Go to the link:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools#h3_1003786176[CT
Mobile Control Panel: Tools] tab and click the *Refresh metadata
...
will arise during metadata archive creation, the admins should cut
creation for several parts.
