...
lists of a record of xref:android/managing-offline-objects[an offline
object].

[TIP] ==== Settings on this tab will be saved in the
corresponding fields of the
xref:android/mobile-custom-details-settings[Mobile Custom Details Settings]
record. ====
...
* Follow the steps xref:android/custom-related-lists[here] to set up custom
