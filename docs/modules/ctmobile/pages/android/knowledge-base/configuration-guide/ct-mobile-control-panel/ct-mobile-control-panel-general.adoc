...
the xref:android/mobile-application-setup[Mobile Application Setup] record.
====

* xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h2_1969690579[Location]
* xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h2_389408561[Global]
* xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h2_1037766202[User
Interface]
* xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h2_670774632[Geolocation]
* xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h2_1687169837[Support and
logs]
* xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h2_479934482[Object
mappings]
...
xref:android/knowledge-base/configuration-guide/person-accounts[Person Accounts] functionality. If enabled:
...
the xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_494016929[Reference
...
passcode three times in a row, xref:android/log-out[the database will be
reset].
...
This section is intended to xref:android/application-theme[personalize the
CT Mobile interface].
...
xref:android/home-screen#h3_1361691321[the Logo widget] is added on the
...
Geolocation data may be used for xref:android/mobile-layouts-maps[the Maps
widget] on a record, in the xref:android/routes[Routes] and
...
xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_612123135[Account
Geolocation] or
xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_1092547330[Account Full
...
Obtain and enter your xref:android/google-maps-api-key[Google Maps API key]
...
Obtain and enter your
https://docs.microsoft.com/en-us/bingmaps/getting-started/bing-maps-dev-center-help/getting-a-bing-maps-key[]xref:android/google-maps-api-key[Google
...
Obtain and enter your xref:android/google-maps-api-key[Google Maps
...
If enabled, the xref:android/sync-logs[Sync Log] records will be created
...
Choose where to xref:android/quick-reference-guides/application-settings/send-application-data-dump.adoc[send the customer's
...
Name* field of the xref:android/mobile-application-setup[Mobile Application
Setup] should be correctly specified for each
[.object]#Activity# object in the
xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-calendar.adoc#h3_1397263211[Activity Object
API Name] field.
...
For more information, refer to xref:android/knowledge-base/configuration-guide/reference-object[Reference
Object].
