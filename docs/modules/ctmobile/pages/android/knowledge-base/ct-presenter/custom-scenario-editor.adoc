...
xref:android/knowledge-base/ct-presenter/clm-scheme/clm-customscenario[its details].
* Click the
image:edit-icon.png[]
...
xref:android/knowledge-base/ct-presenter/publishing-clm-presentations#h3_1098755975[renew them].
...
xref:android/knowledge-base/ct-presenter/clm-scheme/clm-customscenario[favorites].
