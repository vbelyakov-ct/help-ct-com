...
using xref:android/knowledge-base/ct-presenter/clm-scheme/clm-template[templates], xref:android/knowledge-base/ct-presenter/clm-scheme/clm-widget[widgets],
and xref:android/knowledge-base/ct-presenter/clm-scheme/clm-placeholder[placeholders].
