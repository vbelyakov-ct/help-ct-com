...
link:android/knowledge-base/ct-presenter/clm-scheme/clm-application[Applications] available to the user.
...
link:android/home-screen[the Carousel of CLM presentations on the Home
Screen] or link:android/mobile-layouts-applications[in the widget on the
