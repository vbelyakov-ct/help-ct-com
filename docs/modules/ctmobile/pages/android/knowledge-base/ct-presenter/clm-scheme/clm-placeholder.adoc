...
xref:android/knowledge-base/ct-presenter/clm-scheme/clm-template[the HTML template].

The list of widgets available for insertion varies depending on
xref:android/creating-a-placeholder[the type of placeholder] selected.
...
xref:android/knowledge-base/ct-presenter/clm-scheme/clm-widget[widgets].
