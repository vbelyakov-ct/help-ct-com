...
link:android/knowledge-base/ct-presenter/clm-scheme/clm-template[the HTML template].

The list of widgets available for insertion varies depending on
link:android/creating-a-placeholder[the type of placeholder] selected.
...
link:android/knowledge-base/ct-presenter/clm-scheme/clm-widget[widgets].
