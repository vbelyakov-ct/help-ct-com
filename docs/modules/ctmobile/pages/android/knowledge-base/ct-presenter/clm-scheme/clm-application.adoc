...
to link:android/ct-mobile-os-comparison[CT Mobile OS Comparison].
...
the link:android/knowledge-base/ct-presenter/clm-scheme/clm-applicationstats[Application Stats] object.
...
link:android/creating-clm-presentation-from-powerpoint[PowerPoint],
link:android/creating-clm-presentation-from-pdf[PDF], or
link:android/creating-clm-presentation-from-jpeg-jpg[ZIP archives with the
JPEG/JPG files] on the link:android/application-editor[Application Editor]
tab.
* *Plain Application*

In the built-in link:android/plain-application-editor[Plain Application
Editor], CLM presentations can be created based on
link:android/knowledge-base/ct-presenter/clm-scheme/clm-template[templates],
link:android/knowledge-base/ct-presenter/clm-scheme/clm-placeholder[placeholders], link:android/knowledge-base/ct-presenter/clm-scheme/clm-widget[widgets],
...
link:android/knowledge-base/ct-presenter/clm-scheme/clm-customscenario[custom scenarios].

|Slide Zoom Enabled |[.apiobject]#clm__IsZoomEnabled__c#
|Checkbox |If enabled, zoom in and out slides if
link:android/knowledge-base/configuration-guide/custom-settings/mobile-application-setup#h2_993073976[the display mode is
*wk*].
