...
xref:android/creating-clm-presentation-from-powerpoint[PowerPoint],
...
JPEG/JPG files] on the xref:android/application-editor[Application Editor]
tab.
* *Plain Application*

In the built-in xref:android/plain-application-editor[Plain Application
