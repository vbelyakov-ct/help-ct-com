...
. Go to xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_2011978[CT Mobile
Control Panel: Tools] and check the cloud token is specified.
. Assign xref:android/quick-reference-guides/application-permission-settings.adoc#h3_2115044027[the
