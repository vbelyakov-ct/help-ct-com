...
* xref:android/knowledge-base/mobile-application/actions#h2_62618674[Photo]
* xref:android/knowledge-base/mobile-application/actions#h2_785802245[Add Post]
...
on the xref:android/attachments-and-files[Notes & Attachments] tab of the
record.
...
Add a post in the xref:android/mobile-layouts-chatter-feed[Chatter feed].
