...
xref:android/knowledge-base/mobile-application/mobile-application-modules/applications/applications[Application] module, on
xref:android/mobile-layouts-applications[the mobile layout], and
...
xref:android/knowledge-base/ct-presenter/clm-scheme/clm-application.adoc[CLM presentation] record.
