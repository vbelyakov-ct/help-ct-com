...
xref:android/knowledge-base/ct-presenter/ct-presenter-introduction[CLM presentations] and
xref:android/knowledge-base/ct-presenter/clm-scheme/clm-customscenario[custom scenarios] on the record details
...
xref:android/knowledge-base/mobile-application/mobile-application-modules/applications/gestures-in-clm-presentations[Gestures in CLM presentations]
and
