...
xref:android/knowledge-base/mobile-application/synchronization/index.adoc[synchronization] depending on the value in the
xref:android/quick-reference-guides/synchronization-launch/sync-logs#h2_272409891[Debug Level] option on the *CT Mobile
...
xref:android/quick-reference-guides/application-settings/send-application-data-dump[sends an application data dump],
...
[NOTE] ==== If
xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-general.adoc#h3_1808523151[the tracking
