...
* xref:android/quick-reference-guides/synchronization-launch/sync-logs#h2_1487877011[Sync Log Records]
* xref:android/quick-reference-guides/synchronization-launch/sync-logs#h2_272409891[Enable Sync Logs]
* xref:android/quick-reference-guides/synchronization-launch/sync-logs#h2_1454825892[Sync Log Reports]
...
xref:android/quick-reference-guides/synchronization-launch/sync-log[Sync Log]. ====
