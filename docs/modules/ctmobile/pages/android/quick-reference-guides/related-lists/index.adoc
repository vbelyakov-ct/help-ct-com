...
* on xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/index.adoc-custom-details[CT Mobile Control
...
* on xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/index.adoc-offline-objects[CT Mobile Control
Panel: Offline Objects] for a standard related list;
* in xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/index.adoc-custom-details[CT Mobile Control
Panel: Custom details] for a custom related list.
