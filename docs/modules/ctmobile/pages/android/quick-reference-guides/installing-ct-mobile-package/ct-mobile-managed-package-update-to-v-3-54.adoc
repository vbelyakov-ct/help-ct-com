...
xref:android/knowledge-base/configuration-guide/custom-settings/api-key[API Key] custom setting and retrieved by the web
service.
** As before, xref:android/quick-reference-guides/application-permission-settings.adoc[administrators]
could view and refresh the cloud token value on the
xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc[CT Mobile Control Panel: Tools].
...
* xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h2_203730205[The
...
the user's device.
* xref:android/knowledge-base/configuration-guide/metadata-archive/index.adoc[The metadata archive] should be built. This
...
xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_1003786176[Refresh metadata
archive] button to build the metadata archive. Please note that the
process will take some time.  ====

* xref:android/knowledge-base/configuration-guide/ct-mobile-control-panel/ct-mobile-control-panel-tools/index.adoc#h3_2011978[The cloud token] is
