...
or *link:creating-clm-presentation.html[create new CLM presentation]*.
. Click
...
. Click link:publishing-clm-presentations.html[the Publish application
button].
...
link:synchronization-launch.html[Perform fast or mixed synchronization]
...
* link:creating-interactive-clm-presentation.html[Creating Interactive
CLM Presentation]
