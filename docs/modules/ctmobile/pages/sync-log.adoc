...
link:synchronization.html[synchronization] depending on the value in the
*Debug Level* option on the
link:ct-mobile-control-panel-general.html#h3_1226274811[CT Mobile
Control Panel:
General]/link:ct-mobile-control-panel-general-new.html#h3_1226274811[CT
...
user link:send-application-data-dump.html[sends an application data
dump], the field contains [.apiobject]#Part n from m#,
where *n* is the number of an attachment and *m* is the total number of
attachments. ifdef::ios[]If the link:sync-recovery.html[Sync
Recovery] functionality is enabled with the *Proxy Object* parameter
specified
on link:ct-mobile-control-panel-offline-objects.html#h3_37043680[CT
Mobile Control Panel: Offline
Objects]/link:ct-mobile-control-panel-offline-objects-new.html#h4_37043680[CT
...
If link:ct-mobile-control-panel-general.html#h3__1808523151[the tracking
interval] (refer to
...
file in the Attachments section if the link:sync-recovery.html[Sync
