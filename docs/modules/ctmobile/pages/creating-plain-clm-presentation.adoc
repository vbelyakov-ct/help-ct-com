...
* Click
link:creating-plain-clm-presentation-using-templates.html[Templates] for
selecting a template for a CLM presentation.
* Click link:creating-plain-clm-presentation-from-powerpoint.html[Import
PPT] for creating a CLM presentation from uploaded PowerPoint.
* Click *Save* to save changes.
* Click *Convert* to edit the plain CLM presentation as
link:creating-clm-presentation.html[the usual one]. This action is
irreversible.
