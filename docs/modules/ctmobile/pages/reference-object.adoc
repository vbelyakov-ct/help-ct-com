...
. Go to the link:ct-mobile-control-panel-general.html#h3_494016929[CT
...
. Go to
the link:ct-mobile-control-panel-general-new.html#h4__351797814[CT
...
The setup is complete. Launch link:full-synchronization.html[full
...
link:person-accounts.html[Person Accounts], affects the record display. 
