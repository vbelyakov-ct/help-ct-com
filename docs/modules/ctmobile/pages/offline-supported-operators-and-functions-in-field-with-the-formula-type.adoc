...
Back to
link:offline-supported-operators-and-functions-in-field-with-the-formula-type.html#ListOfOperators[the
list of operators and functions].
...
Back to
link:offline-supported-operators-and-functions-in-field-with-the-formula-type.html[the
list of operators and functions].
...
|$CustomMetadata |Yes | |Records of link:custom-settings.html[custom
metadata types].
...
|$Setup |Yes |Yes |Records of link:custom-settings.html[custom
settings].
