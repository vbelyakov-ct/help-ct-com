...
link:logging-in.html[logging in];
...
the link:ct-mobile-control-panel.html[CT Mobile Control
...
For more information, read link:full-synchronization.html[the Full
Synchronization article].



Go back to link:synchronization-f-a-q.html#F.A.Q.list[the F.A.Q. list].
...
link:publishing-clm-presentations.html[republishing]. The CT Mobile app
...
link:clm-application.html[on the CLM presentation record], the CT mobile
...
could be managed on link:errors-screen.html[the Errors screen].

The CT Mobile app is not locked during the fast synchronization.

ifndef::win,andr[]

The sync process may include link:ct-mobile-replication.html[CT Mobile
Replication];

The sync process may include the link:sync-recovery.html[Sync Recovery]
functionality.



For more information, read link:fast-synchronization.html[the Fast
Synchronization article].
...
link:clm-user.html[current user's record] is earlier than the date of
...
* download link:metadata-archive.html[metadata] changes in ZIP
...
a change on link:ct-mobile-control-panel.html[CT Mobile Control
Panel]/link:ct-mobile-control-panel-new.html[CT Mobile Control Panel
2.0].
...
Errors could be managed on link:errors-screen.html[the Errors screen];
...
* link:metadata-checker.html#h2__682427009[Manually create the metadata
archive].
* link:metadata-checker.html#h2__1244689107[Enable Metadata Checker] to
refresh metadata.
...
example, link:remote-detailing-launch-the-ct-mobile-app.html[to download
...
For more information, read link:sync-recovery.html[the Sync Recovery
...
case, link:ct-mobile-replication.html[create a CT Mobile Replication
...
on link:home-screen.html#h2__396225247[the status indicator] at the
...
information, read link:sync-log.html[the Sync Log article].
...
The link:sync-log.html[Sync Log] object is intended to store logs for
...
link:send-application-data-dump.html#SendApplicationDataDump-SpecifyDatatoSend[Sync
...
For more information, read link:sync-logs.html[the Sync Logs article].
...
link:attachments-and-files.html[attachments] can be downloaded one at a
time.
...
link:metadata-archive.html#h2_1854953360[here]. Also, the metadata
...
We recommend enabling link:metadata-checker.html[a metadata checker] and
link:metadata-checker.html#h3_1645525423[setting a schedule] for a
...
may incorrectly work, for example, link:validation.html[offline
validation rules].

. Check link:ct-mobile-control-panel-tools.html#h3_2011978[the cloud
token] (refer to link:ct-mobile-control-panel-tools.html#h3_2011978[CT
Mobile Control Panel:
Tools]/link:ct-mobile-control-panel-tools-new.html#h2_2011978[CT Mobile
Control Panel 2.0: Tools]) is valid.
. Create a ZIP archive or refresh metadata in the ZIP archive. We
recommend enabling link:metadata-checker.html[a metadata checker]. Also,
it is possible link:metadata-checker.html#h3_1645525423[to set a
schedule] for a metadata checker or
link:metadata-checker.html#h2__1657467916[manually create/update] the
metadata archive.  
...
created or updated. We recommend enabling link:metadata-checker.html[a
metadata checker]. Also, it is possible
link:metadata-checker.html#h3_1645525423[to set a schedule] for a
metadata checker or link:metadata-checker.html#h2__1657467916[manually
create/update] the metadata archive.
* Also, check the link:application-language.html[Application Language]
article.
...
link:metadata-archive.html[a metadata archive]. We recommend enabling
link:metadata-checker.html[a metadata checker]. Also, it is possible
link:metadata-checker.html#h3_1645525423[to set a schedule] for a
metadata checker or link:metadata-checker.html#h2__1657467916[manually
create/update] the metadata archive.
...
Go to the link:send-application-data-dump.html[Send Application Data
Dump] article.
...
link:technical-requirements-for-devices-and-network.html#h2_1498128754[the
requirements for the connection].
* amount of data. To avoid the synchronization of the large data,
link:managing-offline-objects.html[customize the criteria] to download
desired records of offline objects.

* amount of modified components (objects, fields, layouts) or changes
provided on the link:ct-mobile-control-panel.html[CT Mobile Control
Panel]/link:ct-mobile-control-panel-new.html[CT Mobile Control Panel
...
link:managing-offline-objects.html[SOQL query] in the error message.
...
inserted into link:reference-fields.html[the reference field] when the
...
* Enable the link:application-settings.html#h3_1768799377[Background
...
* Disable the link:ctm-settings-offline-objects.html[Files Download
Enabled] option for offline objects. The files attached to offline
objects will be downloaded as previews.
* Set up the link:ctm-settings-offline-objects.html[Files Filter] option
...
Enable logs on the
link:ct-mobile-control-panel-general.html#h3__272409891[CT Mobile
Control Panel:
General]/link:ct-mobile-control-panel-general-new.html#h2__1687169837[CT
Mobile Control Panel 2.0: General] tab to collect statistics in the
[.object]#Sync Log# object. The link:sync-log.html[Sync Log]
