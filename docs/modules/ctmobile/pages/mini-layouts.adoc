...
link:managing-offline-objects.html[the offline object].
...
. Go to link:ct-mobile-control-panel-mini-layouts.html[CT Mobile Control
Panel: Mini Layouts].
. Click *Create layout*.
image:47745554.png[]
...
link:application-permission-settings.html[permissions for the selected
...
. Go to link:ct-mobile-control-panel-mini-layouts-new.html[CT Mobile
...
link:application-permission-settings.html[proper permissions for the
...
link:ct-mobile-control-panel-mini-layouts.html[]
