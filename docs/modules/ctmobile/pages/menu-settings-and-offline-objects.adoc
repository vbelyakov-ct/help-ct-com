...
of the link:ctm-settings-menu.html[Menu] record type of the
custom link:ctm-settings.html[CTM Settings] object. 
[TIP] ==== For easy setup, go to
link:ct-mobile-control-panel.html[CT Mobile Control Panel]. CT Mobile
Control Panel makes duplicates of the offline objects list in
link:related-list-filters.html[Related List Filters] so that to be able
...
be grouped by the title of link:compact-layout.html[a compact layout].
