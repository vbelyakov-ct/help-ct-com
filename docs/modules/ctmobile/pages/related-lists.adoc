...
link:reference-fields.html[the reference field]. In the CT Mobile app,
two types of related lists are available:

* link:custom-related-lists.html[Custom Related Lists]
* link:standard-related-lists.html[Standard Related Lists]
...
details]/link:ct-mobile-control-panel-custom-details-new.html[CT Mobile
Control Panel 2.0: Custom Details] to customize a custom related list.

|Create a record |{plus} |{plus} a|
Grant permission:

* on link:ct-mobile-control-panel-offline-objects.html[CT Mobile Control
Panel: Offline
Objects]/link:ct-mobile-control-panel-offline-objects-new.html[CT Mobile
Control Panel 2.0: Offline Objects] for a standard related list;
* on link:ct-mobile-control-panel-custom-details.html[CT Mobile Control
Panel: Custom
details]/link:ct-mobile-control-panel-custom-details-new.html[CT Mobile
...
Objects]/link:ct-mobile-control-panel-offline-objects-new.html[CT Mobile
Control Panel 2.0: Offline Objects] for a standard related list;
* in link:ct-mobile-control-panel-custom-details.html[CT Mobile Control
Panel: Custom
details]/link:ct-mobile-control-panel-custom-details-new.html[CT Mobile
Control Panel 2.0: Custom Details] for a custom related list.
...
* Go to link:custom-related-lists.html#h2__773495381[Custom Related
...
list;
* Grant permission on
link:ct-mobile-control-panel-custom-details.html[CT Mobile Control
Panel: Custom
details]/link:ct-mobile-control-panel-custom-details-new.html[CT Mobile
...
link:columns-width-for-related-lists.html[Columns' Widths for Standard
...
link:timeline-view.html[Timeline View]. ifdef::win,andr,kotlin[]
[NOTE] ==== Not in use. ====
...
link:filters-in-related-lists.html[Filters in Related Lists].
|===
