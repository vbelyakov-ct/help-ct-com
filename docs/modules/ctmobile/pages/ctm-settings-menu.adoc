...
a|
Stores an API Name of link:managing-offline-objects.html[an offline
object], link:mobile-application-modules.html[module's name], or name of
a menu item, e.g., link:home-screen.html[Home] and
link:application-settings.html[Settings], that will be available in
link:app-menu.html[the main menu].
...
section while creating a new link:list-views.html#h2__380480215[mobile
...
Defines the way how link:libraries.html[Library] object must be
downloaded during synchronization, as full content or as a preview.
Interacts with the
link:application-settings.html#h3_1768799377[Background content loading]
...
link:synchronization.html[synchronization] with displaying a loader.
** *Background content loading* is disabled: the full content of the
Library object will be downloaded
after link:synchronization.html[synchronization].
...
|Text(255) a|
Stores an API Name of a field for link:grouping-records.html[grouping
records] in link:app-menu.html[the main menu].
...
of link:menu-settings-and-offline-objects.html[Menu Settings and Offline
