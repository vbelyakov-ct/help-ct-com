...
link:managing-offline-objects.html[an offline object] by the specific
criterion, for example, records in the left menu, activities in the
link:calendar.html[Calendar] module, and records in the
link:nearby-accounts.html[Nearby Accounts] module. Each offline object
...
. Go to link:ct-mobile-control-panel-color-settings.html[CT Mobile
...
. Go to link:ct-mobile-control-panel-colors-new.html[CT Mobile Control
Panel 2.0: Colors].
. {blank}
...
link:synchronization-launch.html[Launch synchronization] to apply the
changes. ifdef::kotlin[] The setup is complete.
link:synchronization-launch.html[Launch mixed synchronization] to apply
the changes.
ifdef::ios[]
image:62561517.png[]
ifdef::win[]
