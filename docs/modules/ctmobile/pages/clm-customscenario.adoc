...
link:clm-application.html[Applications] available to the user.
...
link:home-screen.html[the Carousel of CLM presentations on the Home
Screen] or link:mobile-layouts-applications.html[in the widget on the
...
link:changing-slides.html[in the navigation].
