...
long link:synchronization.html[during the synchronization].
...
that may be link:creating-clm-presentation-from-pdf.html[converted into
HTML5 code].
...
link:gestures-in-clm-presentations.html[Default gestures] to switch and
...
For presentations in link:the-remote-detailing-functionality.html[Remote
...
Go back to
link:requirements-and-media-file-formats.html#ListofRequirements[the
