...
link:clm-slide.html[here]. ====
* Enter the *Slide* name.
* Specify the slide content using one of the options below:
** Select link:clm-template.html[the template] with placeholders and
widgets.
** In the *Markup* field, specify a markup for a slide.
* Specify link:clm-navigation-in-clm-presentations.html[the order and
branch].
...
It is also possible to add link:attachments-and-files.html[attachment
