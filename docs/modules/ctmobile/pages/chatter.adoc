...
Chatter to the link:mobile-layouts-chatter-feed.html[mobile layout].
ifdef::ios[] The *Chatter* module displays users' messages. Users
can create posts and comments, add attachments, and receive
link:chatter-push-notifications.html[push notifications]. You can add
Chatter to the link:mobile-layouts-chatter-feed.html[mobile layout].
...
To add the *Chatter* module to the link:app-menu.html[app menu]:
