...
link:mobile-layouts-chatter-feed.html[Chatter feed] is a widget to
...
the value for the link:push-identifier.html[PUSH Identifier] field.
...
общая
инфа link:https://docs.microsoft.com/ru-ru/windows/uwp/design/shell/tiles-and-notifications/windows-push-notification-services--wns--overview[]).
image:image-(1).png[]
