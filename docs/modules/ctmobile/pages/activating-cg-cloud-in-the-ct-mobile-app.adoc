...
link:activating-cg-cloud-in-salesforce.html[After activating CG Cloud]
...
list.
. link:managing-offline-objects.html#h2__1747811907[Set up user
permissions].
. Click *Save*.
...
link:custom-related-lists.html[if configured].
...
refer to link:managing-visits-to-retail-stores.html[Managing Visits to
Retail Stores]. 
...
parameters, refer to link:ctm-settings-cg-cloud-record-type.html[CTM
