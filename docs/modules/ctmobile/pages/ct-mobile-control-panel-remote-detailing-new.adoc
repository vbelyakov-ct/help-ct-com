...
* To create link:test-clm-presentations.html[test CLM presentations],
...
. On the link:clm-applicationstats.html[Application Stats] object,
create lookup fields to every [.object]#Activity#
object configured on the
link:ct-mobile-control-panel-activities-new.html#h2_2014841429[Activities]
tab.
. In the link:mobile-application-setup.html[Mobile Application Setup],
