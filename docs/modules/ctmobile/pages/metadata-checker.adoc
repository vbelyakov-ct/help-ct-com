...
the link:mobile-application-setup.html[Mobile Application Setup]. If the
user does not have this access, grant it
by assigning link:application-permission-settings.html#ApplicationPermissionSettings-PermissionSets[one
...
link:metadata-archive.html#h2_1854953360[metadata components].
* For archiving metadata components.
* For auto-updating a value in the
[.apiobject]#clm__MetadataLastModifiedDate__c# field of
the link:mobile-application-setup.html[Mobile Application Setup]
records.
...
. Go to the link:ct-mobile-control-panel-tools.html[CT Mobile Control
Panel: Tools] tab.
...
the link:ct-mobile-control-panel-tools.html#h4_1003786176[CT Mobile
Control Panel:
