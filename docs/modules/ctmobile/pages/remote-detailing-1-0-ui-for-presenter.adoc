...
link:remote-detailing-launch-the-ct-mobile-app.html[the CT Mobile
app]. Read link:remote-detailing-f-a-q.html[Remote Detailing: F.A.Q.] to
...
link:remote-detailing-1-0-ui-for-participants.html[can join] and
participate.
...
link:ct-mobile-control-panel-presenter.html#h2_985373192[CT Mobile
Control Panel:
...
link:remote-detailing-statistics.html[the statistics], the *Track slide
