...
Errors occur due to violation of link:validation.html[the validation
rules] and
...
link:attachments-and-files.html[an attachment] to the
link:sync-log.html[Sync Log] record.

[TIP] ==== To use this option, the cloud token should be
valid (refer to link:ct-mobile-control-panel-tools.html#h3_2011978[CT
...
* link:sync-recovery.html[Sync Recovery]: to send records as usual or as
the JSON file for post-processing by the administrator.
* link:ct-mobile-replication.html[CT Mobile Replication]: to download
