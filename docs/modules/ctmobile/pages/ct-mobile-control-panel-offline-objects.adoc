...
the link:ctm-settings-offline-objects.html[Offline
Objects] and link:ctm-settings-standard-related-list.html[Standard
...
the *Selected* list on the link:ct-mobile-control-panel-app-menu.html[CT
...
If enabled, the link:conflict-manager-control.html[Conflict Manager]
...
link:other-synchronization-modes.html#h2__1958232390[sync a single
...
For more information, refer to link:sync-recovery.html[Sync Recovery].
...
link:managing-offline-objects.html[Managing Offline Objects].
...
records that match the criteria. Enable link:timeline-view.html[the
...
For more information, refer to
link:managing-offline-objects.html[Managing Offline Objects]. Also, get
familiar with the information in the
link:standard-related-lists.html[Standard Related Lists] article.

To set up custom related lists of an offline object, go
to link:ct-mobile-control-panel-custom-details.html[CT Mobile Control
