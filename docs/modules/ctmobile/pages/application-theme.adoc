...
to link:ct-mobile-control-panel-user-interface-new.html[CT Mobile
Control Panel 2.0: User Interface]. 
...
The logo is represented on the link:home-screen.html[Home screen] if the
...
size. After that, launch the link:fast-synchronization.html[fast
synchronization].
...
The logo is represented on the link:home-screen.html[Home screen]. Click
