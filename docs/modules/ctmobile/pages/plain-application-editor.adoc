...
read link:requirements-and-media-file-formats.html[Requirements and
Media File Formats] and link:remote-site-settings.html[set up remote
sites].
...
* link:creating-plain-clm-presentation.html[Create a CLM presentation by
adding slide by slide&#44; and configure template placeholders and
widgets].
* link:creating-plain-clm-presentation-using-templates.html[Create a CLM
presentation based on the template]link:creating-a-widget.html[].
* link:creating-plain-clm-presentation-from-powerpoint.html[Create a CLM
