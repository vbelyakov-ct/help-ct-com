...
saved in the corresponding fields of the link:clm-settings.html[CLM
Settings] record.
...
to link:js-bridge-methods-availability.html[JS Bridge Methods
Availability].

[[h3_856955672]]
==== Detailed Statistics Enabled

If enabled, link:remote-detailing-statistics.html[the statistics] per
...
link:remote-detailing-1-0-ui-for-presenter.html[can resume] the finished
Remote Detailing session. The statistics will be collected for the
resuming meeting too. Use
link:remote-detailing-f-a-q.html#h2__106650128[the same link] to enter
...
to link:remote-detailing-2-0-audio-recording.html[Remote Detailing 2.0:
Audio Recording].
...
link:ct-mobile-control-panel-presenter.html#h3_1157844415[Delete After
(days)] field.
...
link:ct-mobile-control-panel-presenter.html#h3_1230065320[Scheduled
...
The field API name of the link:clm-activity.html[Activity] object for
...
Specify link:remote-detailing-setup.html[the active site URL] for
...
Enter the API name of a checkbox of the link:clm-activity.html[Activity]
