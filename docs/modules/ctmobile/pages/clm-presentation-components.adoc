...
link:gestures-in-clm-presentations.html[using a double swipe].
...
link:applications.html[the Application module],
link:home-screen.html[Home Screen],
link:mobile-layouts-applications.html[a record's mobile layout], and
...
The object is intended to store the CLM presentation statistics from
link:applications.html[the Application module],
link:home-screen.html[Home Screen], and
link:mobile-layouts-applications.html[a record's mobile layout].
...
link:clm-product.html[products], of different types of
link:clm-user.html[user] visits.
