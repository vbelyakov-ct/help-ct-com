...
link:managing-offline-objects.html#ManagingOfflineObjects-SOQLFilters[Set
...
record type of the link:ctm-settings.html[CTM Settings] object.
...
The sorting order for link:custom-related-lists.html[a custom related
list] is stored in link:mobile-custom-details-settings.html[Mobile
