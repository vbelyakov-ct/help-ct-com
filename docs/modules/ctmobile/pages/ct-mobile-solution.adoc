...
* In the link:ct-mobile-news.html[News] section, we share with you the
latest CT Mobile updates, release notes, and Salesforce updates that
affect our CT Mobile solution.
* link:getting-started.html[Getting Started] is a peek into the CT
...
app. 
* link:quick-reference-guides.html[Administrator Guide] is a complete CT
...
Mobile package.
* The link:mobile-application.html[Mobile Application] section describes
the settings and functionalities available in the CT Mobile app.
* The link:ct-presenter.html[CT Presenter] section is intended to
...
link:ct-mobile-ios-release-notes.html#h2_211762337[2.9].
...
* link:knowledge-base.html[]link:quick-reference-guides.html[Administrator
