...
available link:remote-detailing-versions-comparison.html[here].
* Remote Detailing 2.0 and Self Detailing 2.0 are parts of
the link:ct-presenter.html[CT Presenter] solution. The CT Presenter
features depend on the version of the CT Mobile package are
available link:ct-mobile-package-release-notes.html[here].
...
link:remote-detailing-launch-microsoft-teams.html[using the CT Presenter
app].
...
* Support for the secure link:ctm-securequery.html[ctm.secureQuery]
...
* link:remote-detailing-2-0-ui-for-participants.html#h3__111154998[The
...
* Participants can
link:remote-detailing-2-0-ui-for-participants.html#h4__1837856184[turn
on the video or share the screen] in a browser.
link:remote-detailing-2-0-ui-for-presenter.html#h4_1768762957[The
...
* Display all link:clm-application.html[active and available for Remote
...
link:ct-mobile-control-panel-presenter.html#h3__1123335710[the specified
time interval].
...
link:ct-mobile-control-panel-presenter.html#h3__53846510[the integration
...
* link:clm-settings.html[If enabled], the chat history will be saved and
