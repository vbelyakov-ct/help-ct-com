...
link:ct-presenter-introduction.html[CLM presentations] and
link:clm-customscenario.html[custom scenarios] on the record details
screen. The carousel becomes scrollable if it contains more than two
screenshots.

The *Applications* widget is also available on
the link:home-screen.html[Home screen].



To learn more about CLM presentation controls, refer
to link:gestures-in-clm-presentations.html[Gestures in CLM
presentations] and link:clm-presentation-controls.html[CLM presentation
Controls].
...
If link:start-finish-functionality.html[Start/Finish functionality] with
