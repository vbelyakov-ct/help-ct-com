...
. If the *Orders* module has not been added to the app menu, link:https://help.customertimes.com/smart/project-order-module/adding-ct-orders-to-the-ct-mobile-app-4-0/a/h2_827845120[add
it].
