...
. Click *Save*.
. (Optional) to filter photos by date in the xref:../working-with-ct-vision-lite-in-salesforce-2-9.adoc#h2_1552458132[Feedback Loop] tab, create an *Activity Setting* for each of the API names of the [.object]#Activity# object used by CT Vision Lite and specified in the *Activity Object API Name* field.
...
xref:../working-with-ct-vision-lite-in-the-ct-mobile-app-2-9.adoc#h2_566778463[Pictures] allows
