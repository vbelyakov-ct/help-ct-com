...
[NOTE]
====
In the <<h3__585482629, Simple View>>, the report data and the final summary report will not be displayed and <<h2_566778463, previewing pictures in full size>> will be disabled.
====
