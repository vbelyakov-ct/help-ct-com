...
Only documents from link:https://help.customertimes.com/articles/ct-sign-en/configuring-the-ct-sign-package/a/h2__1469899678[the specified workspaces] will be downloaded on the mobile device.
