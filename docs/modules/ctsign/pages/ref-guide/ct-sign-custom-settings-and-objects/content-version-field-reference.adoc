...
The standard _Content Version_ object is used to store template attributes.
...
The following fields are created on the standard _Content Version_ object during the CT Sign installation:
