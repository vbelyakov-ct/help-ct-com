...
xref:ctmobile:ios/mobile-application/synchronization/synchronization-launch/index.adoc[fast synchronization].
* Documents signed by DocuSign offline will be available:
* In Salesforce: as soon as all signatories sign the document.
* In the mobile application: after all signatories sign the document and after performing the xref:ctmobile:ios/mobile-application/synchronization/synchronization-launch/index.adoc[fast synchronization].
