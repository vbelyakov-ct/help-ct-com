...
a|[.apiobject]#globalActions# |An array of <<h2_1835390962,Global Actions>> |Yes a|An array of one or more global actions that are specified for one or more navigation buttons.
...
a|[.apiobject]#stepSettings# |<<Step Settings>> |No a|[.apiobject]#true# if xref:admin-guide/ct-layouts-editor-customize-tabs.adoc#h3_1068114486[the *Path* mode is set] and the *Status* field is selected.

a|[.apiobject]#tabs# |An array of <<h2_1948275861,Tabs>> |Yes a|List of tabs to display on a record screen.
...
|[.apiobject]#completedTab# |<<Path Tab Settings>> |Yes |The status field values that are added in the *Completed* group of the tab statuses.
...
|[.apiobject]#statuses# |An array of String |Yes a|The API names of <<h3_1890880071,stepSettings.statusField>> values.
...
|[.apiobject]#showCondition# .2+|<<Action Condition>> .2+|No .2+a| By default, a button is displayed on every tab. To hide a button:
...
[NOTE]
====
* The values in the [.apiobject]#alwaysDisplayedActions# and [.apiobject]#alwaysHiddenActions# keys of <<Tab Settings>> have priority over these conditions.
...
|[.apiobject]#onClickActions# |An array of <<h3_2124187468,Click Actions>> |Yes a| Actions to perform when a mobile user taps the button.
...
* <<h4_472370536,Field comparison expression>>.
...
|[.apiobject]#operator# |Enum |Yes |<<h4_748327130,Available operators>> depending on the field data type.
...
|[.apiobject]#alwaysDisplayedActions# .2+|An array of String .2+|No .2+a| An array of the values for the name key of <<h3_1652615080,the global actions>> to always display or hide the specified button on the tab.

NOTE: These conditions have priority over the values in the [.apiobject]#displayCondition# and [.apiobject]#hideCondition# keys of <<Action Keys>>.
...
NOTE: Required when [.apiobject]#"hasCustomColor": true# <<h3_1857678454,for the tab>>.
...
NOTE: Required when [.apiobject]#"hasCustomIcons": true# <<h3_1857678454,for the tab>>.

|[.apiobject]#label# |String |Yes a|The label of the tab. Available values:

include::partial$label-format.adoc[]

|[.apiobject]#sections# |Array of <<h2_903347826,Sections>> |Yes a|The list of sections on the tab.
...
|[.apiobject]#statusValue# |String |Yes a| The API name of <<h3_1890880071,stepSettings.statusField>> value.

NOTE: Required when <<h3_1890880071,Step Settings>> are defined.
...
|[.apiobject]#position# |<<h3_1500637436,Section Position>> |Yes |Location of the section on the tab.
...
|[.apiobject]#fields# |An array of <<h2_1352679225,Field Settings>> |Yes a|Fields to display.
...
|[.apiobject]#permission# |<<Record Permission Settings>> |Yes |User permissions to work with fields in the section.
|===
