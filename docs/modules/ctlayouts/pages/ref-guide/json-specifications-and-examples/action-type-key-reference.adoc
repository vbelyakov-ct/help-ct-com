...
Get familiar with
link:ct-layouts-editor-customize-tabs.html#h3_349797985[the CT Layouts
Editor UI] and the settings in the *Navigation* button.

To learn more about the $Class, $System, and $Tabs contexts, refer to
the link:context-key-reference.html[CT Layouts contexts] article.
...
field of the desired link:layout-settings-field-reference.html[Object]
record.
