...
|[.apiobject]#$System.geoCoordinates# |v1 |Geolocation |To write the current user geolocation in the specified field in the field key.

|[.apiobject]#$System.date# |v1 |Date |To write the current date in the specified field in the field key.

|[.apiobject]#$System.dateTime# |v1 |Date/Time |To write the current date and time in the specified field in the field key.
|===
