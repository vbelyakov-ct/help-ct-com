...
|xref:ref-guide/json-specifications-and-examples/index.adoc[A formed JSON file] that
stores settings specified in the
xref:admin-guide/ct-layouts-editor-customize-tabs.adoc[CT Layouts Editor] for
