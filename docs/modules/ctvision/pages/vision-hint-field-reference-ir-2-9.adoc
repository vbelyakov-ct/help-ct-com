...
The following fields must be created on the [.object]##[.object]#Vision Settings# object for this record type:

[width="100%",cols="25%,25%,25%,25%",]
|=======================================================================
|*Field* |*API Name* |*Type* |*Description*

|Component |ctv__Component\__c |Picklist a|
...
|Label |[.apiobject]#ctv__Label\__c# |Text(255) |Specify the text of the hint. |Type |[.apiobject]#ctv__Type\__c # |Picklist a|
