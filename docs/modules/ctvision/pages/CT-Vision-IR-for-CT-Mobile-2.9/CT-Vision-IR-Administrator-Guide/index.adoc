...
. link:Getting-Started/4-Setting-up-Integration-with-the-Image-Recognition-Providers/index[Add the desired providers] and set up a connection.
...
When the CT Vision IR is configured, work with it in link:working-with-ct-vision-ir-in-salesforce-2-9[Salesforce] and link:working-with-ct-vision-ir-in-the-ct-mobile-app-2-9[the CT Mobile app] Integration with https://help.customertimes.com/articles/ct-mobile-ios-en/cg-cloud[the CG Cloud solution] is currently not supported.
