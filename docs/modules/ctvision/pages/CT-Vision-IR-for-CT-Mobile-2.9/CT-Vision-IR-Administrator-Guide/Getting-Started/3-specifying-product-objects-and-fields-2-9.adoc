...
used for mapping the [.object]#Product# object in Salesforce and the server. . Click *Save*. image:../../../../images/General-Configuration-Product-Object-2.9.png[] . Allow Salesforce to create a field with the *Lookup* type when prompted for the specified [.object]#Product# object.
