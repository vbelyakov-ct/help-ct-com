...
Photo tag is an additional parameter for  the taken  photos in  link:../working-with-ct-vision-ir-in-salesforce-2-9#h3_1235535035[Salesforce] and link:../working-with-ct-vision-ir-in-the-ct-mobile-app-2-9[the CT Mobile app]. Each tag has its label and color.
...
To allow a user working with the specific photo tag in link:../working-with-ct-vision-ir-in-salesforce-2-9[Salesforce], link:../working-with-ct-vision-ir-in-the-ct-mobile-app-2-9[CT Mobile], and while link:../working-with-ct-vision-ir-in-salesforce-2-9#h3_717556108[searching in the Feedback Loop], share access to the tag:
