...
[NOTE]
====
For each link:../../../CT-Vision-IR-Reference-Guide/Vision-Settings-Field-Reference/../Vision-Settings-Field-Reference/vision-object-field-reference-ir-2-9[Vision Object] record type, the [.apiobject]#Provider__c# field must be filled with the corresponding value for the image recognition provider.
====
...
../../../CT-Vision-IR-Reference-Guide/Vision-Settings-Field-Reference/vision-visit-field-reference