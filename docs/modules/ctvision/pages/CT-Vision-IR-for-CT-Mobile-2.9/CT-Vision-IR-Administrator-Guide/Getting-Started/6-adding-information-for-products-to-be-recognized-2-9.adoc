...
To use product images to recognize products in the taken photos, set upmuploading them to the CT Vision server:
...
. Make sure, that the  *Product Synchronization Criteria*  field is added on the  *Vision Setup*  page layout for the link:../../CT-Vision-IR-Reference-Guide/vision-setup-field-reference-2-9[Vision Setup] custom metadata type.
