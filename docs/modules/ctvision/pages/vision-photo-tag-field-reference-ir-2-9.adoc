...
|Vision Photo |[.apiobject]#ctv__VisionPhoto#__c |Master-Detail(Vision Photo) |Specify the link:vision-photo-field-reference-ir-2-9.html[Vision Photo] record. |Tag |[.apiobject]#ctv__Tag__c# |Master-Detail(Tag) |Specify the
