...
Click the image:Salesforce-Shelf-Product-List-Button-v.2.png[22,60] button to open  link:../index#h3_1017582017[the Shelf Product List] with recognized products to verify the product
...
* The color mark next to the product is responsible for link:../working-with-ct-vision-in-the-ct-mobile-app#h2_691734370[the status of recognition].
* Click the product:
