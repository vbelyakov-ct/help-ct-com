...
. Go to https://help.customertimes.com/articles/ct-mobile-ios-en/ct-mobile-control-panel-general[CT Mobile Control Panel: General] tab.
...
* If you use link:adding-photo-tags[photo tags], also add the [.object]#Tag# object to the selection.
. Click *Save*.
