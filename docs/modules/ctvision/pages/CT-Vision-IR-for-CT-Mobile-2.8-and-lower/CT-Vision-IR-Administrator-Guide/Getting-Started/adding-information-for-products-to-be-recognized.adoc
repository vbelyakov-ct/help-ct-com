...
[TIP]
====
To specify the additional product information, refer to xref:CT-Vision-IR-for-CT-Mobile-2.8-and-lower/CT-Vision-IR-Administrator-Guide/Getting-Started/specifying-product-objects-and-fields.adoc#h2__2130197288[Specifying Product Objects and Fields: Product Image Information].
====
...
. Make sure, that the *Product Synchronization Criteria* field is added on the  *Vision Setup*  page layout for the xref:CT-Vision-IR-for-CT-Mobile-2.8-and-lower/CT-Vision-IR-Reference-Guide/vision-setup-field-reference.adoc[Vision Setup] custom metadata type.
