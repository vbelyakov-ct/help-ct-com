...
[TIP]
====
For more information, refer to link:adding-information-for-products-to-be-recognized[Adding Information for Products to be Recognized].
====
...
Specify the fields to display under the taken photo on the link:../../CT-Vision-IR-Administrator-Guide/Working-with-CT-Vision-IR-in-Salesforce/index[Feedback Loop] page.
