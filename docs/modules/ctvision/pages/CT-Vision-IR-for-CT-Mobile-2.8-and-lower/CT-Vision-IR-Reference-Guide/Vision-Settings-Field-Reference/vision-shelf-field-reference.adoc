...
If the shelf name is set as _Master_, it will be the only shelf displayed in the link:../../CT-Vision-IR-Administrator-Guide/working-with-ct-vision-in-the-ct-mobile-app#h2__1221438961[list of shelves] on the left part of the report summary creation screen.
