...
====
 ...
 . On the *Product Image Setting* tab, add desired fields from the *Available* to *Selected* section. image:../../../../images/General-Configuration-Product-Image.png[] . Click *Save*. The setup is complete. [[h2_553985630]] == [[h2_166351641]] == Feedback Loop 
