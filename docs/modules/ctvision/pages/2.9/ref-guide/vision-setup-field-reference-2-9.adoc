...
The _Vision Setup_ custom metadata type is used xref:2.9/admin-guide/getting-started/6-adding-information-for-products-to-be-recognized-2-9.adoc#h3_1021024571[to filter product images that should be sent] from the CT Vision server to the Image Recognition provider.
