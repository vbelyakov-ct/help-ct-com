...
Previews are used in xref:2.9/admin-guide/working-with-ct-vision-ir-in-the-ct-mobile-app-2-9.adoc#h3_2072273480[the clickable realogram] when the mobile user taps the recognized product to see its details.
