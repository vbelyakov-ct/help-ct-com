...
Photo tag is an additional parameter for the taken photos in xref:2.9/admin-guide/working-with-ct-vision-ir-in-salesforce-2-9.adoc[Salesforce] and xref:2.9/admin-guide/working-with-ct-vision-ir-in-the-ct-mobile-app-2-9.adoc[the CT Mobile app]. Each tag has its label and color.
...
To allow a user working with the specific photo tag in xref:2.9/admin-guide/working-with-ct-vision-ir-in-salesforce-2-9.adoc[Salesforce], xref:2.9/admin-guide/working-with-ct-vision-ir-in-the-ct-mobile-app-2-9.adoc[CT Mobile], and while xref:2.9/admin-guide/working-with-ct-vision-ir-in-salesforce-2-9.adoc#h3_717556108[searching in the Feedback Loop], share access to the tag:
