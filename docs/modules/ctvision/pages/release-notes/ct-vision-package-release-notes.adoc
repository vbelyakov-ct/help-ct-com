...
** xref:2.9/admin-guide/working-with-ct-vision-ir-in-salesforce-2-9.adoc#h2__1484451922[Filtering] by tags, date, users, and user managers. Also, you can create your own custom filters in the *Filter Fields* of the xref:2.9/ref-guide/vision-settings-ref/vision-object-field-reference-ir-2-9.adoc[Vision object].
...
** xref:2.9/admin-guide/getting-started/7-specifying-photo-tags-2-9.adoc#h2__117227442[Granular access management] to each photo tag.
