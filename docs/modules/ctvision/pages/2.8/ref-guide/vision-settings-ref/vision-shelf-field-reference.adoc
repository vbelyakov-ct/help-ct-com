...
If the shelf name is set as _Master_, it will be the only shelf displayed in the xref:2.8/admin-guide/working-with-ct-vision-in-the-ct-mobile-app.adoc#h2__1221438961[list of shelves] on the left part of the report summary creation screen.
