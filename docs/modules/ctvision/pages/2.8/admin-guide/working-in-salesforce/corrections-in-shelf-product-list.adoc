...
Click the image:Salesforce-Shelf-Product-List-Button-v.2.png[22,60] button to open xref:2.8/admin-guide/working-in-salesforce/index.adoc[the Shelf Product List] with recognized products to verify the product quantity on the shelves.
...
* The color mark next to the product is responsible for xref:2.8/admin-guide/working-with-ct-vision-in-the-ct-mobile-app.adoc#h2_691734370[the status of recognition].
* Click the product:
