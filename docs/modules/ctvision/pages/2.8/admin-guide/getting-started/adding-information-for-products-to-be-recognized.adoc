...
[TIP]
====
To specify the additional product information, refer to xref:2.8/admin-guide/getting-started/specifying-product-objects-and-fields.adoc#h2__2130197288[Specifying Product Objects and Fields: Product Image Information].
====
