...
[TIP]
====
Select the *Vision light* provider if image recognition is not required. In this case, there are no settings for the provider list. For better experience with the Vision light, xref:2.8/admin-guide/getting-started/adding-photo-tags.adoc[specify photo tags].
====
