...
. xref:2.8/admin-guide/getting-started/index.adoc[Configure the CT Vision solution].
. xref:2.8/admin-guide/getting-started/configuring-ct-mobile-for-work-with-ct-vision.adoc[Add the CT Vision module].
. xref:ctmobile:ios/getting-started/logging-in/index.adoc[Log in] to the CT Mobile app.
...
[NOTE]
====
To enable photo tags for the CT Mobile application, add the *Tag* offline object in the xref:ctmobile:ios/admin-guide/ct-mobile-control-panel/ct-mobile-control-panel-offline-objects.adoc[CT Mobile Control Panel] / xref:ctmobile:ios/admin-guide/ct-mobile-control-panel-new/ct-mobile-control-panel-offline-objects-new.adoc[CT Mobile Control Panel 2.0].
====
...
. In the pop-up, tap to select tags from xref:2.8/admin-guide/getting-started/adding-photo-tags.adoc[the list of available tags] to add them to a photo.
+
image:Tags-01.png[]
...
xref:2.8/admin-guide/getting-started/configuring-ct-mobile-for-work-with-ct-vision.adoc#h2_521416285[Add the Pictures gallery] to the _Account_ mobile layout to view photos that you have taken.
